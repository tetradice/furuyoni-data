...
export const CARD_SET_DATA = {
  ...
  "na-s9-2": {
    ...
    nameZh: "新幕 赛季9-2",
    listNameZh: "新幕 赛季9-2（2024/6/24～）",
    nameKo: "신막 시즌9-2",
    listNameKo: "신막 시즌9-2 (2024/6/24～)",
    nameEn: "Shinmaku Season 9-2",
    listNameEn: "Shinmaku Season 9-2 (from 2024/6/24)",
  },
  "na-s10": {
    seasonNumber: 13,
    name: "新幕 シーズン10",
    listName: "新幕 シーズン10 (2025/4～ 『後日譚』以降)",
    nameZh: "新幕 赛季10",
    listNameZh: "新幕 赛季10(2025/4～ 『新剧扩展：神座樱缘起 后日谈』之后)",
    nameKo: "신막 시즌10",
    listNameKo: "신막 시즌10(2025/4~「후일담」이후)",
