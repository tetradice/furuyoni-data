...
export const S8_UPDATED_CARD_DATA: Partial<{
  ...
  "23-akina-o-s-1": {
    ...
    type: "action",
    cost: "時価",
    text: "攻撃『0-10　-/1、【常時】この《攻撃》が対応されたならば、この攻撃は打ち消される。【常時】この《攻撃》のダメージは変化しない』を行う。その後、あなたの資本が相手の資本より大きいならばこのカードを使用する。\n（消費は支払い、その消費は時価以外で加減されない）",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "23-akina-o-s-3": {
    ...
    capacity: "1",
    cost: "1",
    text: "【展開時】あなたのライフからフレアへと桜花結晶を4つ移動させる。\n【展開中】このカードの効果以外でこの付与札の上の桜花結晶は移動しない。\n【展開中】あなたのライフが0の時にあなたが敗北するならば、代わりにあなたのフレアからライフへと桜花結晶を4つ移動させる。その後、この上の桜花結晶を全てダストに送り、このカードを取り除く。",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
