...
import { CardId, TCardId } from "./cardId.js";

export const CARD_DATA: { [key in CardSet]: { [key: string]: CardDataItem } } =
  {} as any;

export const S2_BASE_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> = {
  "01-yurina-o-n-1": {
    megami: "yurina",
    name: "斬",
    nameEn: "Slash",
  ...
  "01-yurina-A1-n-1": {
    ...
    textZh:
      "【常时】决死～若自命中的樱花结晶数小于等于3，则此《攻击》得+0/+2和不可被对应。",
    textZhG1:
      "【常时】决死-若自命中的樱花结晶的数目小于3，则此《攻击》得+0/+2和不可被对应。",
    textKo:
      "【상시】결사-당신의 라이프가 3 이하라면, 이 《공격》은 +0/+2가 되고, 대응불가를 얻는다.",
    textEn:
      "Forced: Resolve - If your Life is 3 or less, this attack gains +0/+2 and No Reactions.",
  },
  "01-yurina-o-n-2": {
    megami: "yurina",
    name: "一閃",
  ...
  "01-yurina-o-n-3": {
    ...
    textZh:
      "【攻击后】决死～若自命中的樱花结晶数小于等于3，则本回合你的下一次《攻击》得+1/+0。",
    textZhG1:
      "【攻击后】决死-若自命中的樱花结晶的数目小于3，则本回合你的下一次《攻击》得+1/+0。",
    textKo:
      "【공격후】결사-당신의 라이프가 3 이하라면, 이 턴에 당신이 다음에 행하는 《공격》은 +1/+0이 된다.",
    textEn:
      "After Attack: Resolve - The next attack you make this turn gains +1/+0 if your Life is 3 or less.",
  },
  "01-yurina-o-n-4": {
    megami: "yurina",
    name: "居合",
  ...
  "01-yurina-o-n-5": {
    ...
    textZhG1:
      "若当前距离大于4，则距（2）→虚。 \n若当前距离小于1，则虚（2）→距。",
    textKo:
      "현재 간격이 4 이상이라면、간격→더스트：2\n현재 간격이 1이하라면, 더스트→간격：2",
    textEn:
      "If the current Distance is 4 or more:\nDistance (2)→ Shadow\n\nIf the current Distance is 1 or less:\nShadow (2)→ Distance",
  },
  "01-yurina-o-n-6": {
    megami: "yurina",
    name: "圧気",
  ...
  "02-saine-o-n-1": {
    ...
    textZhG1:
      "【攻击后】八相-若自装中没有樱花结晶，则进行一次“攻击距离4-5 伤害2/1”的攻击。",
    textKo:
      "【공격후】팔상-당신의 오라가 0이라면, 공격『적정거리4-5、2/1』을 행한다.",
    textEn:
      'After Attack: Idea - You attack with "Range: 4-5, Damage: 2/1" if you have no Sakura tokens on your Aura.',
  },
  "02-saine-o-n-2": {
    megami: "saine",
    name: "薙斬り",
  ...
  "02-saine-o-n-3": {
    ...
    textZh:
      "【攻击后】若此牌作为对应使用，则进行一次“攻击距离3-5、伤害2/1、不可被对应”的攻击。",
    textZhG1:
      "【攻击后】若此牌作为对应使用，则进行一次“攻击距离3-5 伤害2/1 不可被对应”的攻击。",
    textKo:
      "【공격후】이 카드를 대응으로 사용했다면, 공격『적정거리3-5、2/1、대응불가』를 행한다.",
    textEn:
      'After Attack: If this card was played as a Reaction, you attack with "Range: 3-5, Damage: 2/1, No Reactions".',
  },
  "02-saine-A1-n-3": {
    megami: "saine",
    anotherID: "A1",
  ...
  "02-saine-o-n-4": {
    ...
    textZhG1:
      "【常时】八相-若自装中没有樱花结晶，则此牌额外具有《对应》副类别。\n距（1） ⇔ 虚",
    textKo:
      "【상시】팔상-당신의 오라가 0이라면, 이 카드를 《대응》을 갖는것과 같이 상대의 《공격》 에 끼어들어 사용 가능하다. \n간격⇔더스트：1",
    textEn:
      "Forced: Idea - You may play this card as if it were a Reaction if you have no Sakura tokens on your Aura.\n\nDistance (1)⇔ Shadow",
  },
  "02-saine-o-n-5": {
    megami: "saine",
    name: "圏域",
  ...
  "02-saine-A1-n-6": {
    ...
    textZh:
      "【展开中】若你有至少1张另一柱女神的王牌为已使用状态，则每回合对手的第一次《攻击》得-1/+0。\n【展开中】若你有至少1张细音的王牌为已使用状态，则每回合你使用的第一张王牌费用减小1（王牌的费用不会为负值）。",
    textZhG1:
      "【展开中】若你有至少一张另一柱女武神的王牌正面朝上，则每回合对手的第一次《攻击》得-1/+0 。\n【展开中】若你有至少一张细音的王牌正面朝上，则每回合你使用的第一张王牌费用减小1（王牌的消费不会为负）。",
    textKo:
      "【전개중】당신의 다른 여신의 비장패가 1장 이상 사용완료라면, 매 턴 첫 상대의 《공격》은 -1/+0이 된다.\n 【전개중】당신의 사이네의 비장패가 1장 이상 사용완료라면, 당신이 매 턴 처음 사용하는 비장패의 소비는 1 적게 된다(0미만으로는 되지 않는다).",
    textEn:
      "Ongoing: If at least one of your other Megami's Special cards is Devoted, the first attack your opponent makes each turn gets -1/+0.\n\nOngoing: If at least one of your Saine's Special cards is Devoted, the first Special you play each turn costs 1 less to play.",
  },
  "02-saine-o-n-7": {
    megami: "saine",
    name: "無音壁",
  ...
  "04-tokoyo-A1-n-1": {
    ...
    textZh:
      "【常时】若你有至少1张常世的王牌处于已使用状态，则此《攻击》得不可被对应。\n【攻击后】境地～若你的集中力为2，且你有至少1张另一柱女神的王牌处于已使用状态，则将此牌置于你的牌库顶。",
    textZhG1:
      "【常时】若你有至少一张常世的王牌正面朝上，则此《攻击》得不可被对应。\n【攻击后】境地-若你的集中力等于2，且你有至少一张另一柱女武神的王牌正面朝上，则将此牌置于你的牌库顶。",
    textKo:
      "【상시】당신의 토코요의 비장패가 1장 이상 사용완료라면, 이 《공격》은 대응불가를 얻는다.\n 【공격후】경지-당신의 집중력이 2이고, 당신의 다른 여신의 비장패가 1장 이상 사용완료라면, 이 카드를 패산 위에 둔다.",
    textEn:
      "Forced: If at least one of your Tokoyo's Special cards is Devoted, this attack gains No Reactions.\n\nAfter Attack: Artistic - If your Vigor is 2 and at least one of your other Megami's Special cards is Devoted, put this card on the top of your deck.",
  },
  "04-tokoyo-o-n-2": {
    megami: "tokoyo",
    name: "雅打ち",
  ...
  "04-tokoyo-o-n-7": {
    ...
    textZh:
      "【破弃时】境地～若你的集中力为2，则虚→2→自装\n【破弃时】你获得1点集中力。",
    textZhG1:
      "【破弃时】境地-若你的集中力等于2，则虚（2）→自装\n【破弃时】你获得1点集中力。",
    textKo:
      "【파기시】경지-당신의 집중력이 2라면, 더스트→자신 오라：2 \n 【파기시】당신은 집중력을 1 얻는다.",
    textEn:
      "Disenchant: Artistic - If your Vigor is 2:\nShadow (2)→ Your Aura\n\nDisenchant: Gain 1 Vigor.",
  },
  "04-tokoyo-A1-n-7": {
    megami: "tokoyo",
    anotherID: "A1",
    ...
    textKo:
      "【전개시/전개중】전개시, 그리고 당신이 《대응》카드를 사용했을 때, 그 해결 후 더스트→자신 오라：1 \n 【전개중】 상대 턴에는 이 카드 위의 벚꽃 결정은 이동하지 않는다.",
    textEn:
      "Initialize/Ongoing: When you play this, or you play a Reaction while this is in play, after that card resolves:\nShadow (1)→ Your Aura\n\nOngoing: Sakura tokens cannot leave this card on your opponent's turn.",
  },
  "04-tokoyo-o-s-1": {
    megami: "tokoyo",
    name: "久遠ノ花",
  ...
  "04-tokoyo-A1-s-2": {
    ...
    textZh:
      "【已使用】每当你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择1张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点或以上的伤害。",
    textZhG1:
      "【已使用】你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择一张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点以上的伤害。",
    textKo:
      "【사용완료】당신의 개시 페이즈 시작시에 버림패, 혹은 덮임패에서 카드 1장을 골라, 그것을 패산 밑에 두어도 좋다.\n ----\n 【즉재기】당신이 재구성 이외로 라이프에 1 이상의 대미지를 받는다.",
    textEn:
      "Devoted: At the beginning of your turn, you may put a card from your discard pile or your played pile on the bottom of your deck.\n----\nImmediate Resurgence: You take 1 or more damage to your Life, excluding reshuffle damage.",
  },
  "04-tokoyo-o-s-3": {
    megami: "tokoyo",
    name: "無窮ノ風",
  ...
  "05-oboro-o-s-3": {
    ...
    textZh:
      "【已使用】每当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
    textZhG1:
      "【已使用】当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
    textKo:
      "【사용완료】당신은 한 번의 재구성에 대해, 설치를 갖는 카드를 임의의 장수, 임의의 순서로 사용 가능하다.",
    textEn:
      "Devoted: You may play any number of cards with Trap from your discard pile in the order of your choosing just before you reshuffle your deck.",
  },
  "05-oboro-o-s-4": {
    megami: "oboro",
    name: "壬蔓",
  ...
  "07-shinra-o-n-2": {
    ...
    textZh:
      "【攻击后】若被对应的《攻击》非王牌且对装伤害大于等于3，则打消其将造成的所有伤害（其攻击后效果依然结算）。\n【攻击后】对手抓1张牌。",
    textZhG1:
      "【攻击后】若被对应的《攻击》非王牌且对装伤害大于3，则防止其将造成的所有伤害。\n【攻击后】对手抓一张牌。",
    textKo:
      "【공격후】대응한 카드가 비장패가 아니면서, 오라로의 대미지가 3 이상인 《공격》의 대미지를 무효화한다.\n 【공격후】상대는 카드를 1장 뽑는다.",
    textEn:
      "After Attack: Cancel the damage of the non-Special attack you played this card as a Reaction to if that attack has 3 or more Damage to Aura.\n\nAfter Attack: Your opponent draws a card.",
  },
  "07-shinra-o-n-3": {
    megami: "shinra",
    name: "詭弁",
  ...
  "09-chikage-o-n-4": {
    ...
    textKo:
      "【공격후】상대의 손패가 2장 이상이라면, 상대는 손패를 1장 버림패로 한다.",
    textEn:
      "After Attack: If your opponent has 2 or more cards in their hand, they must put one of them into their played pile.",
  },
  "09-chikage-o-n-5": {
    megami: "chikage",
    name: "毒霧",
  ...
  "10-kururu-o-n-5": {
    ...
    textZh:
      "----\n<攻对> 你可以使用你的1张已使用的王牌，而不需支付其费用（可以选择《全力》牌）。\n----\n你的集中力变为0。",
    textZhG1:
  ...
  "10-kururu-o-s-3": {
    ...
    textZh:
      "若此牌没有封印牌，则从你的手牌中选择1张非《付与》的牌，封印在此牌下。\n从追加牌区中将1张『复制品齿轮』置于你的牌库底。\n----\n【即再起】你重铸牌库后。",
    textZhG1:
      "若此牌没有封印牌，则从你的手牌中选择一张非《付与》的牌，封印在此牌下。\n将一张复制品齿轮牌置于你的牌库底。\n----\n【即再起】重铸牌库后。",
    textKo:
      "이 카드에 카드가 봉인되어 있지 않다면, 당신의 손패에서 《부여》가 아닌 카드 한 장을 골라, 그 카드를 이 카드 밑에 앞면으로 봉인해도 좋다.\n 당신의 추가패에서 「듀~플리기어」를 패산의 밑에 1장 둔다(최대 합계 3장). \n ----\n 【즉재기】당신이 패산을 재구성한다(재구성 후에 미사용으로 되돌린다).",
    textEn:
      'If no card is sealed under this card, you may choose a non-Enhancement card in your hand and seal it under this card, face-up.\n\nPut one of your set aside "Dupligear" on the bottom of your deck.\n\nImmediate Resurgence: You reshuffle your deck.',
    sealable: true,
  },
  "10-kururu-o-s-4": {
    megami: "kururu",
  ...
  "11-thallya-o-s-4": {
    ...
    textZhG1:
      "若你的造花结晶的数目为0，则TRANSFORM，然后回复2个造花结晶，否则将这张牌翻面。",
    textKo:
      "당신의 머신에 조화결정이 없다면, 당신의 머신은 TransForm하고, 당신의 연소완료 조화결정 2개를 회복한다. 그렇지 않을 경우, 이 카드를 미사용으로 되돌린다.",
    textEn:
  ...
  "12-raira-o-s-3": {
    ...
    textZhG1:
      "根据现在的风神槽的值，将以下牌背面朝上加入王牌，然后将此牌移出游戏。\n3以上……风魔旋风\n6以上……风魔缠回\n10以上……风魔天狗道",
    textKo:
  ...
  "12-raira-o-s-4": {
    ...
    textZh:
      "【展开中】每当你使用的非《付与》的牌结算完毕时，以将其置于你的牌库底来代替该牌将进入弃牌区。",
    textZhG1:
      "每当你使用的非《付与》的牌结算完毕时，若该牌将进入你的弃牌区，则改为将其置于你的牌库底。",
    textKo:
      "【전개중】당신이 《부여》가 아닌 통상패를 사용했을 경우, 그것을 버림패로 하는 대신 패산 밑에 둔다.",
    textEn:
      "Ongoing: Whenever you play a non-Special, non-Enhancement card, put that card on the bottom of your deck instead of into your played pile after it resolves.",
  },
  "12-raira-o-s-3-ex1": {
    megami: "raira",
    name: "風魔旋風",
  ...
  "13-utsuro-o-n-2": {
    ...
    textZh:
      "【攻击后】若对手选择由装承受此次伤害，则检视对手的手牌，弃置其中1张。",
    textZhG1:
      "【攻击后】若对手选择由装承受此次伤害，则检视对手的手牌，弃置其中一张。",
    textKo:
      "【공격후】상대가 오라로의 대미지를 골랐다면, 상대의 손패를 보고 그 중 1장을 골라, 그것을 버림패로 한다.",
    textEn:
      "After Attack: If your opponent chose to take damage to Aura, look at their hand. Choose a card from it and put it into their played pile.",
  },
  "13-utsuro-o-n-3": {
    megami: "utsuro",
    name: "刈取り",
  ...
  "13-utsuro-o-n-4": {
    ...
    textZh:
      "对手从其装、气、命三个区域中选择1个樱花结晶移至虚。\n灰尘～若虚中的樱花结晶数大于等于12，则令对手畏缩。",
    textZhG1:
      "对手从其装、气、命三个区域中选择1个樱花结晶移至虚。 灰尘-若虚中的樱花结晶的数目大于12，则对手畏缩。",
    textKo:
      "상대는 상대의 오라, 플레어, 라이프 중 원하는 곳에서 벚꽃 결정을 하나 더스트로 이동시킨다.\n 회진-더스트가 12 이상이라면、상대를 위축시킨다.",
    textEn:
      "Your opponent moves 1 Sakura token from their Aura, Flare, or Life to Shadow.\n\nAshen - If there are 12 or more Sakura tokens on Shadow, flinch your opponent.",
  },
  "13-utsuro-o-n-5": {
    megami: "utsuro",
    name: "影の翅",
    ...
    textEn:
      "For the rest of the turn, the current Distance is increased by 2, and the size of the Mastery Zone is increased by 2.",
  },
  "13-utsuro-o-n-6": {
    megami: "utsuro",
    name: "影の壁",
  ...
  "13-utsuro-o-s-1": {
    ...
    textZh:
      "【常时】此牌的费用减小X，X等于虚中的樱花结晶的数目。\n敌命→3→虚\n将此牌移出游戏。",
    textZhG1:
      "【常时】此牌的费用减小X，X等于虚中的樱花结晶的数目。敌命（3）→虚 将此牌移出游戏。",
    textKo:
      "【상시】이 카드의 소비는 더스트의 수 만큼 줄어든다.\n 상대 라이프→더스트：3 \n 이 카드를 제외한다.",
    textEn:
  ...
  "13-utsuro-o-s-2": {
    ...
    textZh:
      "【展开中】对手的《攻击》得距离缩小（近1），且不结算其【攻击后】效果。\n【展开中】对手的《付与》牌的纳减少1，且不结算其【破弃时】效果。",
    textZhG1:
      "【展开中】对手的《攻击》得距离缩小（近1），其攻击后效果无效。\n【展开中】对手的《付与》牌的纳减少1，其破弃时效果无效。",
    textKo:
      "【전개중】상대의 《공격》은 거리축소(근1)을 얻고, 【공격후】효과가 해결되지 않는다.\n 【전개중】상대의 《부여》카드는 납이 1 감소하고, 【파기시】효과가 해결되지 않는다.",
    textEn:
  ...
  "13-utsuro-o-s-3": {
    ...
    textZh:
      "【展开中】若你因被攻击受到了1点或以上的伤害，则在该《攻击》效果结算完毕后，将此牌上所有樱花结晶移入虚。\n【破弃时】结束当前阶段。\n----\n【再起】灰尘～虚中的樱花结晶数大于等于12。",
    textZhG1:
      "【展开中】若你受到了大于1点的伤害，则将此牌上所有樱花结晶移入虚。\n【破弃时】结束当前阶段。\n----\n【再起】灰尘-虚中的樱花结晶的数目大于12。",
    textKo:
      "【전개중】당신에게 1 이상의 대미지를 준  《공격》을 해결한 뒤, 이 카드 위의 벚꽃 결정을 모두 더스트로 보낸다.\n 【파기시】현재 페이즈를 종료한다.\n ----\n 【재기】회진-더스트가 12 이상이다.",
    textEn:
...
// シーズン3
export const S3_UPDATED_CARD_DATA: Partial<{
  ...
  "02-saine-o-n-3": {
    ...
    textEn:
      "After Attack: Idea - If you have no Sakura tokens on your Aura:\n\nShadow (1)→ Distance",
  },
  "02-saine-o-n-6": {
    megami: "saine",
    name: "衝音晶",
  ...
  "04-tokoyo-A1-n-5": {
    ...
    textZhG1:
      "【展开中】每当你使用的具《对应》副类别的牌结算完毕时，虚（1）→自装\n【展开中】对手的回合内不能移除此牌上的樱花结晶。",
    textKo:
      "【전개중】당신이 《대응》카드를 사용했을 때, 그 해결 후 더스트→자신 오라：1 \n【전개중】상대 턴에 이 카드 위 벚꽃 결정은 이동하지 않는다.",
    textEn:
      "Ongoing: Whenever you play a Reaction card, after that card resolves:\nShadow (1)→ Your Aura\n\nOngoing: Sakura tokens cannot leave this card on your opponent's turn.",
  },
  "04-tokoyo-A1-s-2": {
    megami: "tokoyo",
    anotherID: "A1",
  ...
  "11-thallya-o-s-3": {
    ...
    textZh:
      "【已使用】你的回合内，每当你由于基本动作以外的效果发动骑动结算完毕时，若此次骑动改变了距离，则你可以选择：虚↔1↔距",
    textZhG1:
      "【已使用】你的回合内，每当你的骑动效果结算完毕时，若此效果改变了距离且不属于基本动作，则你可以选择\n虚（1）⇔ 距",
    textKo:
      "【사용완료】당신의 턴에, 당신이 기본동작 이외의 방법으로 기동을 행하고, 간격에 변화를 줄 때마다\n더스트⇔간격：1 \n를 행해도 좋다.",
    textEn:
      "Devoted: During your turn, whenever your non-basic action Maneuver changes the Distance, you may:\nShadow (1)⇔ Distance",
  },
  "11-thallya-o-s-4": {
    megami: "thallya",
    name: "Julia's BlackBox",
  ...
  "05-oboro-A1-s-4-ex1": {
    ...
    textZh:
      "【常时】这张牌不能以正常方法使用。仅当你第一次将要输掉本局游戏时，可以以立即使用此牌（仍需支付费用）来代替失败的发生。\n虚→1→自命",
    textZhG1:
      "【常时】只能当你将受到大于自命中樱花结晶数目的命伤时使用此牌。每局游戏限使用一次。\n防止此次命伤，虚（1）→自命",
    textKo:
      "【상시】이 카드는 통상 방법으로는 사용 할 수 없다. 당신이 처음 패배하려 한다면, 대신 이 카드를 사용해도 좋다(소비는 지불한다). \n더스트→자신 라이프：1",
    textEn:
      "Forced: This card has no effect when played normally. When you would lose the game for the first time, instead you may play this card (paying its cost).\n\nShadow (1)→ Your Life",
  },
  ...
  "13-utsuro-A1-n-2": {
    ...
    textKo:
      "【공격후】상대가 라이프로의 대미지를 골랐다면, 상대 플레어→더스트：2",
    textEn:
  ...
  "13-utsuro-A1-s-1": {
    ...
    textAdditional:
      "「終焉の影が蘇る」- 山札、手札、伏せ札、捨て札、付与札にある切札でないカードをすべて取り除き、代わりに「万象乖ク殲滅ノ影」「我ヲ亡クシテ静寂ヲ往ク」「終焉、来タレ」の3枚を捨て札に置き、その後山札を再構成する。\n（条件を満たした状態で、このカードを右クリックすることにより発動可能）",
    textZh:
      "若敌命中的樱花结晶数大于等于8，则：敌命→1→虚\n【已使用】在双方的每个结束阶段，若虚中的樱花结晶的数目大于等于13，则终焉之影苏醒。然后将此牌移出游戏，从追加牌区以已使用状态获得王牌『夙愿』，最后抓1张牌。",
    textZhG1:
      "若敌命中樱花结晶的数目大于8，则敌命（1）→虚\n【已使用】每当双方的结束阶段结束时，若虚中的樱花结晶的数目大于13，则『终焉之影』苏醒（移除你展开中的《付与》牌上的所有樱花结晶，这些牌的破弃时效果无效，将你的所有通常牌移出游戏，将追加牌『万象乖离残灭之影』『自灭往寂』『末日来临』以任意顺序置于你的牌库顶）。将追加牌『欲望』正面朝上加入王牌，抓一张牌，将此牌移出游戏。",
    textZhAdditional:
      "「终焉之影苏醒」～将你手牌、牌库、盖牌区、弃牌区与付与区中的所有非王牌移出游戏（付与牌的破弃时效果不发动），从追加牌区将『万象乖离残灭之影』『灭吾之身静以思』『终焉、降临吧』置入弃牌区，然后重铸牌库。",
    textKo:
      "상대의 라이프가 8 이상이라면, 상대 라이프→더스트：1 \n【사용완료】당신 또는 상대의 종료 페이즈시 더스트가 13이상이라면, 종언의 그림자가 되살아난다. 그 후, 이 카드를 제외하고, 당신의 추가패에서 비장패 「욕망~желание~」를 사용완료로 얻고, 카드를 1장 뽑는다.",
    textEn:
      "If your opponent's Life is 8 or more:\nOpponent's Life (1)→ Shadow\n\nDevoted: At the end of each player's turn, if there are 13 or more Sakura tokens on Shadow, the end is nigh. Remove this card from the game. Add your set aside \"желание\" to your Special cards, face-up (Devoted). Draw a card.",
    removable: true,
  },
  ...
  "13-utsuro-A1-s-1-ex4": {
    ...
    textKo:
      "【파기시】상대는 손패와 패산을 모두 버림패로 한다. 상대의 집중력은 0이 된다. 상대를 위축시킨다.",
    textEn:
      "Disenchant: Put all cards in your opponent's hand and deck into their played pile. Their Vigor becomes 0. Flinch them.",
  },
  ...
  "14-honoka-o-n-6": {
    ...
    textZh:
      "【展开中】对手的回合内，你的手牌与牌库中的牌不会被弃置或盖伏。\n（使用的牌依然进入弃牌区）\n【展开中】你不会畏缩。\n【破弃时】你获得1点集中力。",
    textZhG1:
      "【展开中】对手的回合内，所有盖伏或弃置你手牌或牌库中牌的效果无效。\n【展开中】所有使你畏缩的效果无效。\n【破弃时】你获得1点集中力。",
    textKo:
      "【전개중】상대 턴에 당신의 손패와 패산에 있는 카드는 덮임패, 버림패가 되지 않는다.\n(사용한 카드는 평소대로 버림패가 된다) \n【전개중】당신은 위축되지 않는다.\n【파기시】당신은 집중력을 얻는다.",
    textEn:
      "Ongoing: During your opponent's turn, cards in your hand and deck cannot be put into your discard or played piles.\n(Played cards will go to the played pile as usual.)\n\nOngoing: You cannot be flinched.\n\nDisenchant: Gain 1 Vigor.",
  },
  "14-honoka-o-n-7": {
    megami: "honoka",
    name: "追い風",
    ...
    textEn:
      "Ongoing: Increase the Range of your attacks by 1 in the distant direction.",
  },
  "14-honoka-o-s-1": {
    megami: "honoka",
    name: "胸に想いを",
    ...
    textZh:
      "开花～将这张『感存心间』与追加牌区的『樱结手弦』交换，将『樱结手弦』变为未使用状态。",
    textZhG1:
      "开花-将此牌与追加牌『结樱于手』交换，将『结樱于手』翻为背面朝上。",
    textKo:
      "개화-이 「품속에 마음을」을 추가패의 「양손에 꽃을」과 교환하고, 미사용으로 되돌린다.",
    textEn:
      'Bloom - Exchange this with your set aside "Flowers in Your Hands" and turn that card face-down.',
  },
  "14-honoka-o-s-1-ex1": {
    megami: "honoka",
    name: "両手に華を",
    ...
    textZh:
      "【已使用】开花～每当你的结束阶段，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将这张『樱结手弦』与追加牌区的『旋即旌招幕展』交换，将『旋即旌招幕展』变为未使用状态。",
    textZhG1:
      "【已使用】开花-每当你的结束阶段结束时，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将此牌与追加牌『旋即旌招幕展』交换，将『旋即旌招幕展』翻为背面朝上。",
    textKo:
      "【사용완료】개화-당신의 종료 페이즈에 당신의 오라에 있는 벚꽃 결정을 2개까지 이 카드 위에 올려도 좋다. 그 결과, 딱 5개가 되었다면, 그 개화결정들을 당신의 플레어로 이동시키고, 이 「양손에 꽃을」을 추가패의 「그리고 새로운 개막을」로 교환하고, 미사용으로 되돌린다.",
    textEn:
      'Bloom - At the end of your turn, you may move up to 2 Sakura tokens from your Aura to this card. Then if there are exactly 5 Sakura tokens on this card, move them all to your Flare, exchange this card with your set aside "And So Begins the Rising of a New Curtain", and turn that card face-down.',
  },
  "14-honoka-o-s-1-ex2": {
    megami: "honoka",
    name: "そして新たな幕開けを",
    ...
    textZh:
      "【已使用】每当你的结束阶段，进行一次“攻击距离0-10、伤害X/X、不可被对应、【常时】X等于场上樱花结晶数等于5的区域的个数”的攻击。（结束阶段存在樱花结晶的区域包括距、命(2个)、装(2个)、气(2个)、虚、付与区(2个)、王牌区(2个)、游戏外）",
    textZhG1:
      "【已使用】每当你的结束阶段结束时，进行一次“攻击距离0-10 伤害X/X 不可被对应 X等于场上樱花结晶数等于5的领域的个数。”的攻击。",
    textKo:
      "【사용완료】당신의 종료 페이즈에 공격 「적정거리 0-10、X/X、대응불가 【상시】X는 벚꽃 결정이 딱 5개 있는 영역의 수와 같다」를 행한다.",
    textEn:
      'Devoted: At the end of your turn, you attack with "Range: 0-10, Damage: X/X, No Reactions, Forced: X is the number of zones with exactly 5 Sakura tokens."',
  },
  "14-honoka-o-s-2": {
    megami: "honoka",
    name: "この旗の名の下に",
    ...
    textZh:
      "【常时】当你使用此牌时，你可以选择你的付与区中的一张展开中的付与牌。因此《攻击》造成的伤害将移动的樱花结晶改为移动至所选择的付与牌上。",
    textZhG1:
      "【常时】当你使用此牌时，你可以选择你的一张展开中的《付与》牌。若此《攻击》将造成伤害，则将因结算伤害移动的樱花结晶移至所选择的付与牌上。",
    textKo:
      "【상시】이 카드를 사용 할 때, 당신의 부여패를 1장 선택해도 좋다. 이 《공격》의 대미지에 의해 이동하는 벚꽃 결정은, 가능하다면 더스트나 플레어로가 아닌 선택한 부여패로 움직인다. \n(부여패가 존재하지 않음 등의 불가능한 경우에는 통상대로 벚꽃 결정을 움직인다)",
    textEn:
      "Forced: As you play this card, you may choose one of your Enhancements in play. Damage dealt by this attack moves Sakura tokens to that card instead of to Shadow or to Flare.",
  },
  "14-honoka-o-s-3": {
    megami: "honoka",
    name: "四季はまた廻り来る",
    ...
    textZh:
      "盖伏你的牌库。从你的盖牌区和弃牌区中选择至多4张牌，以任意顺序置于你的牌库顶。",
    textZhG1:
      "盖伏你的牌库。从你的盖牌区和弃牌区中选择4张牌，以任意顺序置于你的牌库顶。",
    textKo:
      "당신의 패산을 모두 덮임패로 한다. 덮임패, 버림패에서 카드를 4장까지 골라, 그것들을 원하는 순서로 패산 위에 둔다.",
    textEn:
      "Put your deck into your discard pile, then choose up to 4 cards from among your discard and played piles. Put the chosen cards on top of your deck in any order.",
  },
  "14-honoka-o-s-4": {
    megami: "honoka",
    name: "満天の花道で",
    ...
    textZh:
      "【展开中】若此牌上的樱花结晶将被移至虚，则改为将其移至自装，若自装中樱花结晶的数目大于等于5，则改为将其移至自气。",
    textZhG1:
      "【展开中】若此牌上的樱花结晶将被移至虚，则改为将其移至自装，若自装中樱花结晶的数目大于5，则改为将其移至自气。",
    textKo:
      "【전개중】이 부여패 위의 벚꽃 결정이 더스트로 보내진다면, 그것은 대신 당신의 오라로 이동한다. 당신의 오라가 5 이상이라면, 대신 당신의 플레어로 이동한다.",
    textEn:
      "Ongoing: If a Sakura token would be moved from this card to Shadow, instead move it to your Aura. If there are already 5 or more Sakura tokens on your Aura, instead move it to your Flare.",
  },
};

// シーズン4
export const S4_UPDATED_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> =
  {
    "03-himika-o-n-2": {
      megami: "himika",
      name: "ラピッドファイア",
      ...
      textZh:
        "【常时】连火～若此牌是本回合你使用的第3张或更多的牌，则此《攻击》得+1/+1。",
      textZhG1:
        "【常时】连火～若本回合你已使用至少2张牌，则此《攻击》得+1/+1。",
      textKo:
        "【상시】연화-이 카드가 이 턴에 사용한 3장째 이후의 카드라면, 이 《공격》은 +1/+1이 된다.",
      textEn:
        "Forced: Inferno - This attack gains +1/+1 if this is the third or later card you've played this turn.",
    ...
    "13-utsuro-A1-s-1": {
      ...
      textAdditional:
        "「終焉の影が蘇る」- 山札、手札、伏せ札、捨て札、付与札にある切札でないカードをすべて取り除き、代わりに「万象乖ク殲滅ノ影」「我ヲ亡クシテ静寂ヲ往ク」「終焉、来タレ」の3枚を捨て札に置き、その後山札を再構成する。\n（条件を満たした状態で、このカードを右クリックすることにより発動可能）",
      textZh:
        "【展开中】仅当虚中的樱花结晶数大于等于13，且自命中的樱花结晶数小于等于6时可以移动此牌上的樱花结晶。\n【破弃时】若当前阶段为准备阶段，则终焉之影苏醒。然后将此牌移出游戏，从追加牌区以已使用状态获得王牌『夙愿』，最后抓1张牌。",
      textZhG1:
        "【展开中】仅当虚中的樱花结晶的数目大于等于13，且自命中的樱花结晶的数目小于等于6时可以移动此牌上的樱花结晶。\n【破弃时】若当前阶段为准备阶段，则终焉之影苏醒（将你手牌、牌库、盖牌区、弃牌区与付与区中的所有非王牌移出游戏（付与牌的破弃时效果不发动），将追加牌『万象乖离残灭之影』『自灭往寂』『终焉将至』洗混后置于你的牌库顶）。然后从追加牌区域将追加牌『夙愿』以已使用状态加入王牌，抓1张牌，将此牌移出游戏。",
      textZhAdditional:
        "「终焉之影苏醒」～将你手牌、牌库、盖牌区、弃牌区与付与区中的所有非王牌移出游戏（付与牌的破弃时效果不发动），从追加牌区将『万象乖离残灭之影』『灭吾之身静以思』『终焉、降临吧』置入弃牌区，然后重铸牌库。",
      textKo:
        "【전개중】더스트가 13이상이고 당신의 라이프가 6이하일 경우에만 이 카드 위의 벚꽃결정이 이동한다.\n【파기시】현재 페이즈가 개시 페이즈라면 종언의 그림자가 되살아난다. 그 후에 이 카드를 제외하고 당신의 추가패에서 「욕망」을 사용된 상태로 얻고 카드를 1장 뽑는다.",
      textEn:
        'Ongoing: Sakura tokens cannot leave this card unless there are 13 or more Sakura tokens on Shadow, and your Life is 6 or less.\n\nDisenchant: If it is currently the beginning of turn phase, the end is nigh, then remove this card from the game and add your set aside "желание" to your Special cards face-up. Draw a card.',
      removable: true,
    },
    "14-honoka-o-n-6": {
      megami: "honoka",
      ...
      textZh:
        "【展开中】每当你的结束阶段，进行一次“攻击距离1-5、伤害1/1、不可被对应”的攻击。",
      textZhG1:
        "【展开中】每当你的结束阶段开始时，进行一次“攻击距离1-5 伤害1/1 不可被对应”的攻击。",
      textKo:
        "【전개중】당신의 엔드 페이즈 시에 공격 「적정거리 1-5, 1/1, 대응불가」을 한다.",
      textEn:
        'Ongoing:You attack with\n"Range: 1-5, Damage: 1/1 No Reaction" at your end phase.',
    },
    "14-honoka-o-s-3": {
      megami: "honoka",
      name: "四季はまた廻り来る",
      ...
      textZh:
        "你可以从你的盖牌区中选择1张牌，将其置于你的牌库底。\n你可以抓1张牌。\n盖伏1张手牌。若如此做，执行1次基本动作《装附》。\n【已使用】每当你的牌从追加牌区移至其他区域时，你可以将此牌移至追加牌区，若如此做，则从追加牌区以未使用状态再次获得此牌。",
      textZhG1:
        "你可以从你的盖牌区中选择1张牌，将其置于你的牌库底。\n你可以抓1张牌。\n盖伏1张手牌。若如此做，执行1次基本动作《装附》。\n【已使用】每当你的牌从追加牌区域移至其他区域时，你可以将此牌移至追加牌区域，若如此做，则将此牌以未使用状态加入王牌。",
      textKo:
        "당신의 덮임패에서 1장을 골라서 패산 맨 밑으로 보내도 좋다.\n카드를 1장 뽑아도 좋다.\n손패를 1장 덮임패로 한다. 그렇게 한 경우, 기본 동작 《휘감기》를 1번 한다.\n\n【사용됨】당신의 카드가 추가패에서 다른 영역으로 이동했을 때, 이 카드를 추가패로 이동시켜도 좋다. 그 후에 이 카드를 미사용으로 추가패에서 얻는다.",
      textEn:
    ...
    "02-saine-A2-s-3": {
      ...
      textZhG1:
        "被对应的《攻击》结算完毕后，若你选择用装承受该《攻击》的伤害，且自装中的樱花结晶的数目等于0，则结束当前阶段。\n【再起】八相～自装中的樱花结晶的数目等于0。",
      textKo:
        "대응한 《공격》 해결 후에 그 《공격》에서 오라 데미지를 선택했고 당신의 오라가 0이라면 현재의 페이즈를 종료한다.\n----\n【재기】팔상-당신의 오라가 0이다.",
      textEn:
        "After the attack you played this card as Reaction to resolves, if you chose to take damage to your Aura, and you now have no Sakura tokens on your Aura, end the current phase.\n\nResurgence: Idea - You have no Sakura tokens on your Aura.",
    },
    "07-shinra-A1-n-2": {
      megami: "shinra",
      anotherID: "A1",
    ...
    "10-kururu-A1-s-3": {
      ...
      textZh:
        "<攻> 对手选择其盖牌区中的1张牌。你宣言1个牌名，并弃置所选择的牌。若你宣言的牌名与所选择牌的牌名一致，则将1个樱花结晶从虚移至此牌上。当此牌上的樱花结晶数达到2个后，则将其上所有樱花结晶移至虚，进行世纪的大发现，此牌额外获得终端。\n----\n【即再起】你重铸牌库后。",
      textZhG1:
        "机巧：红～对手选择其盖牌区中的1张牌。你宣言1个牌名，并弃置所选择的牌。若你宣言的牌名与所选择牌的牌名一致，则将1个樱花结晶从虚移至此牌上。当此牌上的樱花结晶的数目达到2个后，则将其上所有樱花结晶移至虚，进行世纪的大发现（查看对手的所有王牌。这之后选择你或者对手，将所选玩家寄宿的女神的王牌中在眼前构筑时没有被选上的5张，从追加牌处以未使用的状态获得。再将『不懈探索』移出游戏并从追加牌处以未使用的状态获得『壮绝旅途』），此牌额外获得终端。\n----\n【即再起】你重铸牌库后",
      textZhAdditional:
    ...
    "15-korunu-o-n-3": {
      ...
      textEn:
        "Forced: If your opponent's Aura is full, this attack gets +1/+1.",
    },
    "15-korunu-o-n-4": {
      megami: "korunu",
      name: "雪渡り",
    ...
    "15-korunu-o-n-7": {
      ...
      textZh:
        "【展开中】若对手被冻结，则每当对手的准备阶段开始时，对手选择以下2项。该开始阶段结算时跳过对手选择的步骤。\n●获得1点集中力；\n●从每张展开中的付与牌上移除1个樱花结晶；\n●可以重铸牌库；\n●抓2张牌。",
      textZhG1:
        "【展开中】若对手被冻结，则每当对手的开始阶段开始时，对手选择2项。该开始阶段结算时跳过对手选择的步骤。\n1.获得1点集中力；\n2.从每张展开中的付与牌上移除1个樱花结晶；\n3.可以重铸牌库；\n4.抓2张牌。",
      textKo:
        "【전개중】상대의 오라에 동결 토큰이 있다면 상대의 개시 페이즈 때에 아래의 단계 중 2개를 골라서 무시한다.\n・집중력을 1얻는다.\n・부여패에서 벚꽃결정을 1개씩 더스트로 보낸다.\n・패산의 재구성을 해도 좋다.\n・카드를 2장 뽑는다.",
      textEn:
        "Ongoing: If your opponent has any Ice counters, at the beginning of their turn, they choose two of the following steps and skip them that phase:\n・Gain 1 Vigor.\n・Move 1 Sakura token from each Enhancement in play to Shadow.\n・You may reshuffle your deck.\n・Draw 2 cards.",
    },
    "15-korunu-o-s-1": {
      megami: "korunu",
      name: "コンルルヤンペ",
    ...
    "16-yatsuha-o-s-1": {
      ...
      textZh:
        "若自命中的樱花结晶的数目小于敌命，则进行一次《攻击》，该《攻击》为被对应的《攻击》的复制并且对应了那个被对应的《攻击》。（复制的《攻击》的攻击距离、伤害、【攻击后】效果、有无超克、使用女神均与被复制的攻击相同。攻击距离与伤害使用由其他效果修正后的值。）\n打消被对应的非王牌的《攻击》。",
      textZhG1:
        "若自命中的樱花结晶的数目小于敌命，则进行一次《攻击》，该攻击为被对应的攻击的复制\n（复制的《攻击》的攻击距离、伤害、【攻击后】效果、有无超克、使用女神均与被复制的攻击相同。攻击距离与伤害使用由其他效果修正后的值）\n打消被对应的非王牌的《攻击》。",
      textKo:
        "당신의 라이프가 상대의 라이프보다 적다면 대응한 《공격》의 복제에 해당되는 《공격》을 한다. 그 《공격》은 대응한 《공격》에 대응한 것으로 취급한다. (복제란 적정거리, 데미지, 【공격후】 효과, 초극의 유무, 사용 여신의 동일한 공격이다. 적정거리나 데미지는 모든 효과를 적용한 후의 것을 사용한다)\n대응한 비장패가 아닌 《공격》을 무효로 한다.",
      textEn:
...
// シーズン4プレ更新
export const S4_PRE_UPDATED_CARD_DATA: Partial<{
  ...
  "12-raira-o-s-4": {
    ...
    textZh:
      "【展开中】对手进行的《攻击》结算完毕时，执行以下内容。\n距←1→虚\n\n选择风神槽或雷神槽，其值增加1。",
    textZhG1:
      "【展开中】每当对手进行的《攻击》结算完毕时，你可以依序执行以下动作。\n距（1）⇔ 虚 \n选择风神槽或雷神槽，其值增加1。",
    textKo:
      "【전개중】상대가 《공격》을 했다면, 해결 후에 아래를 실행해도 좋다.\n간격⇔더스트：1\n\n풍신 게이지 또는 뇌신 게이지를 1올린다.",
    textEn:
      "Ongoing: Whenever your opponent attacks, after it is resolved, you may:\nDistance (1)⇔ Shadow\nIncrease your Wind God or Thunder God gauge by 1.",
  },
  "13-utsuro-o-s-4": {
    megami: "utsuro",
    name: "魔食",
...
export const S6_UPDATED_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> =
  {
    ...
    "18-mizuki-o-n-2": {
      ...
      textZh:
        "【常时】若你在上个回合进行了对应，此《攻击》得+2/+1。\n全力化：【常时】此《攻击》得+1/+1。",
      textZhG1:
        "【常时】若上一回合内你进行过对应，则此《攻击》得+2/+1。\n全力化（主要阶段，若你选择执行全力行动，则你可以如使用《全力》牌一样使用此牌。若如此做，则此牌额外获得以下效果）：【常时】此《攻击》获得+1/+1。",
      textKo:
        "【상시】당신이 직전 턴에 대응을 했다면, 이 《공격》은 +2/+1된다.\n전력화：【상시】이 《공격》은 +1/+1된다.",
      textEn:
    ...
    "18-mizuki-o-n-6": {
      ...
      textZh:
        "选择以下选项3次，且同样的选项可以重复选择：\n●进行1次征兵。\n●进行基本动作《前进》。\n●进行基本动作《装附》。",
      textZhG1:
        "选择3次。你可以多次选择同一个选项：\n1.进行1次征兵；\n2.执行1次基本动作《前进》；\n3.执行1次基本动作《装附》。",
      textKo:
        "아래를 3번 고른다. 같은 것을 여러 선택해도 좋다.\n・징병을 1번 한다.\n・기본 동작 《전진》을 한다.\n・기본 동작 《휘감기》를 한다.",
      textEn:
        "Choose three. You may choose the same option more than once:\n・Conscript a Unit.\n・Perform a Forward Movement basic action.\n・Perform a Recover basic action.",
    },
    ...
    "14-honoka-A1-n-1-ex1": {
      ...
      textZh:
        "【攻击后】若对手选择由装承受此次伤害，则检视对手的手牌，弃置其中1张。若对手选择由命承受此次伤害，则敌气→2→虚\n【攻击后】将这张『影之两手』与追加牌区的『樱之双剑』交换。若如此做，则你可以将『樱之双剑』置于你的牌库底。",
      textZhG1:
        "敌装（1）→自装\n开花～根据虚中樱花结晶的数目，将这张『独自醒来』与下述的卡牌交换，并置于牌库底。\n5或以下……『向目标前进』\n6或以上……『直视阴暗面』",
      textKo:
        "【공격후】상대가 오라에 대한 데미지를 선택했다면 상대의 손패를 보고 그 중에서 1장을 골라서 그것을 버림패로 한다. 상대가 라이프에 대한 데미지를 선택했다면,\n상대 플레어→더스트：2\n【공격후】이 「그림자 양손」을 추가패의 「벚꽃 쌍검」과 교환한다. 그렇게 했다면 그 「벚꽃 쌍검」을 패산 아래에 두어도 좋다.",
      textEn:
        'After Attack: If your opponent chose to take damage to Aura, look at their hand. Choose a card from it and put it into their played pile. If they chose to take damage to Life:\nOpponent\'s Flare (2)→ Shadow\n\nAfter Attack: Exchange this card with your set aside "Brands of Sakura". If you do, you may put that card on the bottom of your deck.',
    },
    "14-honoka-A1-s-1": {
      megami: "honoka",
      anotherID: "A1",
      ...
      textZhG1:
        "【攻击后】若对手选择由装承受此次伤害，则检视对手的手牌，从中选择1张弃置。若对手选择由命承受此次伤害，则敌气（2）→虚\n【攻击后】将这张『影之两手』与追加牌区域中的『樱之双剑』交换。若如此做，则你可以将『樱之双剑』置于你的牌堆底。",
      textKo:
    ...
    "19-megumi-o-n-3": {
      ...
      textZhG1:
        "【攻击后】本回合内你使用的下一张其他女神的《付与》牌获得生长2。",
      textKo:
    ...
    "19-megumi-o-s-2": {
      ...
      textZh:
        "【常时】X等于你付于区中展开中的付于牌上的种子结晶的数目。\n【常时】此《攻击》得+X/+0。\n【攻击后】被对应的《攻击》得-X/+0。",
      textZhG1:
        "【常时】X等于置于你的展开中的付与牌上的种子结晶的总数。\n【常时】此《攻击》获得+X/+0。\n【攻击后】被对应的《攻击》获得-X/+0。",
      textKo:
        "【상시】X는 당신의 부여패에 있는 씨앗 결정의 개수에 해당된다.\n【상시】이 《공격》은 +X/+0 된다.\n【공격후】대응한 《공격》은 -X/+0 된다.",
      textEn:
        "Forced: X is the number of Seed tokens on your Enhancements in play.\n\nForced: This attack gets +X/+0.\n\nAfter Attack: The attack this card was played as a Reaction to gets -X/+0.",
    },
    "19-megumi-o-s-3": {
      megami: "megumi",
      name: "結末の果実",
    ...
    "20-kanawe-o-n-1": {
      ...
      textZh:
        "【常时】X等于现在的幕的值的一半(向上取整)。\n【攻击后】现在的幕的值是偶数的话：距↔1↔虚",
      textZhG1:
        "【常时】X等于当前剧幕的值的一半（向上取整）。\n【攻击后】若当前剧幕的值为偶数，则\n距（1）⇔虚",
      textKo:
        "【상시】X는 현재의 막의 수치의 절반(소수점 올림)과 같다.\n【공격후】현재의 막의 수치가 짝수라면,\n간격⇔더스트：1",
      textEn:
    ...
    "20-kanawe-o-n-3": {
      ...
      textZh:
        "【常时】现在的幕的颜色是《紫》的话，此攻击得+0/+1。\n【攻击后】你在这个回合构想无法推进。",
      textZhG1:
        "【常时】若当前剧幕的颜色为【紫】，则此《攻击》获得+0/+1。\n【攻击后】本回合内你不能达成构想。",
      textKo:
        "【상시】현재의 막의 색이 보라색이라면, 이 《공격》은 +0/+1된다.\n【공격후】당신은 이 턴에 구상을 진행시킬 수 없다.あなたはこのターンに構想を進められない。",
      textEn:
    ...
    "20-kanawe-o-n-4": {
      ...
      textZh:
        "你可以进行1次基本动作《装附》，然后你可以进行1次《装附》以外的基本动作。\n全力化：你可以从追加牌区或者已达成的构想牌里准备1张构想。令对手畏缩。",
      textZhG1:
        "你可以执行1次基本动作《装附》。然后你可以执行1次《装附》以外的基本动作。\n全力化：你可以从追加区或已达成区域准备1张构想牌。对手畏缩。",
      textKo:
        "기본 동작 《휘감기》를 1번 해도 좋다. 그 후, 《휘감기》 이외의 기본 동작을 1번 해도 좋다.\n전력화：추가패 또는 달성된 구상 카드를 1장 준비해도 좋다. 상대를 위축시킨다.",
      textEn:
        "You may perform a Recover basic action, then you may perform a non-Recover basic action.\n\nAll-Out: You may prepare one of your set aside or completed Plot cards. Flinch your opponent.",
    },
    "20-kanawe-o-n-5": {
      megami: "kanawe",
      name: "残光",
      ...
      textAdditional:
        "（自分の手札を右クリックすることで、手札を相手プレイヤーに公開することが可能）",
      textZh: "检视对手的手牌，选其中1张置于牌库底。对手获得1点集中力。",
      textZhG1:
        "查看对手手牌，从中选择1张置于对手的牌堆底。对手获得1点集中力。",
      textZhAdditional: "（右键自己的手牌区可以将手牌展示给对方玩家）",
      textZhG1Additional: "（右键自己的手牌区可以将手牌展示给对方玩家）",
      textKo:
        "상대의 손패를 보고 그 중에서 1장을 고르고 그것을 패산의 밑에 둔다. 상대는 집중력을 1 얻는다.",
      textKoAdditional:
        "(자신의 손패를 우클릭해서 손패를 상대 플레이어에게 공개할 수 있음)",
      textEn:
        "Look at your opponent's hand. Choose a card from it and put it at the bottom of their deck. They gain 1 Vigor.",
    ...
    "20-kanawe-o-n-6": {
      ...
      textZh:
        "从手牌中选1张其他女神的非《全力》的《攻击》牌，你可以使用之。若此牌对应了一个《攻击》，则视为所选择的牌也对应了那个《攻击》。这之后，如果现在的幕的颜色是《绿》的话，将所选这的那张牌移回手牌。",
      textZhG1:
        "你可以从手牌中使用1张其他女神的非全力的《攻击》牌。若此牌对应了一个《攻击》，则视为所使用的牌也对应了该《攻击》。然后若当前剧幕的颜色为【绿】且该牌位于弃牌区，则将该牌置入手牌。",
      textKo:
        "손패에서 다른 여신의 전력이 아닌 《공격》 카드를 1장 사용해도 좋다. 이 카드로 대응하고 있는 《공격》이 있다면, 사용된 카드는 그것에 대응한 것처럼 취급한다. 그 후, 현재의 막의 색이 녹색에다가 그 카드가 버림패에 있다면, 그 카드를 손패로 되돌린다.",
      textEn:
        "You may choose a non-Kanawe, non-Throughout Attack card in your hand and play it. If this card was played as a Reaction to an attack, treat that card as if it were played as a Reaction to that attack. Then, if the current Act is Green and that card is in your played pile, return that card to your hand.",
    },
    "20-kanawe-o-n-7": {
      megami: "kanawe",
      name: "封殺",
    ...
    "20-kanawe-o-s-3": {
      ...
      textZh:
        "【攻击后】打消被对应的《攻击》。那个《攻击》是通常牌的话，将其置于牌库顶；那个《攻击》是王牌的话，将其变回未使用的状态。",
      textZhG1:
        "【攻击后】打消被对应的《攻击》。若被对应的《攻击》为通常牌，则将该牌置于牌库顶。若被对应的《攻击》为王牌，则将该牌变为未使用状态。",
      textKo:
        "【공격후】대응한 《공격》을 무효화한다.\n그 《공격》이 통상패라면 그 카드를 패산 위로 되돌린다. 그 《공격》이 비장패라면 그 카드를 미사용으로 되돌린다.",
      textEn:
        "After Attack: Cancel the attack this card was played as a Reaction to. If that attack was a Normal, put that card on the top of its owner's deck. If that attack was a Special, turn that card face-down.",
    },
    "20-kanawe-o-s-4": {
      megami: "kanawe",
      name: "はらからのあまつそら",
      ...
      textZh:
        "你可以展示你的1张手牌里的通常牌并将其移出游戏，若如此做，展示1张眼前构筑时没有选用的通常牌，并将其加入手牌。\n将此牌移出游戏，以未使用的状态获得1张眼前构筑时没有选用的王牌。",
      textZhG1:
        "你可以从手牌中展示1张通常牌并将其移出游戏。若如此做，则展示1张你眼前构筑时没有选用的通常牌，将其加入手牌。\n将此牌移出游戏，然后将1张你眼前构筑时没有选用的王牌以未使用状态加入王牌。",
      textZhAdditional: "（面朝上的状态右键就可以发动这个效果）",
      textZhG1Additional: "（面朝上的状态右键就可以发动这个效果）",
      textKo:
        "당신의 손패에서 통상패를 1장 공개하고 그것을 제외해도 좋다. 그렇게 했다면 안전구축에서 고르지 않았던 당신의 통상패 1장을 공개하고 그것을 손패에 더한다.\n이 카드를 제외하고 안전구축에서 고르지 않은 당신의 비장패 1장을 미사용으로 얻는다.",
      ...
      textEnAdditional:
        "(To use this effect, right-click on this card while it is face-up.)",
    },
    "20-kanawe-o-p-01": {
      megami: "kanawe",
      name: "殺陣",
      ...
      textKo:
        "이 턴에 《공격》이나 대응이 합계 2번 이상 이루어졌다.\n（달성회수：2）",
      textEn:
        "2 or more total attacks and Reactions to attacks were made this turn.\n(Required number of achievements: 2)",
    },
    "20-kanawe-o-p-01-will": {
      ...
      textKo:
        "이 턴에 《공격》이나 대응이 합계 5번 이상 이루어졌다.\n（달성회수：1）",
      textEn:
        "5 or more total attacks and Reactions to attacks were made this turn.\n(Required number of achievements: 1)",
    },
    "20-kanawe-o-p-02": {
      megami: "kanawe",
      name: "桜飛沫",
      ...
      textZh:
        "这个回合有至少3个的樱花结晶一次性移向付与牌区以外的区域。\n（所需完成次数：1）",
      textZhG1:
        "本回合内有至少3个樱花结晶一次性移动到了付与区以外的区域。\n（达成次数：1次）",
      textKo:
        "이 턴에 3개 이상의 벚꽃결정이 부여패 이외의 영역으로 한 번에 이동했다.\n（달성회수：1）",
      textEn:
        "3 or more Sakura tokens were moved simultaneously this turn to zones other than an Enhancement in play.\n(Required number of achievements: 1)",
    },
    "20-kanawe-o-p-02-will": {
      ...
      textZhG1:
        "本回合内有至少5个樱花结晶一次性移动到了其他区域。\n（达成次数：1次）",
      textKo:
        "이 턴에 5개 이상의 벚꽃결정이 한 번에 이동했다.\n（달성회수：1）",
      textEn:
        "5 or more Sakura tokens were moved simultaneously this turn.\n(Required number of achievements: 1)",
    },
    "20-kanawe-o-p-03": {
      megami: "kanawe",
      name: "鼓動",
      ...
      textZhG1:
        "本回合内某一方命中的樱花结晶的数目发生变化。\n（达成次数：2次）",
      textKo: "이 턴에 라이프가 변화했다.\n（달성회수：2）",
      textEn:
        "A player's Life changed this turn.\n(Required number of achievements: 2)",
    },
    "20-kanawe-o-p-03-will": {
      ...
      textZh:
        "这个回合自命或敌命发生过一次性至少2点的变化。\n（所需完成次数：1）",
      textZhG1:
        "本回合内某一方命中的樱花结晶的数目一次性变化了2及以上。\n（达成次数：1次）",
      textKo: "이 턴에 라이프가 한 번에 2이상 변화했다.\n（달성회수：1）",
      textEn:
        "A player's Life changed by 2 or more at once this turn.\n(Required number of achievements: 1)",
    },
    "20-kanawe-o-p-04": {
      megami: "kanawe",
      name: "明転",
      ...
      textEn:
        "An arrow effect was resolved this turn.\n(Required number of achievements: 2)",
    },
    "20-kanawe-o-p-04-will": {
      ...
      textEn:
        "2 or more arrow effects were resolved this turn.\n(Required number of achievements: 2)",
    },
    "20-kanawe-o-p-05": {
      megami: "kanawe",
      name: "粒立て",
      ...
      textZh:
        "不是这个回合准备的构想，并且这个回合使用了《全力》牌。\n（所需完成次数：1）",
      textZhG1:
        "本回合内没有准备构想，且本回合内使用了《全力》卡。\n（达成次数：1次）",
      textKo:
        "이 턴에 준비되지 않았고, 이 턴에 《전력》 카드가 사용되었다.\n（달성회수：1）",
      textEn:
        "This Plot was not prepared this turn, and a Throughout card was played this turn.\n(Required number of achievements: 1)",
    },
    ...
    "20-kanawe-o-p-06": {
      ...
      textZh:
        "当前距为8或以下，并且与本回合开始时的距比相差2或者以上。\n（所需完成次数：2）",
      textZhG1:
        "当前距离与回合开始时距离之差的绝对值大于等于2，且当前距离小于等于8。\n（达成次数：2次）",
      textKo:
        "현재의 간격이 턴 개시 시의 간격에서 2이상 변화했고 간격이 8이하이다.\n（달성회수：2）",
      textEn:
        "The current Distance is 8 or less, and the difference between the current Distance and the Distance at the beginning of this turn is 2 or more.\n(Required number of achievements: 2)",
    },
    "20-kanawe-o-p-06-will": {
      ...
      textZhG1:
        "当前距离与回合开始时距离之差的绝对值大于等于5。\n（达成次数：1次）",
      textKo:
        "현재의 간격이 턴 개시 시의 간격에서 5이상 변화되어 있다.\n（달성회수：1）",
      textEn:
        "The difference between the current Distance and the Distance at the beginning of this turn is 5 or more.\n(Required number of achievements: 1)",
    },
  };

// シーズン6-2
export const S6_2_UPDATED_CARD_DATA: Partial<{
  [id in TCardId]: CardDataItem;
}> = {
  "02-saine-A1-s-2": {
    megami: "saine",
    ...
    textZh:
      "终端\n令对手畏缩，你抓一张牌或获得1点集中力。\n【已使用】你的另一柱女神的《攻击》得+0/+1且不可避。\n----\n【即再起】自命受到除重铸牌库以外的1点或以上的伤害。",
    textZhG1:
      "终端\n对手畏缩。你抽1张牌或者获得1点集中力。\n【已使用】你的其他女神的《攻击》获得+0/+1和不可被闪避。\n----\n【即再起】自命受到除重鑄牌庫以外的1點及以上的傷害。",
    textKo:
  ...
  "02-saine-o-n-1": {
    ...
    textZhG1:
      "【攻击后】八相～若自装中的樱花结晶的数目小于等于1，则进行一次“攻击距离4-5、伤害2/1”的攻击。",
    textKo:
  ...
  "02-saine-o-n-3": {
    ...
    textZhG1:
      "【攻击后】八相～若自装中的樱花结晶的数目小于等于，则：虚（1）→距",
  ...
  "02-saine-o-n-4": {
    ...
    textZhG1:
      "【常时】八相～若自装中的樱花结晶的数目小于等于1，则此牌可以如《对应》牌一样对应《攻击》使用。\n距↔1↔虚",
    textKo:
  ...
  "20-kanawe-o-n-5": {
    ...
    textAdditional:
      "（自分の手札を右クリックすることで、手札を相手プレイヤーに公開することが可能）",
    textZh:
      "现在的幕的颜色是《紫》或《绿》的话，检视对手的手牌，选其中1张置于牌库底。\n对手获得1点集中力。",
    textZhG1:
      "若当前剧幕的颜色为【紫】或【绿】，则检视对手的手牌，选其中1张置于牌库底。对手获得1点集中力。",
    textZhAdditional: "（右键自己的手牌区可以将手牌展示给对方玩家）",
    textZhG1Additional: "（右键自己的手牌区可以将手牌展示给对方玩家）",
    textKo:
      "현재의 막이 자색 또는 녹색이라면, 상대의 손패를 보고 그 중에서 1장을 고르고 그것을 패산의 밑에 둔다. 상대는 집중력을 1 얻는다.",
    textKoAdditional:
      "(자신의 손패를 우클릭해서 손패를 상대 플레이어에게 공개할 수 있음)",
    textEn:
      "If the current Act is Purple or Green, look at your opponent's hand. Choose a card from it and put it at the bottom of their deck. They gain 1 Vigor.",
    textEnAdditional: "(To reveal your hand, right-click on the hand area.)",
  },
  "20-kanawe-o-s-1": {
    megami: "kanawe",
    ...
    textZh:
      "你可以支付1点集中力，若如此做，从追加牌区或已达成的构想牌中准备1张构想。从已达成的构想牌中准备的情况下将此卡移出游戏。\n【已使用】对手的准备步骤开始时，若你在上一个回合没有推进构想的话，将此卡恢复为未使用的状态。",
    textZhG1:
      "你可以支付1点集中力。若如此做，则你可以从追加区或已达成区域准备1张构想牌。若以此法从已达成区域准备构想牌，则将此牌移出游戏。\n【已使用】对手的准备階段开始时，若你上回合內构想牌上的樱花結晶没有前进，则将此牌变为未使用状态。\n",
    textKo:
      "집중력을 1 지불할 수 있다. 그렇게 했다면, 추가패 또는 달선된 상태인 구상 카드를 1장 준비한다. 달성된 상태인 구상 카드를 준비했다면, 이 카드를 게임에서 제외한다.\n【사용됨】상대의 개시 페이즈가 시작될 때, 당신이 직전 턴에 구상을 진행하지 않았다면, 이 카드를 미사용으로 되돌린다.",
    textEn:
      "You may spend 1 Vigor. If you do, prepare one of your set aside or completed Plot cards. If it was a completed Plot card, remove this card from the game.\n\nDevoted: At the beginning of your opponent's turn, if you did not progress a Plot on your previous turn, turn this card face-down.",
    removable: true,
  },
};

// シーズン7
export const S7_UPDATED_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> =
  {
    "14-honoka-A1-s-1": {
      megami: "honoka",
      anotherID: "A1",
    ...
    "20-kanawe-o-s-3": {
      ...
      textZhG1:
        "【攻击后】打消被对应的非王牌的《攻击》。若被对应的《攻击》为通常牌，则将该牌置于牌库顶。",
      textKo:
        "【공격후】대응한 비장패가 아닌 《공격》을 무효화한다.\n그 《공격》이 통상패라면 그 카드를 패산 위로 되돌린다.",
      textEn:
        "After Attack: Cancel the non-Special attack this card was played as a Reaction to. If that attack was a Normal card, put that card on the top of its owner's deck.",
    },
    "16-yatsuha-A1-s-4": {
      megami: "yatsuha",
      anotherID: "A1",
      ...
      textZh:
        "【已使用】如果你要重铸牌库，则在之前你可以公开你弃牌或者手牌中的一张八叶的牌并将其变为完全态。\n（例如将手牌中的『星之爪』公开的话就和追加牌区的『星辰之钩爪』作交换并加入手牌。）",
      textZhG1:
        "【已使用】每当你将要重铸牌库时，你可以从弃牌区或手牌中选择1张八叶的牌，展示该牌，然后将其变为完全态。\n（例如，若你展示了手牌中的『星之爪』，则将其与追加牌中的『星尘之利爪』交换，并加入手牌。）",
      textKo:
    ...
    "16-yatsuha-A1-n-3-ex1": {
      ...
      textZhG1:
        "【攻击后】若对手选择由命承受此《攻击》的伤害，则\n敌命（1）→自命",
      textKo:
        "【공격후】 상대가 라이프 피해를 선택했다면,\n라이프(상대)→라이프(자신) : 1",
      textEn:
    ...
    "17-hatsumi-A1-s-1": {
      ...
      textZh:
        "【展开中】对手的回合中，攻击距离有至少3个的对手的《攻击》失去除了最小值和最大值之外的其他攻击距离。\n（例如攻击距离3-5会变成攻击距离3,5）",
      textZhG1:
        "【展开中】对手的回合内，若对手的《攻击》的攻击距离含有至少3个值，则该《攻击》失去除最大值与最小值以外的所有攻击距离。\n（例如3-5的攻击距离变为3,5）",
      textKo:
        "【전개중】 상대 턴 동안, 적정거리를 3개 이상 가진 상대의 《공격》은 그 중에서 최소값과 최댓값을 제외한 적정거리를 모두 잃는다.\n(예를 들어 3-5라며 3, 5가 된다)",
      textEn:
    ...
    "17-hatsumi-A1-d-2": {
      ...
      textAdditional: "（潜水を行う場合、このカードを「使用済み」領域へ移動）",
      textZh:
        "这个回合中，当前的距增大1，达人距离增大1。\n这之后，如果是以《攻击》来公开的此潜水则立刻查看当前攻击距离是否符合，若是不符合则《攻击》直接失败不进行结算，且下个回合你成为顺风。\n\n攻击是通常牌的话置入弃牌，王牌的话变为已使用。\n无法对失败了的攻击进行对应。",
      textZhG1:
        "本回合内，当前距离增大1，达人距离增大1。\n然后，若此牌因使用《攻击》牌触发，则立即进行一次距离检查。若当前距离不包含于攻击距离，则视为对手没有进行过该《攻击》，并将你的下个回合固定为顺风状态，若该《攻击》由通常牌牌生成，则将该牌置入弃牌区；若由王牌生成，则将该牌变为已使用状态。失败的《攻击》不可被对应。",
      textZhAdditional: "（进行潜水时，将此牌移动到「已使用」的区域）",
      textZhG1Additional: "（进行潜水时，将此牌移至“已使用”区域）",
      textKo:
        "이 턴 중, 현재의 간격이 1 증가하고, 달인의 간격이 1 증가한다.\n만약 《공격》에 잠수전진/후퇴 카드 효과를 해결했다면, 간격 적용 후 바로 간격을 판정한다.\n만약 잠수전진/후퇴로 인해 그 공격이 적정간격을 벗어났다면, 그 《공격》을 실패로 간주하고,\n해결하지 않은 채로 버림패/사용됨으로 보낸 뒤, 다음 턴에 당신은 반드시 순풍이 된다.\n\n공격이 통상패라면 버림패로, 비장패라면 사용된 상태가 된다.\n실패한 공격에는 대응할 수 없다.",
      textKoAdditional: "(잠수를 할 때, 이 카드를 사용 영역으로 이동)",
      textEn:
        "For the rest of the turn, the current Distance is increased by 1, and the size of the Mastery Zone is increased by 1.\n\nThen, if an attack caused this card to be revealed, immediately check its Range. If the current Distance isn't in Range, that attack fails to initiate, and there is a tailwind next turn.\n\n(A failed Normal Attack card is put into its owner's played pile. A failed Special Attack card becomes Devoted. A failed attack cannot be Reacted to.)",
      textEnAdditional: "(To Submerge, move this card to your played pile.)",
    ...
    "21-kamuwi-o-n-2": {
      ...
      textZh:
        "(+1) 【攻击后】敌装仅4或以下的话，给予敌装1点伤害。\n【攻击后】进行1次基本动作《装附》。",
      textZhG1:
        "禁忌+1～【攻击后】若敌装中樱花结晶的数目小于等于4，则对敌装造成1点伤害，执行1次基本动作《装附》。",
      textKo:
        "(+1) 【공격후】상대의 오라가 4 이하라면 상대의 오라에 1 피해를 준다.\n【공격후】기본동작 《휘감기》를 1번 한다.",
      textEn:
        "(+1): After Attack: If your opponent has 4 or fewer Sakura tokens on their Aura, deal 1 damage to their Aura.\n\nAfter Attack: Perform a Recover basic action.",
    },
    "21-kamuwi-o-n-3": {
      megami: "kamuwi",
      name: "四剣乱刃",
      ...
      textZhG1:
        "禁忌+1～全力化：【攻击后】进行3次“攻击距离2-4 伤害1/1”的攻击。",
      textKo: "(+1) 전력화：【공격후】공격 『적정거리 2-4, 1/1』을 3번 한다.",
      textEn:
        '(+1): All-Out: After Attack: You attack with "Range: 2-4, Damage: 1/1" three times.',
    },
    "21-kamuwi-o-n-4": {
      megami: "kamuwi",
      name: "斬り払い",
    ...
    "21-kamuwi-o-s-1-ex-1": {
      ...
      textZhG1:
        "超克\n【常时】若此《攻击》被通常牌对应，则不结算该牌，而改为将其置入弃牌区，此《攻击》得-1/+0；若被王牌对应，则不结算该牌，而改为将其变为已使用状态，此攻击得-1/-1。\n【攻击后】将此牌移出游戏。",
      textKo:
    ...
    "21-kamuwi-o-s-3": {
      ...
      textZh:
        "【攻击后】本回合中，被此牌对应的《攻击》所属女神的牌，在下次使用时的时候不先弃一张那个女神的牌就不能使用。\n----\n【即再起】你的禁忌槽成为6的倍数。",
      textZhG1:
        "【攻击后】本回合内，对手下一次使用被对应的《攻击》的使用者的牌时，必须从手牌中弃置1张该女神的牌作为费用。\n----\n【即再起】你的禁忌槽的值变为6的倍数。",
      textKo:
        "【공격후】이 턴 중에, 이 카드로 대응한 공격을 수행한 여신의 카드를 상대가 다음에 사용할 때, 추가 코스트로 손패에서 해당 여신의 카드 1장을 버림패로 보내야 한다.\n----\n【즉재기】당신의 금기 게이지가 6의 배수가 된다.",
      textEn:
    ...
    "21-kamuwi-o-s-4": {
      ...
      textZh:
        "【常时】只有在自命仅有6或更低的时候，才能使用此牌。\n虚→1→自命\n【已使用】对手使用《行动》王牌时不先弃一张那个女神的牌就不能使用。",
      textZhG1:
        "【常时】仅当自命中的樱花结晶的数目小于等于6时可以使用此牌。\n虚（1）→自命\n【已使用】对手使用《行动》王牌时，必须从手牌中弃置1张同使用者的牌作为费用。",
      textKo:
        "【상시】당신의 라이프가 6이하가 아니라면, 이 카드를 사용할 수 없다.\n더스트→라이프(자신)：1\n【사용됨】상대가 《행동》 비장패를 사용할 때, 추가 코스트로 손패에서 동일한 여신의 카드 1장을 버림패로 보내야 한다.",
      textEn:
        "Forced: You can't play this card unless your Life is 6 or less.\n\nShadow (1)→ Your Life\n\nDevoted: As an additional cost to play a Special Action card, your opponent must put a card from the same Megami from their hand into their played pile.",
    },
    "22-renri-o-n-1": {
      megami: "renri",
      name: "嘘突き",
    ...
    "22-renri-o-n-7": {
      ...
      textEn:
        "Initialize/Disenchant: If the current Distance is 2 or more, Distance (1)→ Shadow.",
    },
    "22-renri-o-s-1": {
      megami: "renri",
      name: "ルルララリ",
      ...
      textZh:
        "【常时】此《攻击》给予伤害的时候如果对手在本回合反证失败过，则改为对敌装和敌命均造成伤害。\n【已使用】在你的结束步骤，给予敌装1点伤害并将此卡恢复为未使用的状态。",
      textZhG1:
        "【常时】若本回合内对手曾反证失败，则此攻击对敌装和敌命均造成伤害。\n【已使用】当你的结束阶段开始时，对敌装造成1点伤害，然后将此牌变为未使用状态。",
      textKo:
        "【상시】이 공격이 데미지를 줄 때, 이번 턴에 상대가 반증에 실패한 적이 있다면, 오라와 라이프 양쪽의 데미지를 받는다.\n【사용됨】자신의 턴의 종료 페이즈에, 상대의 오라에 1 데미지를 준다.\n그 후 이 카드를 미사용으로 되돌린다.",
      textEn:
    ...
    "22-renri-o-s-3": {
      ...
      textZh:
        "从眼前构筑时没有被选上的通常牌里公开并使用1张带伪证的牌。之后，把那张牌移出游戏。若此牌对应了一个《攻击》，则视为所选择的牌也对应了那个《攻击》。\n----\n【再起】你的弃牌和付与区的通常牌合计有3张或更多。",
      textZhG1:
        "从眼前构筑时未选用的具伪证关键字的通常牌中选择1张，展示之，然后使用该牌。若此牌对应了一个《攻击》，则视为该牌也对应了该《攻击》。然后将该牌移出游戏。\n----\n【再起】你的弃牌区与付与区中的通常牌的张数之和大于等于3。",
      textKo:
      ...
      textEn:
        "Choose a Normal card with Falsehood that you did not include in your deck during deck construction, reveal it, and play it. Then, remove it from the game. If this card was played as a Reaction to an attack, treat that card as if it were played as a Reaction to that attack.\n\nResurgence: There are 3 or more Normal cards among your played pile and Enhancements in play.",
    },
    "22-renri-o-s-4": {
      megami: "renri",
      name: "夜山恋離のなれの果て",
    ...
    "22-renri-o-s-4-ex-1": {
      ...
      textZh:
        "【常时】此牌依照你的『夜山恋离的惯见之末』之上的樱花结晶的个数，成为以下对应卡牌的复制。\n3或以上…『久远之花』\n2…『完美驳倒』\n1…『夙愿』\n1…『御剑桐子的巫女神乐』",
      textZhG1:
        "【常时】根据你的『夜山恋离的终幕』上的樱花结晶的数目，此牌成为以下牌的复制。\n大于等于3……『久远之花』\n2……『完全论破』\n1……『夙愿』\n0……『御剑桐子的巫女神乐』",
      textZhAdditional:
        "（各张牌的具体效果，请参考卡牌一览中常世、森罗、终章虚路、恋离的对应卡牌。）",
      textKo:
        "【상시】이 카드는 당신의 『요야마 렌리의 말로』의 위에 놓인 벛꽃결정 수에 따라 이하의 카드의 복제가 된다.\n3이상…「영원의 꽃」\n2…「완전논파」\n1…「망아」\n0…「미츠루기 키리코의 무녀카구라」",
      textKoAdditional:
        "（각 카드의 효과는 토코요, 신라, 종장 우츠로, 렌리의 카드 리스트를 참조）",
      textEn:
        'Forced: Based on the number of Sakura tokens on your "Renri\'s Last Gasp", this card is a copy of the following card:\n3 or more: "Immortal Flower"\n2: "Shake the Mind"\n1: "желание"\n0: "Kiriko\'s Sacred Dance"',
      textEnAdditional:
        '(The text of these cards can be found in the card list under "Tokoyo", "Shinra", "Final Chapter Utsuro", and "Renri".)',
      sealable: true,
    },
    "22-kiriko-o-s-1": {
      megami: "renri",
      ...
      textAdditional:
        "（「剣舞」は現在のルール上では定義されておらず、意味を持たないキーワードである）",
      textZh:
        "【已使用】你因剑舞执行基本动作《装附》的时候，可以改为执行基本动作《聚气》。\n【已使用】你在每回合里执行第三次剑舞的时候，可以使用这张牌。（需要支付费用）",
      textZhG1:
        "【已使用】若你由剑舞执行基本动作《装附》，则你可以选择不执行基本动作《装附》，而改为执行基本动作《聚气》。\n【已使用】每当你进行本回合内的第3次剑舞时，结算完毕后你可以使用此牌。（需要支付费用）",
      textZhAdditional:
        "（「剑舞」在现在的规则中没有被定义，是没有意义的关键词）",
      textKo:
        "【사용됨】당신이 검무로 기본동작 《휘감기》를 수행할 때, 대신 기본동작《품기》를 수행할 수 있다.\n【사용됨】당신이 이번 턴에 3회째의 검무를 수행할 때,\n이 카드를 사용할 수 있다(비용은 지불한다)",
      textKoAdditional:
        "（「검무」는 현재 어떠한 정의도 되어 있지 않은 의미가 없는 키워드다）",
      textEn:
      ...
      textEnAdditional:
        '("Sword Dance" currently has no rules associated with it, so the textbox of this card has no functional effect.)',
    },
  };
// シーズン7-2
export const S7_2_UPDATED_CARD_DATA: Partial<{
  ...
  "13-utsuro-o-n-1": {
    ...
    textZh:
      "【常时】灰尘～若虚中的樱花结晶数大于等于12，则此《攻击》获得距离扩大(近1)，对装伤害改为「-」。",
    textZhG1:
      "【常时】灰尘～若虚中的樱花结晶的数目大于等于12，则此《攻击》获得距离扩大（近1），且对装伤害变为“-”。",
    textKo:
      "	\n【상시】회진 - 더스트가 12 이상이라면 이 《공격》은 거리확대(근1)을 얻고, 오라로의 데미지는 [ - ]이 된다.",
    textEn:
      'Forced: Ashen - If there are 12 or more Sakura tokens on Shadow, increase this attack\'s Range by 1 in the close direction, and its Damage to Aura becomes "-".',
  },
  "14-honoka-o-n-1": {
    megami: "honoka",
    name: "精霊式",
  ...
  "14-honoka-o-n-1-ex2": {
    ...
    textZh:
      "不可被对应 \n【攻击后】虚→1→自命 \n【攻击后】开花～你可以将这张『突击灵式』与追加牌区的『神灵樱华』交换。若如此做，则你可以将『神灵樱华』置于你的牌库底。",
    textZhG1:
      "不可被对应\n【攻击后】虚（1）→自命\n【攻击后】开花～妳可以将这张『突击灵式』与追加牌区中的『神灵奥华』交换。若如此做，则妳可以将『神灵奥华』置于妳的牌库底。",
    textKo:
      "대응불가\n【공격후】더스트→라이프(자신) : 1\n【공격후】개화 - 이 『돌격령식』을 추가패의\n『신령 오우카』와 교환할 수 있다.\n그렇게 하면, 교환한 『신령 오우카』를 패산 맨 밑에 놓을 수 있다.",
    textEn:
      'No Reactions\n\nAfter Attack: Shadow (1)→ Your Life\n\nAfter Attack: Bloom - You may exchange this card with your set aside "Divine Spirit: Ouka". If you do, you may put that card on the bottom of your deck.',
  },
  "15-korunu-o-n-5": {
    megami: "korunu",
    name: "絶対零度",
  ...
  "16-yatsuha-A1-s-4": {
    ...
    textZh:
      "终端　不可被对应 \n【攻击后/已使用】如果你要重铸牌库，则在之前你可以公开你弃牌或者手牌中的一张八叶的牌并将其变为完全态。 \n（例如将手牌中的『星之爪』公开的话就和追加牌区的『星辰之钩爪』作交换并加入手牌。）",
    textZhG1:
      "终端 不可被对应\n【攻击后/已使用】攻击后或每当妳将要重铸牌库时，妳可以从弃牌或手牌中选择1张八叶的牌，展示该牌，然后将其变为完全态。\n（例如，若妳展示了手牌中的『星之爪』，则将其与追加牌区中的『星尘之利爪』交换，并加入手牌。）",
    textKo:
      "	\n종단, 대응불가\n【공격후/사용됨】공격후와 당신이 패산의 재구성을 수행하기 직전에, 당신의 버림패나 손패의 야츠하의 카드 1장을 공개한 뒤 완전태로 바꿀 수 있다.\n(예를 들어 손패의 별의 손톱을 공개했다면, 추가패의 성신의 갈퀴손과 교환하여 손패로 추가한다.)",
    textEn:
      'Terminal No Reactions\n\nAfter Attack/Devoted: After this attack, and immediately before reshuffling your deck, you may reveal a Yatsuha card from your hand or played pile and Perfect it. (For example, if you reveal "Astral Claw" from your hand, exchange it for your set aside "Celestial Talon" and add it your hand.)',
  },
  "17-hatsumi-o-n-5": {
    megami: "hatsumi",
    name: "準備万端",
    ...
    textZh:
      "虚→3→自装 \n你可以抓1张牌。 \n若逆风，则在这个回合你的手牌上限+1。",
    textZhG1:
      "虚（3）→自装\n妳可以抓1张牌。\n若妳处于逆风状态，则本回合内妳的手牌上限增大1。",
    textKo:
      "더스트→오라(자신) : 3\n카드를 한 장 뽑을 수 있다.\n역풍이라면 이 턴 중 손패의 상한이 1만큼 증가한다.",
    textEn:
      "Shadow (3)→ Your Aura\n\nYou may draw a card. If there is a headwind, your maximum hand size is increased by 1 this turn.",
  },
  "18-mizuki-o-s-3": {
    megami: "mizuki",
    name: "大手楯無門",
    ...
    textZhG1:
      "【常时】不动～若本回合内当前距离的值没有发生过变化，则此《攻击》获得+0/+1。\n【攻击后】将此牌置入追加牌区。\n（此牌视为菰珠的牌）",
    textKo:
      "종단\n추가패의 [투신]과 손패의 카드 한 장을 선택하여 그것들을 병영의 징병됨에 놓는다.\n징병을 1회 수행한다.\n【사용됨】당신이 병영에서 사용한 《공격》카드에 의한 《공격》은 +1/+0을 얻는다.\n당신이 병영에서 사용한 《대응》카드는 종단을 잃는다.",
    textEn:
  ...
  "20-kanawe-o-n-2": {
    ...
    textZhG1:
      "【攻击后】妳可以从追加区准备1张构想牌。\n【常时】妳的结束阶段开始时，若此牌位于弃牌区，则妳可以将其置于牌库底。若如此做，则对手获得1点集中力。",
    textKo:
  ...
  "21-kamuwi-o-n-4": {
    ...
    textZh:
      "【常时】此牌只能作为对应使用。 \n---- \n(+2) 【攻击后】打消被对应的《攻击》的伤害。该《攻击》为《全力》或者王牌的话，禁忌槽上升2。",
    textZhG1:
      "【常时】仅当进行对应时可以使用此牌。 \n---- \n(+2) 【攻击后】打消被对应的《攻击》的伤害。若该《攻击》为王牌或具《全力》副类别，则禁忌槽的值增加2。",
    textKo:
      "【상시】이 카드는 대응으로만 사용할 수 있다.\n(+2): 【공격후】대응한 《공격》의 대미지를 무효화한다.\n그 《공격》이 《전력》 또는 비장패라면, 금기 게이지를 2 추가한다.",
    textEn:
      "Forced: This card cannot be played except as a Reaction to an attack.\n\n----------\n\n(+2): After Attack: Cancel the damage of the attack you played this card as a Reaction to. If that attack was Special or Throughout, increase your Taboo gauge by 2.",
  },
  "21-kamuwi-o-s-1": {
    megami: "kamuwi",
    name: "灯",
    ...
    textZhG1:
      "(+3) 将自气中的所有樱花结晶移至虚，对自命造成1点伤害。将『晓』从追加牌区以未使用状态加入王牌。",
    textKo:
      '(+3) 당신의 플레어가 1 이하가 될 때 까지 벛꽃결정을 더스트로 보낸 후, 당신의 라이프에 1 대미지를 준다.\n추가패에서 "새벽"을 미사용 상태로 얻는다.',
    textEn:
  ...
  "21-kamuwi-o-s-2": {
    ...
    textZh:
      "(+2) 【展开时】进行一次“攻击距离3-4、伤害3/3、不可被对应（通常牌）”的攻击，并给予自命1点伤害。 \n---- \n【常时】此牌上有樱花结晶放置时，你无法胜利。",
    textZhG1:
      "(+2) 【展开时】进行一次“攻击距离3-4 伤害3/3 不可被对应（通常牌）”的攻击，对自命造成1点伤害。\n---- \n【常时】若此牌上置有樱花结晶，则妳不能因敌命中樱花结晶的数目降至0或叙述为“妳赢得本局游戏”的牌的效果而赢得本局游戏。",
    textKo:
      "(+2) 【전개시】공격 『적정거리3-4、3/3, 대응불가(통상패)』를 수행한 뒤, 당신의 라이프에 1 대미지를 받는다.\n----\n【상시】이 카드 위에 벚꽃결정이 올려져 있다면, 당신은 승리할 수 없다.",
    textEn:
  ...
  "16-yatsuha-AA1-n-7": {
    ...
    textZh:
      "【常时】此牌为你在游戏中使用的第一张牌的话，使用时，可以改为从游戏外放置樱花结晶到此牌上（而不是从自装或虚）。\n【破弃时】你进行两次基本动作《前进》。之后，将此牌移出游戏，从追加牌区以未使用的状态获得「多彩的世界」。",
    textZhG1:
      "【常时】若此牌是妳本局游戏中使用的第一张牌，则妳可以选择游戏外的樱花结晶作为此牌的纳。\n【破弃时】进行2次基本动作《前进》。然后将此牌移出游戏，将『千芳犹增色』从追加牌区以未使用状态加入王牌。",
    textKo:
      "【상시】이 카드가 당신이 이 게임에서 가장 처음으로 사용하는 카드라면, 사용할 때 게임 밖에서 벛꽃결정을 가져와 봉납해도 된다.\n【파기시】당신은 기본동작 《전진》을 2회 수행한다.\n그 후, 이 카드를 게임에서 제외하고, 추가패에서 「색 입는 세계」를 미사용으로 얻는다.",
    textEn:
      'Forced: If this is the first card you play this game, you may use Sakura tokens from outside the game for its Charge.\n\nDisenchant: Perform two Forward Movement basic actions. Remove this card from the game, and add your set aside "A World of Hope" to your Special cards, face-down.',
    removable: true,
  },
  "16-yatsuha-AA1-n-7-ex1": {
    ...
    textZh:
      "从散樱的旅路的任意起点出发。\n【已使用】各回合的准备阶段开始时结算所在地的效果，将樱花结晶顺时针移动到下个位置。在将要再次结算起点的效果的时候，改为结算归路的效果。",
    textZhG1:
      "从任意起点出发，开始散樱代的旅途。 （仅寄宿了自我八叶的玩家可以开始旅途，每局游戏中每名玩家仅能开始旅途一次）\n【已使用】每回合的准备阶段开始时，结算所在地的效果，然后将樱花结晶沿顺时针方向移至下一个地点。当将要第2次结算出发地的效果时，不结算出发地的效果，而改为结算归途的效果。",
    textZhAdditional:
      "（面朝上的状态下右键可以发动效果。之后，可以用画面上的「旅路」按钮来进行推进旅路的操作）",
    textZhG1Additional:
      "（在正面朝上的状态下，可以通过右键激活效果。之后，您可以从屏幕上的“旅程”按钮继续旅程。）",
    textKo:
    ...
    textEnAdditional:
      '(To begin your Journey, right-click on this card. From then on, you can use the added "Journey" button to progress your Journey.)',
  },
  "16-yatsuha-AA1-n-7-ex2": {
    ...
    textZh:
      "从回忆里选择1张牌，将其移回手牌。\n【已使用】当你将要抽一张牌时，可以改为从回忆里选择一张牌移回手牌。\n【已使用】当你将因重铸牌库而受到伤害时，可以改为选回忆中的1张牌公开并将其移出游戏。\n（从回忆中返回的牌可以公开并变为完全态）",
    textZhG1:
      "从回忆区中选择1张牌置入手牌。\n【已使用】每当妳将要抓牌时，妳可以选择不抓牌，而改为从回忆区中选择等量的牌置入手牌。\n【已使用】每当妳将要因重铸牌库受到命伤时，妳可以选择不受到此次命伤，而改为从回忆区中选择并展示1张牌，然后将该牌移出游戏。\n（若八叶的未变为完全态的牌将从回忆区置入手牌，则妳可以选择将该牌变为完全态后置入手牌）",
    textKo:
      "	추억에서 카드 한장을 골라 손패에 추가한다.\n【사용됨】당신이 카드를 뽑을 때, 대신 추억의 카드를 골라 손패에 추가할 수 있다\n(추억에서 되돌리는 카드는 공개하여 완전태로 바꿀 수 있다)\n【사용됨】당신이 패산의 재구성을 하여 대미지를 입으려 할 때, 대신 추억의 카드 한장을 골라 공개한 뒤, 그것을 게임에서 제외할 수 있다.",
    textEn:
      "Choose a card in your Memory and return it to your hand.\n\nDevoted: If you would draw a card, you may instead return a card from your Memory to your hand.\n\nDevoted: If you would take damage from reshuffling your deck, you may instead choose a card in your Memory, reveal it, and remove it from the game.\n\n(You may Perfect a card returning from your Memory by revealing it.)",
  },
  "16-yatsuha-AA1-s-4": {
    megami: "yatsuha",
    anotherID: "AA1",
    ...
    textZh:
      "可以从弃牌、盖牌、手牌里公开1张八叶的牌，将其变为完全态。那之后，可以将该牌置于牌库顶。\n【已使用】你可以代替你对一个《攻击》进行对应，改为将此牌移出游戏并弃1张其他女神的牌，若如此做，打消那个《攻击》。\n（即使该《攻击》不可被对应也可以如此做）",
    textZhG1:
      "妳可以从弃牌、盖牌或手牌中选择1张八叶的牌。展示该牌，然后将其变为完全态。妳可以将该牌置于牌库顶。\n【已使用】每当结算对妳进行的《攻击》时，妳可以选择不使用牌来对应该《攻击》，而改为将此牌移出游戏，并弃1张其他女神的牌。若如此做，则打消被对应的《攻击》。\n（对于具不可被对应关键字的《攻击》也可以如此做，但对于对应使用的《攻击》牌生成的攻击不能如此做）",
    textKo:
      "버림패, 덮임패, 손패 중에서 야츠하의 카드를 한 장 공개한 뒤, 그 카드를 완전태로 만들 수 있다.\n그 후, 그 카드를 패산의 위에 놓을 수 있다.\n【사용됨】 당신이 어떤 《공격》에 대응하려 할 때, 이 카드를 게임에서 제외하고, 손패에서 다른 여신의 카드 1장을 버림패로 만들 수 있다.\n그렇게 했다면, 그 《공격》을 무효화한다.\n(대응불가를 가지는 《공격》에도 사용 가능하다)",
    textEn:
      "You may choose a Yatsuha card in your hand, discard pile, or played pile, reveal it, and Perfect it. Then, you may put that card on the top of your deck.\n\nDevoted: Instead of making a Reaction to an attack, you may remove this card from the game and put a non-Yatsuha Megami card from your hand to your played pile. If you do, cancel that attack.\n(You may do this even with attacks that have No Reactions.)",
    removable: true,
  },
};
// シーズン8
export const S8_UPDATED_CARD_DATA: Partial<{
  [id in TCardId]: CardDataItem;
}> = {
  "06-yukihi-o-s-1": {
    megami: "yukihi",
  ...
  "16-yatsuha-A1-s-4": {
    ...
    textZh:
      "终端　距离限制（0-7） \n【使用时/已使用】使用时和你要重铸牌库之前，你可以公开你弃牌或者手牌中的一张八叶的牌并将其变为完全态。若如此做，令你畏缩。 \n（例如将手牌中的『星之爪』公开的话就和追加牌区的『星辰之钩爪』作交换并加入手牌。）",
    textZhG1: "",
    textKo:
  ...
  "17-hatsumi-o-n-7": {
    ...
    type: "enhance",
    capacity: "1",
    text: "【展開中】あなたのターンかつ順風である場合のみ、このカードの上の桜花結晶は移動する。\n【展開中/破棄時】あなたの開始フェイズの開始時と破棄時に伏せ札を1枚選び、山札の上に置いてもよい。\n【破棄時】基本動作を1回まで行い、攻撃『適正距離2-7、1/-』を行う。",
    textZh:
      "【展开中】仅在你的回合中且为顺风时，才可以移动此牌上的樱花结晶。\n【展开中/破弃时】在你的准备阶段开始时和此牌破弃时，你可以选盖牌里的一张牌置于牌库顶。\n【破弃时】进行最多一次基本动作，进行一次“攻击距离2-7 伤害1/-”的攻击。",
    textZhG1: "",
    textKo:
  ...
  "23-akina-o-n-3": {
    ...
    textZh:
      "终端\n【攻击后】你的资本比对手的资本多3或更多的话，选弃牌中的最多1张其他女神的牌，并将其移回手牌。\n【攻击后】你的资本比对手的资本更多的话，你可以进行一次基本动作。",
    textZhG1: "",
    textKo:
  ...
  "23-akina-o-s-1": {
    ...
    type: "action",
    cost: "時価",
    text: "攻撃『適正距離0-10　-/1、【常時】この《攻撃》が対応されたならば、この攻撃は打ち消される。【常時】この《攻撃》のダメージは変化しない』を行う。その後、あなたの資本が相手の資本より大きいならばこのカードを使用する。\n（消費は支払い、それは時価以外で変化しない）",
    textZh:
      "进行一次“攻击距离0-10 伤害-/1\n【常时】此《攻击》被对应了的话，此攻击被打消。\n【常时】此《攻击》的伤害不会被改变”\n的攻击。那之后，你的资本比对手的资本更多的话，就再次使用此牌。\n（需要支付费用，且费用不受时价以外的变化影响）",
    textZhG1: "",
    textKo:
  ...
  "23-akina-o-s-3": {
    ...
    capacity: "1",
    cost: "1",
    text: "【展開時】あなたのライフからフレアへと桜花結晶を4つ移動させる。\n【展開中】このカードの効果以外でこの付与札の上の桜花結晶は移動しない。\n【展開中】あなたのライフが0の時にあなたが敗北するならば、代わりにあなたのフレアからライフへと桜花結晶を4つ移動させる。その後、この付与札の上の桜花結晶を全てダストに送り、このカードを取り除く。",
    textZh:
      "【展开时】从自命之中将4个樱花结晶移至自气。\n【展开中】除此卡的效果外，此付于牌上的樱花结晶不能被移动。\n【展开中】当你因命为0而落败时，改为从自气之中将4个樱花结晶移至自命。那之后，将此付与牌上的樱花结晶全部移至虚，将此卡移出游戏。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-2": {
    ...
    range: "2-3",
    damage: "{1/1}",
    text: "【攻撃後】攻撃『適正距離2-3、{1/2}、【常時】相手のオーラに置かれたあなたの裂傷トークンの個数が相手のオーラ以上ならば、相手はオーラへのダメージを選べない』を行う。",
    textZh:
      "【攻击后】进行一次“攻击距离2-3 伤害{1/2} 【常时】若敌装中有不少于敌装的裂伤指示物，则对手不能选择承受对装伤害”的攻击。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-3": {
    ...
    range: "2-4",
    damage: "1/1",
    text: "【常時】あなたがこのターン中にダメージを受けているならば、この《攻撃》は+1/+1となる。\n【攻撃後】あなたがこのターン中にダメージを2回以上受けているならば、基本動作《纏い》を1回行う。",
    textZh:
      "【常时】若你在本回合中受过伤害的话，此《攻击》得+1/+1。\n【攻击后】若你在本回合中受过至少两次伤害的话，进行一次基本动作《装附》。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-4": {
    ...
    range: "1-7",
    damage: "{2/3}",
    text: "対応不可\n【攻撃後】相手を畏縮させ、あなたのオーラかライフかフレアに裂傷を1与える。",
    textZh: "不可被对应\n【攻击后】令对手畏缩，对自装、自命或自气造成1点裂伤。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-5": {
    ...
    textZh:
      "距→2→虚\n对自装或自气造成1点裂伤。当前的距为0的话，改为对自命造成1点裂伤。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-6": {
    ...
    baseType: "normal",
    type: "action",
    text: "基本動作《纏い》を2回行う。その後、以下から1つを選ぶ。\n・あなたと相手のオーラに裂傷を1与える。\n・あなたと相手のフレアに裂傷を1与える。",
    textZh:
      "进行两次基本动作《装附》。那之后，选择一项：\n●对自装和敌装各造成1点裂伤；\n●对自气和敌气各造成1点裂伤。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-n-7": {
    ...
    subType: "reaction",
    capacity: "0",
    text: "【展開時】このカードの上に桜花結晶をX個ダストから置く。Xはあなたがこのターン中にダメージを受けた回数の2倍に等しい。Xが4以上ならばもう1つ置く。\n【展開中】相手の《攻撃》は+0/-1となり、その解決後にこの付与札の上の桜花結晶を2つダストに送る。",
    textZh:
      "【展开时】从虚中将X个樱花结晶置于此牌上。X为本回合你受到过伤害的次数的两倍。X不小于4的话则额外再放置1个。\n【展开中】对手的《攻击》得+0/-1，且结算后将此付与牌上的2个樱花结晶移至虚。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-s-3": {
    ...
    subType: "reaction",
    cost: "2",
    text: "対応した《攻撃》のダメージを打ち消す。そうした場合、あなたは{X/Y}の裂傷を受ける。X/Yは打ち消したダメージの値に等しい。\n----\n【即再起】あなたがこのターンに3回目のダメージを受ける。",
    textZh:
      "打消被对应的《攻击》的伤害。若如此做，你受到{X/Y}的裂伤。X/Y的值和被打消的伤害相同。\n----\n【即再起】你承受本回合第三次伤害。",
    textZhG1: "",
    textKo:
  ...
  "24-shisui-o-s-4": {
    ...
    capacity: "2",
    cost: "{2}",
    text: "【展開時】このカードの上に桜花結晶をX個相手のフレアから置く。相手のフレアがあなたのフレアより大きいならば、Xはその差に等しい。そうでないならばXは0である。\n【展開中】あなたは敗北しない。\n【展開中】あなたのライフが0ならば、相手は集中力を支払えない。",
    textZh:
      "【展开时】从敌气中将X个樱花结晶置于此牌上。若敌气比自气更多则X为那个差值，若否则X为0。\n【展开中】你不会输掉这局游戏。\n【展开中】自命为0时，对手无法支付集中力。",
    textZhG1: "",
    textKo:
...
// シーズン8-2
export const S8_2_UPDATED_CARD_DATA = {
  "06-yukihi-o-n-2": {
    megami: "yukihi",
    name: "しこみび / ねこだまし",
    nameEn: "Preparation / Fake Out",
    ...
    damage: "1/1",
    damageOpened: "1/1",
    text: "【攻撃後】傘の開閉を行ってもよい。",
    textZh: "【攻击后】可以进行一次伞的开合操作。",
    textZhG1: "",
    textKo: "【공격후】 우산의 개폐를 수행해도 된다.",
    textEn: "\nAfter Attack: You may open your umbrella.",
    textOpened: "【攻撃後】傘の開閉を行ってもよい。",
    textOpenedZh: "【攻击后】可以进行一次伞的开合操作。",
    textOpenedZhG1: "",
    textOpenedKo: "【공격후】 우산의 개폐를 수행해도 된다.",
    textOpenedEn: "\nAfter Attack: You may open your umbrella.",
  },
  "02-saine-A2-n-2": {
    megami: "saine",
  ...
  "22-renri-a1-n-2": {
    ...
    baseType: "normal",
    type: "variable",
    text: "【常時】このカードを、相手が眼前構築で選びうる他のメガミの《付与》でない通常札として通常の方法で使用を宣言しても よい。そうした場合、相手は相手の手札、伏せ札、捨て札からそのカードを公開できる。 公開されたならば、このカードは使用されずに捨て札となる。",
    textZh:
      "【常时】此卡可以宣言当做，对手在眼前构筑选择的其他女神的非《付于》的通常牌，以正常的方式使用。若如此做，对手可以从其手牌、盖牌、弃牌中将那张牌公开。若公开的话，此牌使用失败并就这样弃掉。",
    textZhG1: "",
    textKo:
      "【상시】 이 카드를, 상대가 안전구축에서 고를 수 있는 다른 여신의 《부여》가 아닌 통상패로서 통상의 방법으로 사용을 선언해도 된다.\n그렇게 했다면, 상대는 상대의 손패, 덮은패, 버림패로부터 해당 카드를 공개해도 된다. 공개되었다면, 이 카드는 사용되지 않고 버림패가 된다.",
    textEn:
      "Forced: You may declare this card as if it were any non-Renri non-Enhancement Normal card that your opponent could have chosen during deck construction, being played within the regular timing rules of that card. When you do, your opponent may reveal the copied card from their hand, discard or played pile. If they reveal it, place this card in your played pile without being played.",
  },
  "22-renri-a1-n-5": {
    megami: "renri",
    anotherID: "A1",
  ...
  "22-renri-a1-n-5-ex1": {
    ...
    textAdditional:
      "（表向きにした後に右クリックすることで回帰させることが可能）",
    textZh:
      "伪证设置 伪证 回归 \n【攻击后】伪火～你在本回合使用的第3张牌是《攻击》牌的话，那个《攻击》得+0/+1。",
    textZhG1: "",
    textZhAdditional: "（正面表示后右键就可以令其回归）",
    textKo:
      "위증설치 위증 회귀\n【공격후】위화 - 당신이 이번 턴에 3번째로 사용하는 카드가 《공격》카드라면, 그 《공격》은 +0/+1된다.",
    textKoAdditional: "（앞면 표시로 한 뒤에 우클릭으로 회귀시키기 가능）",
    textEn:
    ...
    textEnAdditional:
      "(You can return by right-clicking after turning it face up)",
    lie: true,
  },
  "22-renri-a1-n-5-ex2": {
    megami: "renri",
...
// シーズン9
export const S9_UPDATED_CARD_DATA = {
  "06-yukihi-o-n-2": {
    megami: "yukihi",
    name: "しこみび / ねこだまし",
    nameEn: "Preparation / Fake Out",
  ...
  "24-shisui-o-s-2": {
    ...
    text: "【攻撃後】相手がライフへのダメージを選んだならば、このターンにあなたが次に行うオーラへのダメージが2以下の《攻撃》のダメージは裂傷化する。\n----\n【再起】あなたのオーラとフレアの合計が6以下である。",
    textZh:
      "【攻击后】对手选择承受对命伤害的话，本回合中你的下一次对装伤害不大于2的《攻击》造成的伤害裂伤化。\n----\n【再起】自装和自气合计不大于6。",
    textZhG1: "",
    textKo:
      "【공격후】 상대가 라이프 데미지를 선택했다면, 이 턴에 당신이 다음에 수행하는 오라 데미지가 2 이하인 《공격》을 열상화한다.\n----\n【재기】 당신의 오라와 플레어의 합계가 6 이하이다.",
    textEn:
  ...
  "05-oboro-a2-s-1": {
    ...
    damage: "2/1",
    cost: "16",
    text: "【常時】このカードの消費はあなたの伏せ札の枚数と組み立てられたパーツの数の合計だけ少なくなる。\n【攻撃後】攻撃『適正距離3-4、2/1』を3回行う。\n\n",
    textZh:
  ...
  "25-misora-o-n-1": {
    ...
    range: "4-7",
    damage: "2/1",
    text: "【常時】照準が合っているならば、この《攻撃》のオーラへのダメージは「-」になる。\n【攻撃後】現在の間合と照準が等しいならば、ダスト→自オーラ：1\n",
    textZh:
      "【常时】对上瞄准的话，此《攻击》对装伤害变为「-」。\n【攻击后】当前的距等于瞄准的话，虚→1→自装",
    textZhG1: "",
    textZhAdditional:
  ...
  "25-misora-o-n-3": {
    ...
    range: "2-5",
    damage: "1/1",
    text: "【攻撃後】現在の間合と照準を比べて以下のいずれかを行う。\n・現在の間合＞照準…間合→ダスト：1\n・現在の間合＝照準…ダスト→自オーラ：1\n・現在の間合＜照準…ダスト→間合：1\n",
    textZh:
      "【攻击后】比较当前的距和瞄准进行以下一项：\n・当前的距＞瞄准…距→1→虚\n・当前的距＝瞄准…虚→1→自装\n・当前的距＜瞄准…虚→1→距",
    textZhG1: "",
    textKo:
  ...
  "25-misora-o-n-6": {
    ...
    baseType: "normal",
    type: "action",
    text: "眼前構築で選んでいない他のメガミのカードまたは伏せ札のカードから、《全力》でない《攻撃》の通常札1枚を選び、それに追尾を与えて使用する。ゲーム外から使用したそのカードが領域を移動するならば、代わりに裏向きで取り除く。(眼前構築で選んでいない状態に戻る)",
    textAdditional:
      "（このカードを右クリックすることで、眼前構築で選んでいないカードを取得可能。また、使用したカードを右クリックすることで取り除くことができる）",
    textZh:
      "从盖牌中或者眼前构筑时未选取的其他女神的牌中，选1张非《全力》的《攻击》通常牌，使用之且视其具有追踪。从游戏外使用了的那张牌在区域移动时会改为面朝下移出游戏。（回到眼前构筑时未选取的状态）",
    textZhG1: "",
    textZhAdditional:
...
// シーズン9-2
export const S9_2_UPDATED_CARD_DATA = {
  "01-yurina-o-n-5": {
    megami: "yurina",
    name: "体捌き",
    nameEn: "",
    ...
    baseType: "normal",
    type: "action",
    text: "このターンにあなたが次に行う《攻撃》は距離拡大（遠1）を得る。\nあなたのライフが相手のライフよりも小さいならば、基本動作を2回まで行う。",
    textZh:
...
// シーズン10
export const S10_UPDATED_CARD_DATA = {
  "01-yurina-o-n-5": {
    megami: "yurina",
    name: "体捌き",
    nameEn: "",
  ...
  "07-shinra-o-n-2": {
    ...
    range: "2-7",
    damage: "1/-",
    text: "【攻撃後】対応した切札でなく、オーラへのダメージが「-」でない《攻撃》のダメージを打ち消す。 \n【攻撃後】相手はカードを1枚引く。",
    textZh:
  ...
  "23-akina-o-n-2": {
    ...
    textZh:
      "投资券\n【常时】你的资本比对手的资本多至少3的话，此攻击得+0/+1。\n【攻击后】你的资本不比对手的资本多的话，盖伏此卡。",
    textZhG1: "",
    textKo:
      "투자권\n【상시】 당신의 자본이 상대의 자본보다 3이상 많다면, 이 《공격》은 +0/+1 된다.\n【공격후】당신의 자본이 상대의 자본 이하라면, 이 카드를 덮음패로 만든다.",
    textEn: "",
    investable: true,
  },
  "23-akina-o-n-5": {
  ...
  "23-akina-o-n-6": {
    ...
    textZh:
      "距离限制（0-3）\n【展开时】敌气→2→距\n【展开中】此付于牌上的樱花结晶将移至虚时，改为移至敌气。",
    textZhG1: "",
    textKo:
      "간격제한(0-3)\n【전개시】 플레어(상대)→간격:2\n【전개중】이 부여패 위에 놓인 벚꽃결정이 더스트로 보내진다면, 그 벚꽃결정은 대신 플레어(상대)로 이동한다.",
    textEn:
      "Range Restriction (0-3)\n\nInitialize: Opponent's Flare (2)→ Distance\n\n〇〇",
  },
  "24-shisui-o-n-4": {
    ...
    range: "2-5",
    damage: "{2/3}",
    text: "【攻撃後】相手を畏縮させ、あなたのオーラかライフかフレアに裂傷を1与える。",
    textZh: "【攻击后】令对手畏缩，对自装、自命或自气造成1点裂伤。",
    textZhG1: "",
    textKo:
      "【공격후】 상대를 위축시키고, 당신은 오라 또는 플레어 또는 라이프에 열상을 1 받는다.",
    textEn:
  ...
  "26-innealra-o-n-5": {
    ...
    textZhG1: "",
    textKo:
      "기본행동을 1회까지 수행한다.\n과거 -> 현재 -> 미래 순으로 운명의 효과를 해결한다.\n(공명이 아니므로 운명은 움직이지 않는다.)",
    textEn: "",
  },
  "26-innealra-o-n-7": {
    megami: "innealra",
    ...
    textZhG1: "",
    textKo:
      "【전개시】더스트→오라(자신):1\n【파기시】과거의 운명을 보지 못한 운명으로 이동시켜도 된다.",
    textEn: "",
  },
  "26-innealra-o-s-4": {
    megami: "innealra",
    ...
    capacity: "5",
    cost: "5",
    text: "【展開時】手札を好きな枚数だけ伏せ札にする。その枚数に等しい回数まで基本動作を行う。\n【展開中】運命を糾える運命へと導く。\n【使用済】このカードは使用できない。",
    textZh:
      "【展开时】盖伏任意数量手牌，执行最多那个数量的基本动作。\n 【展开中】将命运导向交缠的命运。\n 【使用后】此卡不能被使用。",
    textZhG1: "",
    textKo:
      "【전개시】손패에서 원하는 만큼의 카드를 덮음패로 만든다. 그 장수와 같은 횟수까지 기본동작을 수행한다.\n【전개중】운명을 얽힌 운명으로 인도한다.\n【사용됨】이 카드는 사용할 수 없다.",
    textEn: "",
  },
  "26-innealra-o1-n-2": {
    megami: "innealra",
    anotherID: "O1",
    replace: "26-innealra-o-n-2",
    name: "呪詛",
    nameEn: "",
    nameZh: "诅咒",
    nameZhG1: "",
    ...
    range: "3",
    damage: "-/0",
    text: "【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+0/+1となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》は距離拡大（遠2）を得る。",
    textZh:
      "【常时】若本回合你有进行共鸣的话，此《攻击》得+0/+1。\n 【常时】若本回合你有使用其他女神的牌的话，此《攻击》得距离扩大（远2）。",
    textZhG1: "",
    textKo:
      "【상시】당신이 이번 턴에 공명하였다면, 이 《공격》은 +0/+1된다.\n【상시】당신이 이번 턴에 다른 여신의 카드를 사용하였다면, 이 《공격》은 거리확대(원2)를 얻는다.",
    textEn: "",
  },
  "26-innealra-o1-n-3": {
    megami: "innealra",
    anotherID: "O1",
    replace: "26-innealra-o-n-3",
    name: "祖槍",
    nameEn: "",
    nameZh: "祖枪",
    nameZhG1: "",
    ...
    range: "5-8",
    damage: "2/1",
    text: "【攻撃後】以下から1つを選ぶ。この《攻撃》が対応されたならば、代わりに相手が選ぶ。\n・共鳴する。\n・過去の運命をまだ見ぬ運命へと動かす。",
    textZh:
      "【攻击后】选择以下一项。此《攻击》被对应的话，改为对手进行选择：\n ●进行共鸣。\n ●将过去的命运移去未知的命运。",
    textZhG1: "",
    textKo:
      "【공격후】다음 중 하나를 선택한다. 이 《공격》이 대응되었다면 대신 상대가 선택한다.\n・공명한다\n・과거의 운명을 보지 못한 운명으로 이동시킨다.",
    textEn: "",
  },
  "26-innealra-o1-n-4": {
    megami: "innealra",
    anotherID: "O1",
    replace: "26-innealra-o-n-4",
    name: "悔恨",
    nameEn: "",
    nameZh: "悔恨",
    nameZhG1: "",
  ...
  "26-innealra-o1-n-6": {
    ...
    type: "enhance",
    capacity: "2",
    text: "【展開時/破棄時】相手は相手の伏せ札か手札から1枚を捨て札にする。",
    textZh: "【展开时/破弃时】对手从盖牌或者手牌中弃1张牌。",
    textZhG1: "",
    textKo:
      "【전개시/파기시】상대는 상대의 덮음패 또는 손패에서 1장을 버림패로 만든다.",
    textEn: "",
  },
  "26-innealra-o1-s-1": {
    megami: "innealra",
    anotherID: "O1",
    replace: "26-innealra-o-s-1",
    name: "スピエル・サラバエル",
    nameEn: "",
    nameZh: "逝枪·风蚀形销",
    nameZhG1: "",
    ...
    damage: "-/1",
    cost: "2",
    text: "【常時】この《攻撃》は距離拡大（近X）と距離拡大（遠Y）を得る。Xは相手の使用済の切札の枚数に等しい。Yは相手の捨て札の枚数に等しい。\n----\n【再起】あなたがこのターン中に2回以上共鳴している。",
    textZh:
      "【常时】此攻击得距离扩大(近X)和距离扩大(远Y)。X为对手已使用的王牌数，Y为对手的弃牌数。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
    textZhG1: "",
    textKo:
      "【상시】이 《공격》은 거리확대(근X)와 거리확대(원Y)을 얻는다.\nX는 상대가 사용한 비장패의 숫자와 동일하다.\nY는 상대의 버림패의 숫자와 동일하다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
    textEn: "",
  },
  "26-innealra-o1-s-2": {
    megami: "innealra",
    anotherID: "O1",
    replace: "26-innealra-o-s-2",
    name: "イヤルカス・シラマカス",
    nameEn: "",
    nameZh: "沉掩·洇雪消锋",
    nameZhG1: "",
    ...
    capacity: "1",
    cost: "1",
    text: "【展開中】相手の《攻撃》はダメージが元々の値から加算されない。\n（代入、入れ替えなどは行われる）",
    textZh:
      "【展开中】对手的《攻击》不能在基础值上进行增加。\n （代入、交换数值可以进行）",
    textZhG1: "",
    textKo:
      "【전개중】상대의 《공격》은 데미지가 본래 수치에서 가산되지 않는다\n(수치의 대입이나 교체 등은 가능하다.)",
    textEn: "",
  },
  "26-innealra-o1-s-3": {
    megami: "innealra",
    ...
    type: "action",
    cost: "3",
    text: "【使用済】相手の捨て札にあるカードは山札の再構成により移動しない。\n【使用済】相手が山札の再構成を行った後、このカードを取り除く。",
    textZh:
      "【已使用】对手的弃牌不会因为重铸牌库而移动。\n 【已使用】对手重铸牌库之后，将此卡移出游戏。",
    textZhG1: "",
    textKo:
      "【사용됨】상대의 버림패에 있는 카드는 패산을 재구성할 때 이동하지 않는다\n【사용됨】상대가 패산을 재구성을 수행할 때, 이 카드를 게임에서 제외한다.",
    textEn: "",
    removable: true,
  },
  "26-innealra-o2-n-2": {
    ...
    textZh:
      "【常时】你在本回合中进行过共鸣的话，此《攻击》得+0/+1。\n 【常时】你在本回合中使用过其他女神的牌的话，此《攻击》得+0/+1。",
    textZhG1: "",
    textKo:
      "\n【상시】당신이 이번 턴에 공명하였다면, 이 《공격》은 +0/+1된다.\n【상시】당신이 이번 턴에 다른 여신의 카드를 사용하였다면, 이 《공격》은 +0/+1된다.",
    textEn: "",
  },
  "26-innealra-o2-n-3": {
    megami: "innealra",
  ...
  "26-innealra-o2-n-4": {
    ...
    baseType: "normal",
    type: "action",
    text: "基本動作《纏い》か《後退》を1回まで行う。\n共鳴する。",
    textZh: "进行基本动作《装附》或《后退》合计最多1次。\n 进行共鸣。",
    textZhG1: "",
    textKo: "기본동작 《휘감기》 또는 《후퇴》를 최대 1회 수행한다.\n공명한다.",
    textEn: "",
  },
  "26-innealra-o2-n-6": {
    megami: "innealra",
    ...
    type: "enhance",
    capacity: "4",
    text: "【展開中】基本動作《纏い》以外で相手のオーラへと桜花結晶が移動するならば、それは代わりにこのカードの上へと移動する。\n【展開中】相手が基本動作《纏い》を行った時、その解決後にこのカードの上から桜花結晶を1つダストに送る。",
    textZh:
      "【展开中】樱花结晶因基本动作《装附》以外的原因向敌装移动的话，改为移到此卡上。\n 【展开中】对手进行基本动作《装附》时，结算后从将此卡上的1个樱花结晶移去虚。",
    textZhG1: "",
    textKo:
      "【전개중】기본동작 《휘감기》 외의 방법으로 상대의 오라로 벚꽃결정이 이동하려 한다면, 대신 그 결정은 이 카드 위로 이동한다.\n【전개중】상대가 기본동작 《휘감기》를 수행할 때, 그 동작의 해결 후 이 카드 위에서 벚꽃결정 하나를 더스트로 보낸다.",
    textEn: "",
  },
  "26-innealra-o2-s-1": {
    megami: "innealra",
  ...
  "26-innealra-o2-s-2": {
    ...
    capacity: "1",
    cost: "5",
    text: "【展開中】相手の《攻撃》は-1/+0となる。\n【展開中】相手の《攻撃》の解決後に、相手のオーラに1ダメージを与える。",
    textZh:
      "【展开中】对手的《攻击》得-1/+0。\n 【展开中】对手的《攻击》结算后，给予敌装1点伤害。",
    textZhG1: "",
    textKo:
      "【전개중】상대의 《공격》은 -1/+0 된다.\n【전개중】상대의 《공격》의 해결 후, 상대는 오라에 1 피해를 입는다.",
    textEn: "",
  },
  "26-innealra-o2-s-3": {
    megami: "innealra",
    ...
    textZhG1: "",
    textKo:
      "【상시】이 《공격》의 데미지로 이동하는 벚꽃결정은 더스트나 플레어가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
    textEn: "",
  },
  "26-innealra-o3-n-2": {
    megami: "innealra",
    ...
    range: "0-2",
    damage: "1/1",
    text: "【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+1/+0となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》のダメージにより移動する桜花結晶はダストやフレアでなくロストに動かす。",
    textZh:
      "【常时】你在本回合中进行过共鸣的话，此《攻击》得+1/+0。\n 【常时】你在本回合中使用过其他女神的牌的话，因此《攻击》造成的伤害将移动的樱花结晶改为移去迷失。",
    textZhG1: "",
    textKo:
      "【상시】당신이 이번 턴에 공명하였다면, 이 《공격》은 +1/+0된다.\n【상시】당신이 이번 턴에 다른 여신의 카드를 사용하였다면, 이 《공격》의 데미지로 이동하는 벚꽃결정은 더스트나 플레어가 아니라 로스트로 이동시킨다.",
    textEn: "",
  },
  "26-innealra-o3-n-3": {
    megami: "innealra",
  ...
  "26-innealra-o3-n-4": {
    ...
    baseType: "normal",
    type: "action",
    text: "基本動作《宿し》か《前進》を1回まで行う。\n共鳴する。",
    textZh: "进行基本动作《聚气》或《前进》合计最多1次。\n 进行共鸣。",
    textZhG1: "",
    textKo: "기본동작 《품기》 또는 《전진》을 최대 1회 수행한다.\n공명한다.",
    textEn: "",
  },
  "26-innealra-o3-n-6": {
    megami: "innealra",
    ...
    type: "enhance",
    capacity: "2",
    text: "【展開時】過去の運命をまだ見ぬ運命へと動かしてもよい。\n【展開中】達人の間合は1小さくなる。",
    textZh:
      "【展开时】可以将过去的命运移去未知的命运。\n 【展开中】达人距离的数值减少1。",
    textZhG1: "",
    textKo:
      "【전개시】과거의 운명을 보지 못한 운명으로 이동시켜도 된다.\n【전개중】달인의 간격이 1 감소한다.",
    textEn: "",
  },
  "26-innealra-o3-s-1": {
    megami: "innealra",
    ...
    damage: "2/1",
    cost: "2",
    text: "【常時】このカードの消費の支払いにより移動する桜花結晶はダストでなくロストに動かす。\n----\n【再起】あなたがこのターン中に2回以上共鳴している。",
    textZh:
      "【常时】因支付此卡费用而将移动的樱花结晶改为移去迷失。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
    textZhG1: "",
    textKo:
      "【상시】이 카드의 비용으로 지불하여 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
    textEn: "",
  },
  "26-innealra-o3-s-2": {
    megami: "innealra",
    ...
    textZh:
      "【常时】因支付此卡费用而将移动的樱花结晶改为移去迷失。\n 【常时】使用此卡时可以从距中拿取纳所需的樱花结晶。",
    textZhG1: "",
    textKo:
      "【상시】이 카드의 비용으로 지불할 때 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동한다.\n【상시】이 카드를 사용할 때, 봉납을 간격에서 가져와도 된다.",
    textEn: "",
  },
  "26-innealra-o3-s-3": {
    megami: "innealra",
    ...
    textZhG1: "",
    textKo:
      "과거의 운명을 보지 못한 운명으로 이동시켜도 된다.\n【사용됨】당신의 개시 페이지의 시작시에 공격『적정거리 X, 2/1, 불가피, 【상시】X는 로스트의 숫자와 동일하다.』를 수행해도 된다. 그렇게 했다면, 이 카드를 게임에서 제외한다.",
    textEn: "",
    removable: true,
  },
  "26-innealra-o-n-2": {
  ...
  "26-innealra-o1-f-1": {
    ...
    textKo:
      "이번 턴에, 당신은《공격》을 수행할 수 없다.\n현재 간격이 5 이하라면,\n오라(상대)→간격:1\n이 운명이 과거에 있다면, 다시 한번 수행한다.",
    textEn: "",
  },
  "26-innealra-o1-f-1a": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "このターン中、あなたは通常札を使用できない。\n相手のライフに1ダメージを与える。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "本回合中你不能使用通常牌。\n 给予敌命1点伤害。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이번 턴에, 당신은 통상패를 사용할 수 없다.\n상대 라이프에 1 데미지를 준다.",
    textEn: "",
  },
  "26-innealra-o1-f-2": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "このターン中、あなたは基本動作《前進》と《後退》を行えない。\n相フレア→相オーラ：1",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "本回合中你不能进行基本动作《前进》和《后退》。\n 敌气→1→敌装",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이번 턴에, 당신은 기본동작 《전진》과《후진》을 수행할 수 없다.\n플레어(상대)→오라(상대):1",
    textEn: "",
  },
  "26-innealra-o1-f-2a": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "このターン中、あなたは基本動作を行えない。\n相手のライフに1ダメージを与える。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "本回合中你不能进行基本动作。\n 给予敌命1点伤害。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이번 턴에, 당신은 기본동작을 수행할 수 없다.\n상대 라이프에 1 데미지를 준다.",
    textEn: "",
  },
  "26-innealra-o1-f-3": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "この運命が過去にあるならば、相手のライフに1ダメージを与える。そうした場合、あなたは手札から《対応》カード1枚を捨て札にする。それが行えない場合、あなたは手札を公開する。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh:
      "此命运是过去的命运的话，给予敌命1点伤害。若如此做，你从手牌中舍弃1张《对应》牌，若不能这么做则将手牌公开。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이 운명이 과거에 있다면, 상대의 라이프에 1 데미지를 준다. 그렇게 했다면, 당신은 손패에서 《대응》카드 1장을 버림패로 만든다. 그렇게 하지 못했을경우, 당신은 손패를 공개한다.",
    textEn: "",
  },
  "26-innealra-o1-f-3a": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "このターン中にあなたが通常札を使用していないならば、相手のライフに1ダメージを与える。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "若本回合中你没有使用过通常牌，则给予敌命1点伤害。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이번 턴에 당신이 통상패를 사용하지 않았다면, 상대 라이프에 1 데미지를 준다.",
    textEn: "",
  },
  "26-innealra-o1-f-4": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "あなたと相手の山札の上から1枚を伏せ札にする。\nこの運命が過去にあるならば、もう1回行う。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "你和对手各将牌库顶牌盖伏。\n 此命运是过去的命运的话，重复一次。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "당신과 상대의 패산 위의 카드 1장을 덮음패로 만든다. 이 운명이 과거에 있다면, 한번 더 수행한다.",
    textEn: "",
  },
  "26-innealra-o1-f-4a": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "このターン中にあなたが基本動作を行っていないならば、相手のライフに1ダメージを与える。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "若本回合中你没有进行过基本动作，则给予敌命1点伤害。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "이번 턴에 당신이 기본동작을 수행하지 않았다면, 상대 라이프에 1 데미지를 준다.",
    textEn: "",
  },
  "26-innealra-o2-f-1": {
    megami: "innealra",
    ...
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh:
      "敌装→1→敌气\n 敌装有5个或更多樱花结晶的话，这个箭头行动多移动1个樱花结晶。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "오라(상대)→플레어(상대):1\n상대의 오라가 5 이상이라면, 이 화살표로 움직이는 벚꽃결정이 1개 늘어난다.",
    textEn: "",
  },
  "26-innealra-o2-f-1a": {
    megami: "innealra",
  ...
  "26-innealra-o2-f-2a": {
    ...
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "距←3→虚\n 结算上述效果时，你可以选择移动更少的樱花结晶。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "간격↔더스트:3\n당신은 이 효과로 벚꽃결정을 원래보다 더 적게 이동시켜도 된다.",
    textEn: "",
  },
  "26-innealra-o2-f-3": {
    megami: "innealra",
  ...
  "26-innealra-o2-f-3a": {
    ...
    rubyEn: "",
    baseType: "fate",
    text: "攻撃『適正距離2-5、3/2』を行う。",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh: "进行一次“攻击距离2-5 伤害3/2”的攻击。",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo: "공격『적정거리 2-5, 3/2』를 수행한다.",
    textEn: "",
  },
  "26-innealra-o2-f-4": {
    megami: "innealra",
  ...
  "26-innealra-o3-f-1": {
    ...
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "로스트→더스트:3\n이 효과로 3개 이상의 벚꽃결정이 이동했다면 공격『적정거리 0-3, 3/1, 』을 수행한다.",
    textEn: "",
  },
  "26-innealra-o3-f-1a": {
    megami: "innealra",
    ...
    rubyEn: "",
    baseType: "fate",
    text: "攻撃『適正距離0-X、3/5、対応不可、【常時】Xはロストに等しい』を行う。\nロスト→ダスト：∞",
    textAdditional: "（クリックでまだ見ぬ運命へと移動）",
    textZh:
      "进行一次“攻击距离0-X 伤害3/5 不可被对应 【常时】X等于迷失的值”的攻击。\n 迷失→∞→虚",
    textZhG1: "",
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "공격『적정거리 0-X, 3/5, 대응불가,【상시】X는 로스트의 숫자와 동일하다.』을 수행한다.\n로스트→더스트:모두",
    textEn: "",
  },
  "26-innealra-o3-f-2": {
    megami: "innealra",
    ...
    textZhAdditional: "（点击即可将其移去未知的命运）",
    textKo:
      "규칙에 의한 공명이라면 다음을 수행한다:\n당신은 집중력을 1 얻은 뒤, 오라→로스트:1\n아니라면 다음을 수행한다:\n상대를 위축시킨 뒤, 로스트→더스트:1",
    textEn: "",
  },
  "26-innealra-o3-f-2a": {
    megami: "innealra",
...
export const S10_2_UPDATED_CARD_DATA = {
  ...
  "21-kamuwi-o-s-1": {
    ...
    textZh:
      "(+4) 将自气的樱花结晶全部移至虚。从追加牌区以未使用的状态获得『晓』。",
    textZhG1: "",
    textKo:
...
export const STORY_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> = {
  "story-00-A-1": {
    ...
    textEn:
      "After Attack: The attack this card was played as a Reaction to gets -1/+0.",
  },
  "story-00-A-2": {
    megami: "yurina-story-0",
    name: "執着",
  ...
  "story-00-A-4": {
    ...
    textZh:
      "打消被对应的非王牌的攻击，对手的集中力变为0，令对手畏缩。天音摇波和冰雨细音的命运在此相交。",
    textZhG1:
      "打消被对应的非王牌的《攻击》。对手的集中力变为0，对手畏缩。天音摇波与冰雨细音就此结下不解之缘。",
    textKo:
      "대응한 비장패가 아닌 공격을 무효로 하고, 상대의 집중력을 0으로 하고 위축시킨다. 아마네 유리나와 히사메 사이네의 인연은 여기서 맺어진다.",
    textEn:
      "Cancel the non-Special attack this card was played as a Reaction to. Your opponent's Vigor becomes 0. Flinch them. Thus do Yurina's and Saine's fates become entwined.",
  },
  "story-00-B-1": {
  ...
  "story-01-A-1": {
    ...
    textZhG1:
      "【常时】奉纳～若你赌上了自己的意志，则此《攻击》获得+0/+2和不可被闪避。",
    textKo:
      "【상시】봉납―당신이 의지를 내걸고 있다면, 이 《공격》은 +0/+2 되고 불가피를 얻는다.",
    textEn:
      "Forced: Offering - If you're steeling your resolve, this attack gains +0/+2 and Unavoidable.",
  },
  "story-01-A-2": {
    megami: "yurina-story-1",
    name: "執念",
  ...
  "story-01-A-4": {
    ...
    textAdditional:
      "（不可避を持つ攻撃は対応により現在の間合が変更されたとしても間合の再確認を行わない）",
    textZh:
      "【常时】决死～仅当自命中的樱花结晶数小于等于3时，才可以使用此牌。\n【常时】奉纳～如果你赌上意志的话，此攻击得不可避。",
    textZhG1:
      "【常时】决死～仅当自命中的樱花结晶的数目小于等于3时可以使用此牌。\n【常时】奉纳～若你赌上了自己的意志，则此《攻击》获得不可被闪避。",
    textZhAdditional:
      "（具有不可避的攻击即使因被对应导致当前的距的变动也不会再次检验攻击距离是否合法）",
    textKo:
      "【상시】필사―당신의 라이프가 3이하가 아니라면, 이 카드는 사용할 수 없다.\n【상시】봉납―당신이 의지를 내걸고 있다면, 이 《공격》은 불가피를 얻는다.",
    textEn:
  ...
  "story-01-B-1": {
    ...
    textZh:
      "【常时】你的准备阶段开始时敌装已达上限的话，可以将弃牌区中的此牌返回手牌。",
    textZhG1:
      "【常时】每当你的准备阶段开始时，若敌装中樱花结晶的数目等于最大值，则你可以将此牌从弃牌区置入手牌。",
    textKo:
      "【상시】당신의 개시 페이즈의 개시 시에 상대의 오라가 최대치라면, 버림패에 있는 이 카드를 손패로 되돌려도 좋다.",
    textEn:
      "Forced: At the beginning of your turn, if your opponent's Aura is equal to their maximum Aura, you may return this card from your played pile to your hand. ",
  },
  "story-01-B-2": {
    megami: "saine-story-1",
    name: "雪舞台",
    ...
    textZh:
      "【展开中】达人距离的值增加1，自装和敌装的上限都减小1。\n【展开中】现在的装超出上限的部分移动到虚。",
    textZhG1:
      "【展开中】达人距离增大1，自装与敌装的最大值减小1。\n【展开中】若自装或敌装中樱花结晶的数目大于最大值，则将超出的结晶移至虚。",
    textKo:
      "【전개중】달인의 간격은 1늘리고, 당신과 상대의 최대 오라는 1적게 된다.\n【전개중】현재의 오라가 최대치보다 많다면, 그 만큼 더스트로 이동시킨다.",
    textEn:
      "Ongoing: The size of the Mastery Zone is increased by 1, and both players' maximum Aura is reduced by 1.\n\nOngoing: If a player has Aura in excess of their maximum, move those tokens to Shadow.",
  },
  "story-01-B-3": {
    megami: "saine-story-1",
    name: "氷雨細音の果ての果て：初雪",
  ...
  "story-02-A-1": {
    ...
    textEn:
      "After Attack: If Fading Light Toxin is applied to this needle, you win the game.",
  },
  "story-02-A-2": {
    megami: "chikage-story-2",
    name: "毒針・乙",
  ...
  "story-02-A-5": {
    ...
    textEn:
      "After Attack: If your opponent chose to take damage to Life, you win the game.",
  },
  "story-02-B-1": {
  ...
  "story-02-B-4": {
    ...
    textKo:
      "집중력을 1지불해도 좋다. 그렇게 했다면 상대가 멸등독을 바른 독침을 본다.",
    textEn:
      "You may spend 1 Vigor. If you do, look at your opponent's chosen Drenched Needle.",
  },
  "story-02-B-5": {
    megami: "tatsu-story-2",
    name: "飛び退き",
  ...
  "story-02-B-6": {
    ...
    textZh:
      "获知对手被涂上灭灯毒的毒针。之后，可以打消被对应的1/1的《攻击》。若未如此做，则将此牌恢复为未使用的状态。",
    textZhG1:
      "检视对手涂有灭灯毒的毒针。然后你可以打消被对应的伤害为1/1的《攻击》，否则将此牌变为未使用状态。",
    textKo:
      "상대의 멸등독을 바른 독침을 본다. 그 후, 대응한 1/1의 《공격》을 무효화해도 좋다. 그렇지 않은 경우, 이 카드를 미사용으로 되돌린다.",
    textEn:
      "Look at your opponent's chosen Drenched Needle. Then, you may cancel the 1/1 attack this card was played as a Reaction to. If you did not, turn this card face-down.",
  },
  "story-09-A-1": {
    ...
    textZh:
      "【常时】你在上个回合进行过对应的话，此《攻击》得+1/+1。\n全力化：【常时】此《攻击》得+2/+1。",
    textZhG1:
      "【常时】若上一回合内你进行过对应，则此《攻击》获得+1/+1。\n全力化：【常时】此《攻击》获得+2/+1。",
    textKo:
      "【상시】당신이 저번 턴에 대응했다면, 《공격》은 +1/+1 된다.\n전력화：【상시】이 《공격》은 +2/+1 된다.",
    textEn:
      "Forced: If you reacted to an attack last turn, this attack gains +1/+1.\n\nAll-Out: Forced: This attack gains +2/+1.",
  },
  "story-09-A-2": {
    megami: "yatsuha-story-9",
    name: "防壁",
  ...
  "story-09-B-1": {
    ...
    textZh:
      "【常时】不动～现在的距和回合开始时的距比起来没有发生变化的话，此《攻击》得+0/+1。",
    textZhG1:
      "【常时】不动―若本回合内当前距离的值没有发生过变化，此《攻击》获得+0/+1。",
    textKo:
      "【상시】부동―현재의 간격이 턴 개시 시의 간격에서 변화되지 않았다면, 이 《공격》은 +0/+1 된다.",
    textEn:
      "Forced: Unwavering - This attack gains +0/+1 if the Distance hasn't changed this turn.",
  },
  "story-09-B-2": {
    ...
    textZh:
      "【常时】不动～现在的距和回合开始时的距比起来没有发生变化的话，打消被对应的非全力也非王牌的《攻击》。",
    textZhG1:
      "【常时】不动～若本回合内当前距离的值没有发生过变化，则打消被对应的非《全力》且非王牌的《攻击》。",
    textKo:
      "【상시】부동―현재의 간격이 턴 개시 시의 간격에서 변화되지 않았다면, 대응한 전력도 비장패도 아닌 《공격》을 무효화한다.",
    textEn:
      "After Attack: Unwavering - Cancel the non-Special, non-Throughout attack you played this card as a Reaction to if the Distance hasn't changed this turn.",
  },
  "story-09-B-3": {
  ...
  "story-09-B-4": {
    ...
    textKo:
      "【전개중】상대는 기본동작 《전진》과 《후퇴》와 《이탈》을 할 수 없다.",
    textEn:
      "Ongoing: Your opponent cannot perform the Forward Movement, Backward Movement, or Retreat basic actions.",
  },
  "story-09-B-5": {
    megami: "yura-story-9",
    name: "敷道肆式",
    ...
    textAdditional:
      "※取り除くカードは、「手札」領域に移動し、その後で再構成を行ってください",
    textZh:
      "盖伏整个牌库，然后从弃牌区和盖牌区中移除一共两张牌，再重铸牌库。之后，将被移除的牌以任意顺序放回牌库顶。",
    textZhG1:
      "盖伏自己的牌库，从自己的弃牌区或盖牌区中移除至多2张牌，之后重铸牌库。然后将被移除的牌以任意顺序置于牌库顶。",
    textZhAdditional: "※请先把被移除的牌放进「手牌区」，之后再重铸牌库。",
    textKo:
      "패산을 전부 덮임패로 하고, 버림패 또는 덮임패에서 2장까지 제외하고 패산을 재구성한다. 그 후, 제외했던 카드를 임의의 순서대로 패산 위에 올려둔다.",
    textEn:
      "Put your deck into your discard pile. Then, choose up to two cards from among your discard and played piles, and set them aside. Reshuffle your deck, then put the set aside cards on top in any order.",
  },
  "15-korunu-o-n-a-normal": {
    ...
    textZh:
      "【展开时/展开中】展开时以及每个回合的准备阶段，可以执行下述效果。\n・本回合敌装上限减少1。\n【展开中】现在的敌装超出上限的部分移动到虚。",
    textZhG1:
      "【展开时/展开中】展开时和每回合的准备阶段开始时，可以执行以下效果。\n・本回合内，敌装的最大值减小1。\n【展开中】对手存在于装中的樱花结晶数量如果超出了装的最大值，则将超出数量的樱花结晶移动到虚。",
    textKo:
      "【전개시/전개중】전개시와 각 턴의 개시 페이즈에 아래의 효과를 해도 좋다.\n・이 턴 동안, 상대의 오라의 상한은 1적어진다.\n【전개중】현재의 상대 오라가 최대치보다 많을 경우, 그 만큼 더스트로 이동시킨다.",
    textEn:
      "Initialize/Ongoing: When this initializes and at the beginning of each turn, you may decrease your opponent's maximum Aura by 1.\n\nOngoing: If a player has Aura in excess of their maximum, move those tokens to Shadow.",
  },
  "15-korunu-o-n-a-heroic": {
    ...
    textZh:
      "【展开时/展开中】展开时以及每个回合的准备阶段，可以执行下述效果。\n・本回合敌装上限减少2。\n【展开中】现在的敌装超出上限的部分移动到虚。",
    textZhG1:
      "【展开时/展开中】展开时和每回合的开始阶段，可以进行以下操作。\n・本回合中，对手的装上限减少2。\n【展开中】若敌装中樱花结晶的数目大于最大值，则将超出的结晶移至虚。",
    textKo:
      "【전개시/전개중】전개시와 각 턴의 개시 페이즈에 아래의 효과를 해도 좋다.\n・이 턴 동안, 상대의 오라의 상한은 2적어진다.\n【전개중】현재의 상대 오라가 최대치보다 많을 경우, 그 만큼 더스트로 이동시킨다.",
    textEn:
      "Initialize/Ongoing: When this initializes and at the beginning of each turn, you may decrease your opponent's maximum Aura by 2.\n\nOngoing: If a player has Aura in excess of their maximum, move those tokens to Shadow.",
  },
  ...
  "15-korunu-o-s-a-heroic": {
    ...
    textZh:
      "打消被对应的《攻击》。此《攻击》是攻击牌的话就将那张牌封印于此牌下，结束当前阶段。\n【已使用】你的准备阶段中敌装中没有空位的话，自敌装中将1个樱花结晶移至虚，冻结对手1次。这之后，对手有5个或以上的冻结指示物的话，对手直接输掉这局游戏。",
    textZhG1:
      "打消被对应的《攻击》。若该《攻击》是由《攻击》牌发起的，则将该牌封印于此牌下，结束当前阶段。（《攻击》牌发起的《攻击》仅限由其自身记述的距离、伤害等信息构造的《攻击》，而不含由各类效果构造的《攻击》）\n【已使用】你的准备阶段开始时，若敌装中没有空位，则将对手装中的1个樱花结晶移至虚，并冻结1次。那之后，然后若敌装中有至少5个冻结指示物，则对手输掉这局游戏。",
    textKo:
      "대응한 《공격》을 무효화한다. 그 《공격》이 카드에 의한 것이라면 그 카드를 이 카드에 봉인하고 현재 페이즈를 종료한다.\n【사용됨】당신의 개시 페이즈에 상대의 오라에 빈 공간이 없다면, 상대는 오라에서 벚꽃 결정을 1개 더스트로 보내고 1번 동결한다. 그 후, 상대가 5개 이상 동결되어 있다면, 상대는 패배한다.",
    textEn:
      "Cancel the attack this card was played as a Reaction to. If that attack was from a card, seal that card and end the current phase.\n\nDevoted: At the beginning of your turn, if your opponent's Aura is full, move 1 of those Sakura tokens to Shadow, then freeze them. If your opponent has 5 or more Ice counters, they lose the game.",
    sealable: true,
  },
  ...
  "02-saine-A2-s-a-normal": {
    ...
    textZh:
      "被对应的《攻击》结算后，将自装和敌装的任意数目移至虚，i结束当前阶段。",
    textZhG1:
      "被对应的《攻击》结算完毕后，你可以从自装和敌装中将任意数量的樱花结晶移至虚，然后结束当前阶段。",
    textKo:
      "대응한 《공격》의 해결 후에 당신과 상대의 오라를 원하는 만큼 더스트로 보내고 현재 페이즈를 종료한다.",
    textEn:
      "After the attack this card was played as a Reaction to resolves, move any number of Sakura tokens in any combination from each player's Aura to Shadow, and end the current phase.",
  },
  "02-saine-A2-s-a-heroic": {
    ...
    textZh:
      "被对应的《攻击》结算后，结束当前阶段。\n【已使用】你的主要阶段开始时，将自装和敌装全部移至虚，将此卡变为未使用的状态。",
    textZhG1:
      "打消被对应的《攻击》。\n【已使用】你的主要阶段开始时，将自装与敌装中的所有樱花结晶移至虚，将此牌变为未使用状态。",
    textKo:
      "대응한 《공격》의 해결 후에 현재 페이즈를 종료한다.\n【사용됨】당신의 메인 페이즈 개시 시에 당신과 상대의 오라를 전부 더스트로 보내고 이 카드를 미사용으로 되돌린다.",
    textEn:
      "After the attack this card was played as a Reaction to resolves, end the current phase.\n\nDevoted: At the beginning of your main phase, move all Sakura tokens from both players' Aura to Shadow, and turn this card face-down.",
  },
  ...
  "04-tokoyo-o-n-a-heroic": {
    ...
    textZh:
      "【展开时/破弃时】进行一次“攻击距离2-6、伤害-/1、不可被对应”的攻击。\n【展开中】对手的回合内，此牌上的樱花结晶不会移动。",
    textZhG1:
      "【展开时/破弃时】进行一次『攻击距离2-5 伤害-/1 不可被对应』的攻击。\n【展开中】对手的回合内，此牌上的樱花结晶不会被移除。",
    textKo:
      "【전개시/파기시】공격『적정거리2-6, -/1, 대응불가』를 한다.\n【전개중】상대의 턴에 이 카드 위의 벚꽃 결정은 이동하지 않는다.",
    textEn:
      'Initialize/Disenchant: You attack with "Range: 2-6, Damage: -/1, No Reactions".\n\nOngoing: Sakura tokens cannot leave this card on your opponent\'s turn.',
  },
  "04-tokoyo-o-s-a-normal": {
    ...
    textZh: "【已使用】你的手牌上限增加1，对手的手牌上限减少1。",
    textZhG1: "【已使用】你的手牌上限增大1，对手的手牌上限减小1。",
    textKo:
      "【사용됨】당신의 손패의 최대치는 1증가하고, 상대의 손패의 최대치는 1감소한다.",
    textEn:
      "Devoted: Your maximum hand size is increased by 1. Your opponent's maximum hand size is decreased by 1.",
  },
  "04-tokoyo-o-s-a-heroic": {
    ...
    textZh:
      "【已使用】你的手牌上限增加1，对手的手牌上限减少1。\n【已使用】境地～你在结束阶段有2点集中力的话，令对手畏缩。",
    textZhG1:
      "【已使用】你的手牌上限增大1，对手的手牌上限减小1。\n【已使用】境地～你的结束阶段开始时，若你的集中力等于2，则对手畏缩。",
    textKo:
  ...
  "story-15-A-1": {
    ...
    textAdditional:
      "※伏せ札や捨て札を右クリックすることで、そのカードを取り除くことができます",
    textZh:
  ...
  "15-korunu-o-n-a": {
    ...
    type: "enhance",
    capacity: "4",
    text: "【展開時】相手は畏縮する。\n【展開中】相手のターン中、相手のオーラの上限は1減少する。\n（上限を超えた分の桜花結晶や凍結トークンが既にある場合はそのまま留まる）",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "15-korunu-o-n-y": {
    ...
    range: "4-9",
    damage: "1/-",
    text: "【攻撃後】対応した《攻撃》と、このターンに相手が次に行う《攻撃》は-1/+0となる。",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "15-korunu-o-s-a": {
    ...
    subType: "reaction",
    cost: "3",
    text: "現在のフェイズを終了する。（対応した《攻撃》は消える）\n【使用済】相手の終了フェイズに相手のオーラに空きがなければ、相手のオーラに1ダメージを与え、相手は1回凍結する。",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "08-hagane-o-s-a": {
    ...
    type: "action",
    cost: "3",
    text: "このターンにあなたが行う次の《攻撃》はライフへのダメージが2倍になる。\n----\n【即再起】遠心を持つカードを使用する。",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "08-yukihi-o-s-a": {
    ...
    damage: "2/1",
    cost: "2",
    text: "【常時】このカードはあなたの傘が閉じている場合のみ使用できる。\n【使用済】あなたが傘の開閉を行った時、基本動作を1回行ってもよい。",
    textAdditional:
      "（このカードは両面カードであり、ダブルクリックで裏返すことができる。\n「ゆきのいろ」が表向きである間は、「ゆきのいろ」の【使用済】効果が有効となり、裏向きである「滅灯淀路」は切札を使用するルールに従って使用できる）",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "08-yukihi-o-s-b": {
    ...
    textAdditional:
      "（このカードは両面カードであり、ダブルクリックで裏返すことができる。\n「滅灯淀路」が表向きである間は、「滅灯淀路」の【使用済】効果が有効となり、裏向きである「ゆきのいろ」は切札を使用するルールに従って使用できる）",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
...
CARD_DATA["na-s3"] = { ...CARD_DATA["na-s2"] };
...
CARD_DATA["na-s4"] = { ...CARD_DATA["na-s3"] };
for (let key of typedObjectKeys(S4_UPDATED_CARD_DATA) as TCardId[]) {
...
CARD_DATA["na-s6"] = { ...CARD_DATA["na-s5"] };
for (let key of typedObjectKeys(S6_UPDATED_CARD_DATA) as TCardId[]) {
...
CARD_DATA["na-s6-2"] = { ...CARD_DATA["na-s6"] };
for (let key of typedObjectKeys(S6_2_UPDATED_CARD_DATA) as TCardId[]) {
...
CARD_DATA["na-s7"] = { ...CARD_DATA["na-s6-2"] };
...
CARD_DATA["na-s8"] = { ...CARD_DATA["na-s7-2"] };
for (let key of typedObjectKeys(S8_UPDATED_CARD_DATA) as TCardId[]) {
  let data = S8_UPDATED_CARD_DATA[key];
  if (data === null || data === undefined) {
    delete CARD_DATA["na-s8"][key];
  } else {
...
CARD_DATA["na-s9"] = { ...CARD_DATA["na-s8-2"] };
for (let key of typedObjectKeys(S9_UPDATED_CARD_DATA)) {
  let data = S9_UPDATED_CARD_DATA[key];
  if (data === null || data === undefined) {
    delete CARD_DATA["na-s9"][key];
  } else {
    CARD_DATA["na-s9"][key] = data;
  }
}
CARD_DATA["na-s9-2"] = { ...CARD_DATA["na-s9"] };
for (let key of typedObjectKeys(S9_2_UPDATED_CARD_DATA)) {
  let data = S9_2_UPDATED_CARD_DATA[key];
  if (data === null || data === undefined) {
    delete CARD_DATA["na-s9-2"][key];
  } else {
    CARD_DATA["na-s9-2"][key] = data;
  }
}
CARD_DATA["na-s10"] = { ...CARD_DATA["na-s9"] };
for (let key of typedObjectKeys(S10_UPDATED_CARD_DATA)) {
  let data = S10_UPDATED_CARD_DATA[key];
  if (data === null || data === undefined) {
    delete CARD_DATA["na-s10"][key];
  } else {
...
for (let cardSet of [
  ...
  CARD_DATA[cardSet] = { ...CARD_DATA["story-0"] };
}
...
CARD_DATA["story-9"][CardId.YATSUHA_O_N_2] =
  CARD_DATA["na-s4"][CardId.YATSUHA_O_N_2];
...
for (let cardSet of [
  ...
  CARD_DATA[cardSet] = { ...CARD_DATA["na-s7-2"] };
  for (let key of typedObjectKeys(STORY_CARD_DATA) as TCardId[]) {
    let data = STORY_CARD_DATA[key];
    if (data === null || data === undefined) {
...
export const CARD_SORT_KEY_MAP: { [cardId: string]: string | undefined } = {};

for (let cardSet of typedObjectKeys(CARD_DATA)) {
  for (let cardId of typedObjectKeys(CARD_DATA[cardSet]) as TCardId[]) {
    ...
    if (
      ...
      // 追加札
      card.sortKey = `${
        CARD_DATA[cardSet as CardSet][card.extraFrom].sortKey
      }_${cardId}`;
    } else if (card.replace) {
      // 別のカードを置き換えるアナザー
      card.sortKey = `${card.replace}_${card.anotherID}`;
    } else if (
      card.baseType === "poison" ||
      card.baseType === "mainParts" ||
...
export const ALL_CARD_ID_LIST: { [cardSet in CardSet]: TCardId[] } = {} as {
  [cardSet in CardSet]: TCardId[];
};
export const ALL_CARD_LIST: { [cardSet in CardSet]: CardDataItem[] } = {} as {
  [cardSet in CardSet]: CardDataItem[];
};

for (let cardSet of typedObjectKeys(CARD_DATA) as CardSet[]) {
