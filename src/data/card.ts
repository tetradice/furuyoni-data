...
const SAIEN_S1_CARD_DATA = {
  ...
  "01-yurina-o-n-4": {
    ...
    range: "2-4",
    damage: "4/3",
    text: "【常時】現在の間合が2以下ならば、この《攻撃》は-1/-1となる。",
  ...
  "03-himika-o-n-3": {
    ...
    range: "2-8",
    damage: "2/2",
    text: "【攻撃後】あなたのライフが2以上ならば、自ライフ→間合：1",
    textZh: "【攻击后】自命→1→虚",
    textZhG1: "【攻击后】自命（1）→虚",
  ...
  "03-himika-o-n-6": {
    ...
    rubyZh: "Backdraft",
    type: "action",
    text: "相手を畏縮させる。\n連火ーこのカードがこのターンに使用した3枚目以降のカードならば、このターンにあなたが次に行う他のメガミによるオーラへのダメージが3以下の《攻撃》は+1/+1となる。",
    textZh:
  ...
  "03-himika-o-n-7": {
    ...
    type: "enhance",
    capacity: "3",
    text: "【展開中】あなたの終了フェイズに手札が0枚ならば、カードを1枚引いてもよい。",
  ...
  "03-himika-o-s-4": {
    ...
    type: "action",
    text: "連火―このカードがこのターンに使用した3枚目以降のカードならば、ダスト→間合：1\n再起:あなたの手札が0枚である。",
    textZh:
  ...
  "04-tokoyo-o-n-3": {
    ...
    range: "0-3",
    damage: "1/0",
    text: "【常時】境地-あなたの集中力が2ならば、この《攻撃》は+0/+1となる。\n【攻撃後】ダスト→間合：2",
  ...
  "04-tokoyo-A1-n-1": {
    ...
    range: "5",
    damage: "-/1",
    text: "【常時】あなたのトコヨの切札が使用済ならば、この《攻撃》は対応不可を得る。\n【攻撃後】境地―あなたの集中力が2またはあなたの他のメガミの切札が使用済ならば、このカードを山札の上か底に置く。",
    textZh:
  ...
  "04-tokoyo-A1-s-3": {
    ...
    rubyEn: "",
    type: "action",
    text: "【常時】境地―あなたの集中力が2ならば、このカードの消費は1小さくなる。\nこのターン中、あなたは集中力を支払えない。\n【使用済】あなたが他のメガミの《対応》カードを使用した時、自分のターンなら基本動作《後退》か《離脱》を1回行ってもよい。相手のターンなら相手を畏縮させる。\n即再起:あなたが《攻撃》によりライフに1以上のダメージを受ける。",
    textZh:
  ...
  "05-oboro-o-n-6": {
    ...
    range: "3-4",
    damage: "2/1",
    text: "【攻撃後】手札を1枚伏せ札にしてもよい。そうした場合、攻撃『適正距離3-4、1/1』を行い、基本動作《纏い》を1回行う。",
    textZh:
  ...
  "06-yukihi-o-s-3": {
    ...
    type: "enhance",
    capacity: "5",
    text: "終端\n【展開中】あなたのターンにあなたが初めて行う《攻撃》は距離拡大（近1）を得て、+0/+1となる。\n",
    textZh:
  ...
  "07-shinra-o-n-1": {
    ...
    range: "2-7",
    damage: "2/-",
    text: "【常時】相手の山札に2枚以上のカードがあるならば、この《攻撃》はダメージを与える代わりに相手の山札の上から2枚を伏せ札にする。",
    textZh:
  ...
  "07-shinra-A1-n-7": {
    ...
    subType: "fullpower",
    capacity: "2",
    text: "【展開時】集中力を1支払い、計略を準備してもよい。\n【展開時/破棄時】計略を実行し、次の計略を準備する。\n神算:攻撃『適正距離 1,3,5、2/2、不可避、【攻撃後】相手は相手の手札から1枚選び、山札の底に置く』を行う。\n鬼謀:攻撃『適正距離 0,2,4、2/2、不可避、【攻撃後】相手の山札の上から1枚を捨て札にして、1枚を伏せ札にする』を行う。",
    textZh:
  ...
  "08-hagane-o-n-2": {
    ...
    range: "0-6",
    damage: "1/-",
    text: "【攻撃後】現在の間合がターン開始時の間合から2以上変化しているならば、相手は手札を1枚捨て札にする。",
    textZh:
  ...
  "08-hagane-A1-n-1": {
    ...
    rubyEn: "",
    type: "action",
    text: "現在の間合が3以上ならば、間合→自フレア：1 間合→相フレア：1",
    textZh: "若当前距离大于等于3，则：\n距→1→自气\n距→1→敌气",
  ...
  "09-chikage-o-s-1": {
    ...
    rubyEn: "",
    type: "action",
    text: "毒袋から「滅灯毒」1枚を選び、そのカードを相手の山札の一番上に置く。",
  ...
  "09-chikage-o-s-4": {
    ...
    subType: "fullpower",
    capacity: "4",
    text: "【展開中】あなたが1以上のライフへのダメージを受けた時、このカードを未使用に戻し、このカードの上の桜花結晶を全てダストに送る。\n(破棄時効果は失敗する)\n【破棄時】あなたの他の切札が全て使用済ならば、あなたは勝利する。",
    textZh:
  ...
  "10-kururu-o-n-1": {
    ...
    rubyZh: "Electric",
    type: "action",
    text: "機巧（行行行対対）: 相手のライフに1ダメージを与える。",
    textZh: "----\n<行行行对对> 给予敌命1点伤害。",
    textZhG1: "----\n机巧：蓝蓝蓝紫紫 对敌命造成1点伤害。",
  ...
  "10-kururu-o-n-2": {
    ...
    rubyZh: "Accelerator",
    type: "action",
    text: "機巧（行行付）: あなたの手札から《全力》カードを1枚選び、そのカードを使用してもよい。（フェイズは終了しない）",
    textZh:
  ...
  "10-kururu-o-n-3": {
    ...
    type: "action",
    subType: "reaction",
    text: "【常時】このカードは対応でしか使用できない。\n以下から2つまでを選び、任意の順に行う。（同じものを2回選ぶことはできない）\n・カードを1枚引く。\n・伏せ札1枚を山札の底に置く。\n・相手は手札を1枚捨て札にする。",
    textZh:
  ...
  "10-kururu-o-n-4": {
    ...
    type: "action",
    subType: "fullpower",
    text: "機巧（攻攻）: 相手のオーラに5ダメージを与える。\n機巧（行行）: 相手のフレアに1ダメージを与える。\n機巧（付付）: 相手のライフに1ダメージを与える。",
    textZh: "----\n<攻攻> 给予敌装5点伤害。\n----\n<付付> 给予敌命1点伤害。",
    textZhG1:
      "----\n机巧：红红 对敌装造成5点伤害。\n----\n机巧：绿绿 对敌命造成1点伤害。",
    textKo:
  ...
  "10-kururu-o-n-5": {
    ...
    type: "action",
    subType: "fullpower",
    text: "機巧（付対）:捨て札、伏せ札、切札のいずれかから未使用でも《全力》でもない他のメガミのカードを1枚選んでもよい。そのカードをコストを支払わずに使用する。その際、適正距離の全ての値、どちらかのダメージ、納のいずれかを1増減させてもよい。\n機巧（付対）:捨て札、伏せ札、切札のいずれかから未使用でも《全力》でもない他のメガミのカードを1枚まで選び、コストを支払わずにそれを使用してもよい。その際、適正距離の全ての値、どちらかのダメージ、納のいずれかを1増減させてもよい。\n\n【常時】このカードは伏せ札から手札にあるかのように通常の方法で使用できる。",
    textZh:
  ...
  "10-kururu-o-n-7": {
    ...
    type: "enhance",
    capacity: "0",
    text: "機巧（攻対）:【展開時】このカードの上に桜花結晶を4個ダストから置く。\n【展開中】各ターンにおける相手の2回目の《攻撃》は打ち消される。",
    textZh:
  ...
  "10-kururu-A1-n-1": {
    ...
    rubyZh: "Analyze",
    type: "action",
    text: "機巧（攻付対）：あなたの任意の伏せ札1枚または相手の無作為な伏せ札1枚を捨て札にする。そのカードが《攻撃》ならば相手のライフに1ダメージを与える。そうでなければ相手は手札を1枚伏せ札にする。",
    textZh:
  ...
  "10-kururu-A1-s-3": {
    ...
    type: "action",
    text: "機巧（攻）：相手の伏せ札が0枚ならば相手の山札の上から1枚を伏せ札にする。相手は伏せ札から1枚を選ぶ。あなたはカード名を1つ宣言し、相手は選んだカードを捨て札にする。そのカード名が一致したらこのカードの上にゲーム外から桜花結晶を1つ置く。2つになったら世紀の大発見を行う。\n【使用済】あなたが山札を再構成した時ならびに、《全力》カードを使用した時、このターンの終了フェイズにこのカードをコストを支払ずに使用してもよい。",
    textAdditional:
  ...
  "10-kururu-A2-s-4": {
    ...
    rubyZh: "Connect Dive",
    type: "action",
    text: "機巧（行付対）: 【使用時/使用済】他のメガミのカードで組み立てたならば、使用時とあなたのターン終了フェイズにダストまたはあなたのオーラからこのカードの上に桜花結晶を1つ置いてもよい。\n【使用済】あなたがある歯車枠の効果を解決するに際し、このカードの上の桜花結晶を1つダストに送ってもよい。そうした場合、その歯車枠の中に書かれた数字全てを2倍にする。",
    textZh:
  ...
  "11-thallya-o-n-5": {
    ...
    range: "2-7",
    damage: "1/1",
    text: "【攻撃後】騎動を行ってもよい。その後、あなたの捨て札から他のメガミの《全力》でない《攻撃》カードを1枚まで選び、それを使用してもよい。",
    textZh: "令对手畏缩。\n自装→2→自气",
    textZhG1: "自装（2）→自气 \n对手畏缩。",
    textKo: "상대를 위축시킨다。 \n 자신 오라→자신 플레어：2",
  ...
  "11-thallya-o-n-6": {
    ...
    rubyZh: "引擎轰鸣",
    type: "action",
    text: "マシンにある造花結晶2つを燃焼させてもよい。そうした場合、あなたは集中力を1得て、相フレア→ダスト：1\n集中力を2支払ってもよい。そうした場合、あなたの燃焼済の造花結晶を3つ回復する。",
    textZh:
  ...
  "11-thallya-o-s-4": {
    ...
    type: "action",
    subType: "fullpower",
    text: "あなたのマシンに造花結晶がないならばあなたのマシンはTransFormし、あなたの燃焼済の造花結晶を2つ回復する。そうでない場合、このカードを未使用に戻す。",
    textZh:
  ...
  "transform-02": {
    ...
    rubyEn: "",
    rubyZh: "娜迦形态",
    text: "【変形時】相手のフレアが3つ以上ならば、相手のフレアが2になるように桜花結晶をダストへ移動させる。\n【追加基本動作:Gamma-Ray】相手の山札の上から1枚を捨て札にする。",
    textZh:
  ...
  "transform-03": {
    ...
    rubyEn: "",
    rubyZh: "迦楼达形态",
    text: "【変形時】カードを2枚引く。このターンの間、手札の上限が無くなる。\n【追加基本動作:Delta-Wing】現在の間合が7以下ならば、ダスト→間合：1",
    textZh:
  ...
  "11-thallya-A1-n-5": {
    ...
    rubyZh: "快速变换",
    type: "action",
    text: "あなたのマシンからTransFormカード1枚を追加札に戻してもよい。そうした場合、追加札からTransFormカード1枚をマシンに置く。(TransFormしたことにはならず、その【変形時】効果は発生しない)\n燃焼済の造花結晶を1つ回復するか、基本動作を1回行う。",
    textZh:
  ...
  "11-thallya-A1-s-1": {
    ...
    rubyZh: "新型黑箱",
    type: "action",
    text: "終端\nあなたの燃焼済の造花結晶を1つ回復する。その後、あなたが燃焼済みの造花結晶を持たないならば、このカードの上にダストから桜花結晶を1つ置く。2つになったらこのカードの上の桜花結晶をダストに送るとともに、あなたのマシンはTransFormする。\n再起：あなたのマシンにある造花結晶が3個以下である。または、このターンにあなたのマシンがTransFormしている。",
    textZh:
  ...
  "transform-A1-03": {
    ...
    rubyEn: "",
    rubyZh: "阿修罗形态",
    text: "【変形時】相手は伏せ札から1枚を選び、それを捨て札にする。これをもう1回繰り返す。\n【追加基本動作:Sigma-Drive】攻撃『適正距離3,5、3/2【攻撃後】あなたは畏縮する』を行う。この基本動作は1ターンに1回だけ行える。",
    textZh:
  ...
  "12-raira-o-n-3": {
    ...
    range: "1-2",
    damage: "2/1",
    text: "【攻撃後】捨て札にある《攻撃》カード1枚を選び、山札の一番上に置いてもよい。",
  ...
  "12-raira-o-n-5": {
    ...
    rubyEn: "",
    type: "action",
    text: "集中力を1得る。\n風神ゲージと雷神ゲージの合計が4以上ならば、捨て札にある他のメガミのカードを1枚まで選び、山札の一番上に置いてもよい。\n12以上ならば、山札を再構成してカードを1枚引き、このカードを取り除く。",
    textZh:
  ...
  "12-raira-o-n-6": {
    ...
    type: "action",
    subType: "fullpower",
    text: "以下から1つを選ぶ。\n・風神ゲージと雷神ゲージを1ずつ上げ、相手を畏縮させる。\n・雷神ゲージを2倍にする。\nその後、風神ゲージと雷神ゲージの合計が12以上ならば、基本動作を2回まで行う。",
    textZh:
  ...
  "12-raira-o-s-1": {
    ...
    range: "1-2",
    damage: "2/2",
    text: "【常時】雷神ゲージが4以上ならば、この《攻撃》は+1/+0となる。\n再起:風神ゲージが4以上である",
    textZh:
  ...
  "15-korunu-A1-n-6": {
    ...
    subType: "fullpower",
    capacity: "0",
    text: "【展開時】このカードの上に桜花結晶を5個ダストから置き、あなたはオーラの空きがなくなるまで凍結する。この効果により2回以上凍結したならば、攻撃『適正距離2-5、2/2、対応不可(通常札)』を行う。\n【展開中】あなたへのダメージを解決するに際し、オーラにある凍結トークンを桜花結晶としても扱う。",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "15-korunu-A1-s-1": {
    ...
    range: "3-4",
    damage: "2/2",
    text: "【攻撃後】あなたは1回凍結する。これにより凍結トークンが置かれたならば、相手は1回凍結する。\n再起：相手のオーラにある凍結トークンがあなたのオーラにある凍結トークンより少ない。\n",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
  ...
  "19-megumi-o-s-3": {
    ...
    type: "enhance",
    capacity: "2",
    text: "【展開中】この付与札の上の桜花結晶はメインフェイズに移動しない。開始フェイズの処理であなたのほかの付与札から桜花結晶がダストへと送られるならば、それは代わりにこの付与札の上に動かす。\n【展開中】この付与札の上の種結晶が5個になったターンの終了フェイズに、攻撃『適正距離 5、5/5、不可避、【常時】この《攻撃》は打ち消されない』を行い、このカードの上の桜花結晶を全てダストに送る。",
    textZh:
