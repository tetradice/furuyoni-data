...
export const S2_BASE_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> = {
  ...
  "04-tokoyo-A1-s-2": {
    ...
    textZh:
      "【使用后】每当你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择1张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点或以上的伤害。",
    textZhG1:
      "【使用后】你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择一张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点以上的伤害。",
    textKo:
  ...
  "05-oboro-o-s-3": {
    ...
    textZh:
      "【使用后】每当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
    textZhG1:
      "【使用后】当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
    textKo:
  ...
  "12-raira-o-s-3-ex2": {
    ...
    textZh:
      "将你的1张处于使用后状态的王牌变为未使用状态。\n【使用后】你的王牌的费用减小1（王牌的费用不会为负）。",
    textZhG1:
      "将你的一张正面朝上的王牌翻面。【使用后】你的王牌的费用减小1（王牌的费用不会为负）。",
    textKo:
  ...
  "13-utsuro-o-s-4": {
    ...
    textZh:
      "【使用后】每当你的准备阶段开始时，对手选择一项：\n●敌装→1→虚\n●敌气→2→虚",
    textZhG1:
      "【使用后】当你的准备阶段开始时，对手选择一项：\n1.敌装（1）→虚；\n2.敌气（2）→虚。",
    textKo:
...
export const S3_UPDATED_CARD_DATA: Partial<{
  ...
  "11-thallya-o-s-3": {
    ...
    textZh:
      "【使用后】你的回合内，每当你由于基本动作以外的效果发动骑动结算完毕时，若此次骑动改变了距离，则你可以选择：虚↔1↔距",
    textZhG1:
      "【使用后】你的回合内，每当你的骑动效果结算完毕时，若此效果改变了距离且不属于基本动作，则你可以选择\n虚（1）⇔ 距",
    textKo:
  ...
  "14-honoka-o-s-1-ex1": {
    ...
    textZh:
      "【使用后】开花～每当你的结束阶段，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将这张『樱结手弦』与追加牌区的『旋即旌招幕展』交换，将『旋即旌招幕展』变为未使用状态。",
    textZhG1:
      "【使用后】开花-每当你的结束阶段结束时，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将此牌与追加牌『旋即旌招幕展』交换，将『旋即旌招幕展』翻为背面朝上。",
    textKo:
  ...
  "14-honoka-o-s-1-ex2": {
    ...
    textZh:
      "【使用后】每当你的结束阶段，进行一次“攻击距离0-10、伤害X/X、不可被对应、【常时】X等于场上樱花结晶数等于5的区域的个数”的攻击。（结束阶段存在樱花结晶的区域包括距、命(2个)、装(2个)、气(2个)、虚、付与区(2个)、王牌区(2个)、游戏外）",
    textZhG1:
      "【使用后】每当你的结束阶段结束时，进行一次“攻击距离0-10 伤害X/X 不可被对应 X等于场上樱花结晶数等于5的领域的个数。”的攻击。",
    textKo:
...
export const S7_UPDATED_CARD_DATA: Partial<{ [id in TCardId]: CardDataItem }> =
  {
    ...
    "10-kururu-A2-s-4": {
      ...
      textZhG1:
        "机巧：绿蓝紫～【使用时/使用后】若此机巧全部由其他女神的牌组装，则使用此牌时和你的结束阶段开始时你可以从虚或自装中选择1个樱花结晶移至此牌上。\n【使用后】当你结算齿轮框中的效果时，你可以将此牌上的1个樱花结晶移至虚。若如此做，该齿轮框中记述的所有数字变为原来的2倍。",
      textKo:
    ...
    "22-kiriko-o-s-1": {
      ...
      textZh:
        "【使用后】你因剑舞执行基本动作《装附》的时候，可以改为执行基本动作《聚气》。\n【使用后】你在每回合里执行第三次剑舞的时候，可以使用这张牌。（需要支付费用）",
      textZhG1:
        "【使用后】若你由剑舞执行基本动作《装附》，则你可以选择不执行基本动作《装附》，而改为执行基本动作《聚气》。\n【使用后】每当你进行本回合内的第3次剑舞时，结算完毕后你可以使用此牌。（需要支付费用）",
      textZhAdditional:
...
export const S7_2_UPDATED_CARD_DATA: Partial<{
  ...
  "10-kururu-o-n-5": {
    ...
    textZhG1:
      "---- \n<付对> 妳可以从弃牌、盖牌或使用后的王牌中选择并使用1张其他女神的非《全力》牌，而无需支付其费用。此时妳可以从该牌的攻击距离中含有的所有值、对装伤害、对命伤害或纳中选择一项，所选择的所有值增大或减小1。AF4\n---- \n【常时】妳可以从盖牌区由主要阶段的规则效果使用此牌。",
    textKo:
  ...
  "18-mizuki-o-s-3": {
    ...
    textZh:
      "终端 \n将你的1张手牌和追加牌处的『斗神』以已征兵的状态置入兵营。进行1次征兵。 \n【使用后】你从兵营使用的《攻击》牌的《攻击》得+1/+0，从兵营使用的《对应》牌失去终端。",
    textZhG1:
  ...
  "01-yurina-A2-s-1": {
    ...
    textZhG1:
      "不可被对应\n【常时】X等于支付此牌费用时自气中的樱花结晶的数目。 （修正王牌费用的效果于此效果之后结算）\n【攻击后】以任意顺序执行至多X次基本动作《装附》或基本动作《聚气》。选择至多X张妳的使用后状态的王牌，将其变为未使用状态。本回合内，妳的手牌上限增大X。",
    textKo:
  ...
  "16-yatsuha-AA1-n-7-ex1": {
    ...
    textZh:
      "从散樱的旅路的任意起点出发。\n【使用后】各回合的准备阶段开始时结算所在地的效果，将樱花结晶顺时针移动到下个位置。在将要再次结算起点的效果的时候，改为结算归路的效果。",
    textZhG1:
  ...
  "16-yatsuha-AA1-n-7-ex2": {
    ...
    textZh:
      "从回忆里选择1张牌，将其移回手牌。\n【使用后】当你将要抽一张牌时，可以改为从回忆里选择一张牌移回手牌。\n【使用后】当你将因重铸牌库而受到伤害时，可以改为选回忆中的1张牌公开并将其移出游戏。\n（从回忆中返回的牌可以公开并变为完全态）",
    textZhG1:
      "从回忆区中选择1张牌置入手牌。\n【使用后】每当妳将要抓牌时，妳可以选择不抓牌，而改为从回忆区中选择等量的牌置入手牌。\n【使用后】每当妳将要因重铸牌库受到命伤时，妳可以选择不受到此次命伤，而改为从回忆区中选择并展示1张牌，然后将该牌移出游戏。\n（若八叶的未变为完全态的牌将从回忆区置入手牌，则妳可以选择将该牌变为完全态后置入手牌）",
    textKo:
...
export const S9_UPDATED_CARD_DATA = {
  ...
  "02-saine-A1-n-6": {
    ...
    type: "enhance",
    capacity: "3",
    text: "【展開中】八相―相手が各ターンで初めて 《攻撃》を行った時、あなたのオーラが1以 下または他のメガミの切札が使用済ならば、 その《攻撃》は対応不可を失い、-1/+0となる。\n【展開時/破棄時】 サイネの切札が使用済な らば、このターン中あなたの切札の消費は 1少なくなる。\n",
    textZh: "",
    textZhG1: "",
    textKo: "",
    textEn: "",
