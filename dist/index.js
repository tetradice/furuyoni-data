...
exports.CARD_DATA["na-s4-pre"] = Object.assign({}, exports.CARD_DATA["na-s4"]);
for (let key of (0, typedObjectKeys_1.typedObjectKeys)(exports.S4_PRE_UPDATED_CARD_DATA)) {
    let data = exports.S4_PRE_UPDATED_CARD_DATA[key];
    if (data === null || data === undefined) {
        delete exports.CARD_DATA["na-s4-pre"][key];
    }
    else {
        exports.CARD_DATA["na-s4-pre"][key] = data;
    }
}
