...
export declare const S10_UPDATED_CARD_DATA: {
    ...
    readonly "07-shinra-o-n-2": {
        ...
        readonly textZh: "【攻击后】打消被对应的《攻击》非王牌且对装伤害不为「-」的攻击将造成的伤害（其攻击后效果依然结算）。\n【攻击后】对手抓1张牌。";
        readonly textZhG1: "";
        readonly textKo: "【공격후】 대응한 비장패가 아니며 오라 데미지가「-」 가 아닌 《공격》의 데미지를 무효화한다.\n【공격후】 상대는 카드를 1장 뽑는다.";
        readonly textEn: "";
    };
    readonly "08-hagane-o-s-4": {
        readonly megami: "hagane";
    ...
    readonly "26-innealra-o-n-1": {
        ...
        readonly textZh: "【攻击后】进行共鸣。";
        readonly textZhG1: "";
        readonly textKo: "【공격후】공명한다";
        readonly textEn: "";
    };
    readonly "26-innealra-o-n-5": {
        ...
        readonly name: "雨露霜雪";
        readonly nameEn: "";
        readonly nameZh: "雨露霜雪";
        readonly nameZhG1: "";
        readonly nameKo: "우로상설";
        ...
        readonly textZh: "进行最多1次基本动作。\n 以过去、现在、未来的顺序结算命运的效果。\n （因为并非共鸣所以不会变动命运）";
        readonly textZhG1: "";
        readonly textKo: "기본행동을 1회까지 수행한다.\n과거 -> 현재 -> 미래 순으로 운명의 효과를 해결한다.\n(공명이 아니므로 운명은 움직이지 않는다.)";
        readonly textEn: "";
    };
    readonly "26-innealra-o-n-7": {
        ...
        readonly textZh: "【展开时】虚→1→自装\n 【破弃时】可以将过去的命运移去未知的命运。";
        readonly textZhG1: "";
        readonly textKo: "【전개시】더스트→오라(자신):1\n【파기시】과거의 운명을 보지 못한 운명으로 이동시켜도 된다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o-s-4": {
        ...
        readonly nameEn: "";
        readonly nameZh: "造神·命运交缠";
        readonly nameZhG1: "";
        readonly nameKo: "이니르노르닐·아자나엘";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "innealra";
        readonly baseType: "special";
        readonly type: "enhance";
        readonly subType: "fullpower";
        readonly capacity: "5";
        ...
        readonly textZh: "【展开时】盖伏任意数量手牌，执行最多那个数量的基本动作。\n 【展开中】将命运导向交缠的命运。\n 【使用后】此卡不能被使用。";
        readonly textZhG1: "";
        readonly textKo: "【전개시】손패에서 원하는 만큼의 카드를 덮음패로 만든다. 그 장수와 같은 횟수까지 기본동작을 수행한다.\n【전개중】운명을 얽힌 운명으로 인도한다.\n【사용됨】이 카드는 사용할 수 없다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-n-2": {
        ...
        readonly textZh: "【常时】若本回合你有进行共鸣的话，此《攻击》得+0/+1。\n 【常时】若本回合你有使用其他女神的牌的话，此《攻击》得距离扩大（远2）。";
        readonly textZhG1: "";
        readonly textKo: "【상시】당신이 이번 턴에 공명하였다면, 이 《공격》은 +0/+1된다.\n【상시】당신이 이번 턴에 다른 여신의 카드를 사용하였다면, 이 《공격》은 거리확대(원2)를 얻는다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-n-3": {
        ...
        readonly textZh: "【攻击后】选择以下一项。此《攻击》被对应的话，改为对手进行选择：\n ●进行共鸣。\n ●将过去的命运移去未知的命运。";
        readonly textZhG1: "";
        readonly textKo: "【공격후】다음 중 하나를 선택한다. 이 《공격》이 대응되었다면 대신 상대가 선택한다.\n・공명한다\n・과거의 운명을 보지 못한 운명으로 이동시킨다.";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o1-n-6": {
        ...
        readonly name: "憂き意志";
        readonly nameEn: "";
        readonly nameZh: "忧愁意志";
        readonly nameZhG1: "";
        readonly nameKo: "쓰라린 의지";
        readonly ruby: "うきいし";
        readonly rubyEn: "";
        readonly baseType: "normal";
        readonly type: "enhance";
        ...
        readonly textZh: "【展开时/破弃时】对手从盖牌或者手牌中弃1张牌。";
        readonly textZhG1: "";
        readonly textKo: "【전개시/파기시】상대는 상대의 덮음패 또는 손패에서 1장을 버림패로 만든다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-s-1": {
        ...
        readonly nameEn: "";
        readonly nameZh: "逝枪·风蚀形销";
        readonly nameZhG1: "";
        readonly nameKo: "스피엘·사라바엘";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "spear";
        readonly baseType: "special";
        readonly type: "attack";
        readonly range: "4";
        readonly damage: "-/1";
        ...
        readonly textZh: "【常时】此攻击得距离扩大(近X)和距离扩大(远Y)。X为对手已使用的王牌数，Y为对手的弃牌数。\n ----\n 【再起】你在本回合进行了至少2次共鸣。";
        readonly textZhG1: "";
        readonly textKo: "【상시】이 《공격》은 거리확대(근X)와 거리확대(원Y)을 얻는다.\nX는 상대가 사용한 비장패의 숫자와 동일하다.\nY는 상대의 버림패의 숫자와 동일하다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-s-2": {
        ...
        readonly nameEn: "";
        readonly nameZh: "沉掩·洇雪消锋";
        readonly nameZhG1: "";
        readonly nameKo: "이얄카스·시라마카스";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "iarmhar cás";
        readonly baseType: "special";
        readonly type: "enhance";
        readonly subType: "reaction";
        readonly capacity: "1";
        ...
        readonly textZh: "【展开中】对手的《攻击》不能在基础值上进行增加。\n （代入、交换数值可以进行）";
        readonly textZhG1: "";
        readonly textKo: "【전개중】상대의 《공격》은 데미지가 본래 수치에서 가산되지 않는다\n(수치의 대입이나 교체 등은 가능하다.)";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-s-3": {
        ...
        readonly nameEn: "";
        readonly nameZh: "倚身·渐暮迟徊";
        readonly nameZhG1: "";
        readonly nameKo: "임·크레나즘";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "im";
        readonly baseType: "special";
        ...
        readonly textZh: "【已使用】对手的弃牌不会因为重铸牌库而移动。\n 【已使用】对手重铸牌库之后，将此卡移出游戏。";
        readonly textZhG1: "";
        readonly textKo: "【사용됨】상대의 버림패에 있는 카드는 패산을 재구성할 때 이동하지 않는다\n【사용됨】상대가 패산을 재구성을 수행할 때, 이 카드를 게임에서 제외한다.";
        readonly textEn: "";
        readonly removable: true;
    };
    readonly "26-innealra-o2-n-2": {
        ...
        readonly textZh: "【常时】你在本回合中进行过共鸣的话，此《攻击》得+0/+1。\n 【常时】你在本回合中使用过其他女神的牌的话，此《攻击》得+0/+1。";
        readonly textZhG1: "";
    ...
    readonly "26-innealra-o2-n-4": {
        ...
        readonly textZh: "进行基本动作《装附》或《后退》合计最多1次。\n 进行共鸣。";
        readonly textZhG1: "";
        readonly textKo: "기본동작 《휘감기》 또는 《후퇴》를 최대 1회 수행한다.\n공명한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-n-6": {
        ...
        readonly name: "脆き意志";
        readonly nameEn: "";
        readonly nameZh: "脆弱意志";
        readonly nameZhG1: "";
        readonly nameKo: "나약한 의지";
        readonly ruby: "もろきいし";
        readonly rubyEn: "";
        readonly baseType: "normal";
        readonly type: "enhance";
        ...
        readonly textZh: "【展开中】樱花结晶因基本动作《装附》以外的原因向敌装移动的话，改为移到此卡上。\n 【展开中】对手进行基本动作《装附》时，结算后从将此卡上的1个樱花结晶移去虚。";
        readonly textZhG1: "";
        readonly textKo: "【전개중】기본동작 《휘감기》 외의 방법으로 상대의 오라로 벚꽃결정이 이동하려 한다면, 대신 그 결정은 이 카드 위로 이동한다.\n【전개중】상대가 기본동작 《휘감기》를 수행할 때, 그 동작의 해결 후 이 카드 위에서 벚꽃결정 하나를 더스트로 보낸다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-s-1": {
        ...
        readonly nameEn: "";
        readonly nameZh: "思枪·悲悯忧叹";
        readonly nameZhG1: "";
        readonly nameKo: "스피엘·우리엘";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "spear";
        readonly baseType: "special";
    ...
    readonly "26-innealra-o2-s-2": {
        ...
        readonly nameEn: "";
        readonly nameZh: "穿针·同受异诛";
        readonly nameZhG1: "";
        readonly nameKo: "스나하이드·도즐레드";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "snáthaid";
        readonly baseType: "special";
        readonly type: "enhance";
        readonly subType: "reaction";
        readonly capacity: "1";
        ...
        readonly textZh: "【展开中】对手的《攻击》得-1/+0。\n 【展开中】对手的《攻击》结算后，给予敌装1点伤害。";
        readonly textZhG1: "";
        readonly textKo: "【전개중】상대의 《공격》은 -1/+0 된다.\n【전개중】상대의 《공격》의 해결 후, 상대는 오라에 1 피해를 입는다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-s-3": {
        ...
        readonly nameEn: "";
        readonly nameZh: "破坏·欲壑难填";
        readonly nameZhG1: "";
        readonly nameKo: "시키리스·호리스";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "scrios";
        readonly baseType: "special";
        readonly type: "attack";
        readonly range: "1-4";
        readonly damage: "1/1";
        ...
        readonly textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。";
        readonly textZhG1: "";
        readonly textKo: "【상시】이 《공격》의 데미지로 이동하는 벚꽃결정은 더스트나 플레어가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-n-2": {
        ...
        readonly name: "星空包み";
        readonly nameEn: "";
        readonly nameZh: "星空裹缚";
        readonly nameZhG1: "";
        readonly nameKo: "별하늘 보따리";
    ...
    readonly "26-innealra-o3-n-4": {
        ...
        readonly textZh: "进行基本动作《聚气》或《前进》合计最多1次。\n 进行共鸣。";
        readonly textZhG1: "";
        readonly textKo: "기본동작 《품기》 또는 《전진》을 최대 1회 수행한다.\n공명한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-n-6": {
        ...
        readonly name: "儚き意志";
        readonly nameEn: "";
        readonly nameZh: "缥缈意志";
        readonly nameZhG1: "";
        readonly nameKo: "덧없는 의지";
        ...
        readonly textZhG1: "";
        readonly textKo: "【전개시】과거의 운명을 보지 못한 운명으로 이동시켜도 된다.\n【전개중】달인의 간격이 1 감소한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-s-1": {
        ...
        readonly nameEn: "";
        readonly nameZh: "时枪·永世长存";
        readonly nameZhG1: "";
        readonly nameKo: "스피엘·나가라엘";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "spear";
        readonly baseType: "special";
        ...
        readonly textZh: "【常时】因支付此卡费用而将移动的樱花结晶改为移去迷失。\n ----\n 【再起】你在本回合进行了至少2次共鸣。";
        readonly textZhG1: "";
        readonly textKo: "【상시】이 카드의 비용으로 지불하여 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-s-2": {
        ...
        readonly nameEn: "";
        readonly nameZh: "断念·或有他朝";
        readonly nameZhG1: "";
        readonly nameKo: "아이리아스·아루아스";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "éirigh as";
        readonly baseType: "special";
        readonly type: "enhance";
        readonly subType: "reaction";
        readonly capacity: "1";
        ...
        readonly textZhG1: "";
        readonly textKo: "【상시】이 카드의 비용으로 지불할 때 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동한다.\n【상시】이 카드를 사용할 때, 봉납을 간격에서 가져와도 된다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-s-3": {
        ...
        readonly nameEn: "";
        readonly nameZh: "‌宙宇·玄奥无明";
        readonly nameZhG1: "";
        readonly nameKo: "크레냐·안냐";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "cruinne";
        readonly baseType: "special";
        readonly type: "action";
        readonly cost: "0";
    ...
    readonly "26-innealra-o1-f-1": {
        ...
        readonly textZh: "本回合中你不能进行《攻击》。\n 现在距为5或更少的话，敌装→1→距\n 此命运是过去的命运的话，重复一次。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에, 당신은《공격》을 수행할 수 없다.\n현재 간격이 5 이하라면,\n오라(상대)→간격:1\n이 운명이 과거에 있다면, 다시 한번 수행한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-1a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的悔顾";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 회고";
        readonly ruby: "あざなえるかえりみ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "このターン中、あなたは通常札を使用できない。\n相手のライフに1ダメージを与える。";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "本回合中你不能使用通常牌。\n 给予敌命1点伤害。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에, 당신은 통상패를 사용할 수 없다.\n상대 라이프에 1 데미지를 준다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-2": {
        ...
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "本回合中你不能进行基本动作《前进》和《后退》。\n 敌气→1→敌装";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에, 당신은 기본동작 《전진》과《후진》을 수행할 수 없다.\n플레어(상대)→오라(상대):1";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-2a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的悼悔";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 후회";
        readonly ruby: "あざなえるくやみ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "このターン中、あなたは基本動作を行えない。\n相手のライフに1ダメージを与える。";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "本回合中你不能进行基本动作。\n 给予敌命1点伤害。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에, 당신은 기본동작을 수행할 수 없다.\n상대 라이프에 1 데미지를 준다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-3": {
        ...
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "此命运是过去的命运的话，给予敌命1点伤害。若如此做，你从手牌中舍弃1张《对应》牌，若不能这么做则将手牌公开。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이 운명이 과거에 있다면, 상대의 라이프에 1 데미지를 준다. 그렇게 했다면, 당신은 손패에서 《대응》카드 1장을 버림패로 만든다. 그렇게 하지 못했을경우, 당신은 손패를 공개한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-3a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的怨艾";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 원한";
        readonly ruby: "あざなえるうらみ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "このターン中にあなたが通常札を使用していないならば、相手のライフに1ダメージを与える。";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "若本回合中你没有使用过通常牌，则给予敌命1点伤害。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에 당신이 통상패를 사용하지 않았다면, 상대 라이프에 1 데미지를 준다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-4": {
        ...
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "你和对手各将牌库顶牌盖伏。\n 此命运是过去的命运的话，重复一次。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "당신과 상대의 패산 위의 카드 1장을 덮음패로 만든다. 이 운명이 과거에 있다면, 한번 더 수행한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o1-f-4a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的微憩";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 선잠";
        readonly ruby: "あざなえるまどろみ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "このターン中にあなたが基本動作を行っていないならば、相手のライフに1ダメージを与える。";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "若本回合中你没有进行过基本动作，则给予敌命1点伤害。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "이번 턴에 당신이 기본동작을 수행하지 않았다면, 상대 라이프에 1 데미지를 준다.";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o2-f-1a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的迷茫";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 당황";
        readonly ruby: "あざなえるとまどい";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "相オーラ→自フレア：2";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "敌装→2→自气";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "오라(상대)→플레어(당신):2";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-f-2": {
        ...
        readonly nameZh: "空虚";
        readonly nameZhG1: "";
        readonly nameKo: "서성이다";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "現在の間合に応じて以下を行う。\n5以上…間合→ダスト：2\n3以下…ダスト→間合：2";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "根据当前距进行以下行动：\n 5或更多…距→2→虚\n 3或更少…虚→2→距";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "현재 간격에 따라 다음을 수행한다:\n5이상: 간격→더스트:2\n3이하: 더스트→간격:2";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o2-f-3a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的纷乱";
        readonly nameZhG1: "";
        readonly nameKo: "뒤얽힌 혼란함";
        readonly ruby: "あざなえるちりまがい";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "攻撃『適正距離2-5、3/2』を行う。";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "进行一次“攻击距离2-5 伤害3/2”的攻击。";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "공격『적정거리 2-5, 3/2』를 수행한다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-f-4": {
        ...
        readonly nameZh: "救赎";
        readonly nameZhG1: "";
        readonly nameKo: "사죄하다";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "ダスト→自オーラ：2\nダスト→相オーラ：1";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "虚→2→自装\n 虚→1→敌装";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "더스트→오라(자신):2\n더스트→오라(상대):1";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-f-4a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的救赎";
        readonly nameZhG1: "";
        readonly nameKo: "뒤얽힌 사죄";
        readonly ruby: "あざなえるあがない";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "ダスト→自オーラ：3";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "虚→3→自装";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "더스트→오라(자신):3";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o3-f-1a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的憧憬";
        readonly nameZhG1: "";
        readonly nameKo: "뒤얽힌 동경";
        readonly ruby: "あざなえるあこがれ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "攻撃『適正距離0-X、3/5、対応不可、【常時】Xはロストに等しい』を行う。\nロスト→ダスト：∞";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "进行一次“攻击距离0-X 伤害3/5 不可被对应 【常时】X等于迷失的值”的攻击。\n 迷失→∞→虚";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "공격『적정거리 0-X, 3/5, 대응불가,【상시】X는 로스트의 숫자와 동일하다.』을 수행한다.\n로스트→더스트:모두";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-f-2": {
        ...
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "因角色规则进行共鸣的话结算以下行动：\n 你获得1点集中力，自装→1→迷失\n \n 若非如此则结算以下行动：\n 令对手畏缩、迷失→1→虚";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "규칙에 의한 공명이라면 다음을 수행한다:\n당신은 집중력을 1 얻은 뒤, 오라→로스트:1\n아니라면 다음을 수행한다:\n상대를 위축시킨 뒤, 로스트→더스트:1";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-f-2a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的垂首";
        readonly nameZhG1: "";
        readonly nameKo: "얽힌 낙담";
        readonly ruby: "あざなえるうなだれ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "相ライフ→ロスト：1";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "敌命→1→迷失";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "라이프(상대)→로스트:1";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o3-f-3a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的逃避";
        readonly nameZhG1: "";
        readonly nameKo: "뒤얽힌 달아남";
        readonly ruby: "あざなえるのがれ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "間合→ロスト：1\n間合→ダスト：1";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "距→1→迷失\n 距→1→虚";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "간격→로스트:1\n간격→더스트:1";
        readonly textEn: "";
    };
    ...
    readonly "26-innealra-o3-f-4a": {
        ...
        readonly nameEn: "";
        readonly nameZh: "交缠的恍惚";
        readonly nameZhG1: "";
        readonly nameKo: "뒤얽힌 말흐림";
        readonly ruby: "あざなえるかすれ";
        readonly rubyEn: "";
        readonly baseType: "fate";
        readonly text: "相オーラ→ロスト：1\n相フレア→ロスト：1";
        readonly textAdditional: "（クリックでまだ見ぬ運命へと移動）";
        readonly textZh: "敌装→1→迷失\n 敌气→1→迷失";
        readonly textZhG1: "";
        readonly textZhAdditional: "（点击即可将其移去未知的命运）";
        readonly textKo: "오라(상대)→로스트:1\n플레어(상대)→로스트:1";
        readonly textEn: "";
    };
};
export declare const S10_2_UPDATED_CARD_DATA: {
    readonly "17-hatsumi-o-s-1": {
        readonly megami: "hatsumi";
        readonly name: "イサナ海域";
        readonly nameEn: "Cetacean Ocean";
        readonly nameZh: "鲸鱼海域";
        readonly nameZhG1: "鲸鱼海域";
        readonly nameKo: "이사나 해역";
        readonly ruby: "いさなかいいき";
        readonly rubyEn: "";
        readonly baseType: "special";
        readonly type: "attack";
        readonly range: "3-5";
        ...
        readonly textZhG1: "";
        readonly textZhG1Additional: "【상시】순풍이라면, 이 《공격》은 +1/+2된다.\n【공격시】역풍이라면,\n더스트→간격：2\n을 하고, 이 카드를 미사용으로 되돌린다.";
        readonly textKo: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.";
        readonly textKoAdditional: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.";
        readonly textEn: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.";
    };
    readonly "20-kanawe-o-n-2": {
        readonly megami: "kanawe";
        readonly name: "脚本化";
        readonly nameEn: "Composition";
        readonly nameZh: "剧本化";
        readonly nameZhG1: "脚本化";
        readonly nameKo: "각본화";
        readonly ruby: "きゃくほんか";
        readonly rubyEn: "";
        readonly baseType: "normal";
        readonly type: "attack";
        readonly range: "3-5";
    ...
    readonly "21-kamuwi-o-s-1": {
        ...
        readonly textZhG1: "";
        readonly textZhG1Additional: "(+4) 당신의 플레어에 있는 벚꽃결정을 전부 더스트로 보낸다. 추가패에서 「새벽」을 미사용 상태로 얻는다.";
        readonly textKo: "(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside \"Daybreak\" to your Special cards, face-down.\n\n----------";
        readonly textKoAdditional: "(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside \"Daybreak\" to your Special cards, face-down.\n\n----------";
    ...
    readonly "23-akina-o-n-2": {
        ...
        readonly textZh: "投资券\n【常时】你的资本比对手的资本更多的话，此攻击得+0/+1。\n【攻击后】你的资本不比对手的资本多的话，盖伏此卡。";
        readonly textZhG1: "";
        readonly textZhG1Additional: "투자권\n【상시】 당신의 자본이 상대의 자본보다 크다면, 이 《공격》은 +0/+1 된다.\n【공격후】당신의 자본이 상대의 자본 이하라면, 이 카드를 덮음패로 만든다.";
        readonly textKo: "";
        readonly textEn: "";
        readonly investable: true;
    };
    readonly "26-innealra-o3-n-6": {
        ...
        readonly textZh: "【展开时】可以将过去的命运移去未知的命运。\n 【展开中】达人距离的数值减少1。";
        readonly textZhG1: "";
        readonly textZhG1Additional: "【전개시/파기시】과거의 운명을 아직 보지 않은 운명으로 이동시켜도 된다.\n【상시】이 부여패 위의 벚꽃결정이 더스트로 보내진다면, 대신 로스트로 이동한다.";
        readonly textKo: "";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-s-3": {
    ...
    readonly "22-renri-o-n-6": {
        ...
        readonly textZh: "伪证\n距→1→自气";
        readonly textZhG1: "";
        readonly textZhG1Additional: "위증\n간격→플레어(자신)：1";
        readonly textKo: "";
        readonly textEn: "";
        readonly lie: true;
    };
    readonly "18-mizuki-o-s-3": {
        readonly megami: "mizuki";
        readonly name: "大手楯無門";
        readonly nameEn: "Ōte Gate \"Tatenashi\"";
        readonly nameZh: "大手楯无门";
        readonly nameZhG1: "大手楯无门";
        readonly nameKo: "대수순무문";
        readonly ruby: "おおてたてなしもん";
        readonly rubyEn: "";
        readonly baseType: "special";
        readonly type: "action";
        readonly cost: "3";
    ...
    readonly "26-innealra-o-n-1": {
        ...
        readonly textZh: "【攻击后】进行共鸣。";
        readonly textZhG1: "";
        readonly textZhG1Additional: "【공격후】공명한다";
        readonly textKo: "";
        readonly textEn: "";
    };
    readonly "26-innealra-o2-s-3": {
        ...
        readonly damage: "1/1";
        readonly cost: "1";
        readonly text: "【常時】この《攻撃》のオーラへのダメージにより移動する桜花結晶はダストでなく間合に動かす。\n----\n【再起】あなたがこのターン中に2回以上共鳴している。";
        readonly textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。";
        readonly textZhG1: "";
        readonly textZhG1Additional: "【상시】이 《공격》의 오라 데미지로 이동하는 벚꽃결정은 더스트가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.";
        readonly textKo: "";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-f-1": {
