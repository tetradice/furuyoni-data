...
export declare const S10_2_UPDATED_CARD_DATA: {
    ...
    readonly "03-himika-o-n-6": {
        readonly megami: "himika";
        readonly name: "バックドラフト";
        readonly nameEn: "Backdraft";
        readonly nameZh: "回燃";
        readonly nameZhG1: "回燃";
        readonly nameKo: "백드래프트";
        readonly ruby: "";
        readonly rubyEn: "";
        readonly rubyZh: "Backdraft";
        readonly baseType: "normal";
        readonly type: "action";
    ...
    readonly "26-innealra-o2-s-3": {
        ...
        readonly textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。";
        readonly textZhG1: "";
        readonly textKo: "【상시】이 《공격》의 오라 데미지로 이동하는 벚꽃결정은 더스트가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.";
        readonly textEn: "";
    };
    readonly "26-innealra-o3-f-1": {
        readonly megami: "innealra";
