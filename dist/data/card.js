...
exports.ALL_CARD_LIST = exports.ALL_CARD_ID_LIST = exports.CARD_SORT_KEY_MAP = exports.STORY_CARD_DATA = exports.S10_2_UPDATED_CARD_DATA = exports.S10_UPDATED_CARD_DATA = exports.S9_2_UPDATED_CARD_DATA = exports.S9_UPDATED_CARD_DATA = exports.S8_2_UPDATED_CARD_DATA = exports.S8_UPDATED_CARD_DATA = exports.S7_2_UPDATED_CARD_DATA = exports.S7_UPDATED_CARD_DATA = exports.S6_2_UPDATED_CARD_DATA = exports.S6_UPDATED_CARD_DATA = exports.S5_UPDATED_CARD_DATA = exports.S4_PRE_UPDATED_CARD_DATA = exports.S4_UPDATED_CARD_DATA = exports.S3_UPDATED_CARD_DATA = exports.S2_BASE_CARD_DATA = exports.CARD_DATA = void 0;
...
exports.S2_BASE_CARD_DATA = {
    ...
    "02-saine-A1-n-6": {
        ...
        textZh: "【展开中】若你有至少1张另一柱女神的王牌为已使用状态，则每回合对手的第一次《攻击》得-1/+0。\n【展开中】若你有至少1张细音的王牌为已使用状态，则每回合你使用的第一张王牌费用减小1（王牌的费用不会为负值）。",
    ...
    "04-tokoyo-A1-s-2": {
        ...
        textZh: "【已使用】每当你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择1张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点或以上的伤害。",
        textZhG1: "【已使用】你的准备阶段开始时，你可以从你的弃牌区或盖牌区中选择一张牌，将其置于你的牌库底。\n----\n【即再起】自命受到除重铸牌库以外的1点以上的伤害。",
    ...
    "05-oboro-o-s-3": {
        ...
        textZh: "【已使用】每当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
        textZhG1: "【已使用】当你将重铸牌库时，你可以以任意顺序使用任意张具设置关键字的牌。",
    ...
    "12-raira-o-s-3-ex2": {
        ...
        textZh: "将你的1张处于已使用状态的王牌变为未使用状态。\n【已使用】你的王牌的费用减小1（王牌的费用不会为负）。",
        textZhG1: "将你的一张正面朝上的王牌翻面。【已使用】你的王牌的费用减小1（王牌的费用不会为负）。",
    ...
    "13-utsuro-o-s-4": {
        ...
        textZh: "【已使用】每当你的准备阶段开始时，对手选择一项：\n●敌装→1→虚\n●敌气→2→虚",
        textZhG1: "【已使用】当你的准备阶段开始时，对手选择一项：\n1.敌装（1）→虚；\n2.敌气（2）→虚。",
...
exports.S3_UPDATED_CARD_DATA = {
    ...
    "11-thallya-o-s-3": {
        ...
        textZh: "【已使用】你的回合内，每当你由于基本动作以外的效果发动骑动结算完毕时，若此次骑动改变了距离，则你可以选择：虚↔1↔距",
        textZhG1: "【已使用】你的回合内，每当你的骑动效果结算完毕时，若此效果改变了距离且不属于基本动作，则你可以选择\n虚（1）⇔ 距",
    ...
    "14-honoka-o-s-1-ex1": {
        ...
        textZh: "【已使用】开花～每当你的结束阶段，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将这张『樱结手弦』与追加牌区的『旋即旌招幕展』交换，将『旋即旌招幕展』变为未使用状态。",
        textZhG1: "【已使用】开花-每当你的结束阶段结束时，你可以将至多2个樱花结晶从自装移至此牌上。然后若此牌上恰有5个樱花结晶，则将它们移入自气，将此牌与追加牌『旋即旌招幕展』交换，将『旋即旌招幕展』翻为背面朝上。",
    ...
    "14-honoka-o-s-1-ex2": {
        ...
        textZh: "【已使用】每当你的结束阶段，进行一次“攻击距离0-10、伤害X/X、不可被对应、【常时】X等于场上樱花结晶数等于5的区域的个数”的攻击。（结束阶段存在樱花结晶的区域包括距、命(2个)、装(2个)、气(2个)、虚、付与区(2个)、王牌区(2个)、游戏外）",
        textZhG1: "【已使用】每当你的结束阶段结束时，进行一次“攻击距离0-10 伤害X/X 不可被对应 X等于场上樱花结晶数等于5的领域的个数。”的攻击。",
...
exports.S4_PRE_UPDATED_CARD_DATA = {
    ...
    "13-utsuro-o-s-4": {
        ...
        text: "【使用済】あなたの開始フェイズの開始時に相手は以下のどちらかを選ぶ。\n・相オーラ→ダスト：1\n・相フレア→ダスト：2",
        textZh: "【已使用】每当你的准备阶段开始时，对手选择一项：\n●敌装→1→虚\n●敌气→2→虚",
        textZhG1: "【已使用】每当你的准备阶段开始时，对手选择一项：\n1.敌装（1）→虚\n2.敌气（2）→虚",
        textKo: "【사용완료】당신의 개시 페이즈 시작시에 상대는 이하에서 하나를 고른다.\n ・상대 오라→더스트：1\n ・상대 플레어→더스트：2",
        textEn: "Devoted: At the beginning of your turn, your opponent chooses one:\n・Opponent's Aura (1)→ Shadow\n・Opponent's Flare (2)→ Shadow",
    },
    "14-honoka-o-n-2": {
...
exports.S7_UPDATED_CARD_DATA = {
    ...
    "16-yatsuha-A1-s-4": {
        ...
        textZh: "【已使用】如果你要重铸牌库，则在之前你可以公开你弃牌或者手牌中的一张八叶的牌并将其变为完全态。\n（例如将手牌中的『星之爪』公开的话就和追加牌区的『星辰之钩爪』作交换并加入手牌。）",
        textZhG1: "【已使用】每当你将要重铸牌库时，你可以从弃牌区或手牌中选择1张八叶的牌，展示该牌，然后将其变为完全态。\n（例如，若你展示了手牌中的『星之爪』，则将其与追加牌中的『星尘之利爪』交换，并加入手牌。）",
    ...
    "10-kururu-A2-s-4": {
        ...
        textZhG1: "机巧：绿蓝紫～【使用时/已使用】若此机巧全部由其他女神的牌组装，则使用此牌时和你的结束阶段开始时你可以从虚或自装中选择1个樱花结晶移至此牌上。\n【已使用】当你结算齿轮框中的效果时，你可以将此牌上的1个樱花结晶移至虚。若如此做，该齿轮框中记述的所有数字变为原来的2倍。",
    ...
    "22-kiriko-o-s-1": {
        ...
        textZh: "【已使用】你因剑舞执行基本动作《装附》的时候，可以改为执行基本动作《聚气》。\n【已使用】你在每回合里执行第三次剑舞的时候，可以使用这张牌。（需要支付费用）",
        textZhG1: "【已使用】若你由剑舞执行基本动作《装附》，则你可以选择不执行基本动作《装附》，而改为执行基本动作《聚气》。\n【已使用】每当你进行本回合内的第3次剑舞时，结算完毕后你可以使用此牌。（需要支付费用）",
...
exports.S7_2_UPDATED_CARD_DATA = {
    ...
    "08-hagane-o-n-7": {
        ...
        textZh: "全力化：【常时】这张卡的箭头（→）移动的樱花结晶数增多1个。 \n\n【展开时】距→1→自装 \n【展开中】达人距离的值减小1。",
        textZhG1: "全力化：【常时】因此牌上的箭头效果移动的樱花结晶的数目增大1。\n\n【展开时】距（1）→自装\n【展开中】达人距离减小1。",
        textKo: "	\n전력화 - 【상시】이 카드가 가지는 화살표 효과로 움직이는 벛꽃결정의 숫자가 1만큼 증가한다.\n【전개시】간격→오라(자신) : 1\n【전개중】달인의 간격이 1 감소한다.",
        textEn: "All-Out - Forced: This card's arrow effect moves one additional Sakura token.\n\nInitialize:\nDistance (1)→ Your Aura\n\nOngoing: Decrease the size of the Mastery Zone by 1.",
    },
    "10-kururu-o-n-5": {
        megami: "kururu",
        name: "りげいなー",
    ...
    "13-utsuro-o-n-1": {
        ...
        textZh: "【常时】灰尘～若虚中的樱花结晶数大于等于12，则此《攻击》获得距离扩大(近1)，对装伤害改为「-」。",
        textZhG1: "【常时】灰尘～若虚中的樱花结晶的数目大于等于12，则此《攻击》获得距离扩大（近1），且对装伤害变为“-”。",
        textKo: "	\n【상시】회진 - 더스트가 12 이상이라면 이 《공격》은 거리확대(근1)을 얻고, 오라로의 데미지는 [ - ]이 된다.",
        textEn: 'Forced: Ashen - If there are 12 or more Sakura tokens on Shadow, increase this attack\'s Range by 1 in the close direction, and its Damage to Aura becomes "-".',
    },
    "14-honoka-o-n-1": {
        megami: "honoka",
        name: "精霊式",
    ...
    "15-korunu-o-n-5": {
        ...
        textZh: "全力化：进行一次“攻击距离0-5、伤害1/2”的攻击，冻结对手直至敌装中没有空位为止。 \n\n进行1次基本动作《装附》，对手有至少3个冻结的话再进行一次。",
        textZhG1: "全力化：进行一次“攻击距离2-5 伤害1/2”的攻击。冻结对手，直至敌装中没有空位为止。\n\n执行1次基本动作《装附》。若敌装中有至少3个冻结指示物，则再执行1次基本动作《装附》。",
        textKo: "전력화: 공격 『적정거리2-5、1/2』를 수행하고, 상대의 오라의 빈 칸이 없어질 때까지 동결시킨다.\n\n기본행동 《휘감기》를 1회 수행한다. 상대가 3개 이상 동결되었다면 추가로 한번 더 수행한다.",
        textEn: 'All-Out - You attack with "Range: 2-5, Damage: 1/2". Then, Freeze your opponent until their Aura is full.\n\nPerform a Recover basic action. If your opponent has 3 or more Ice counters, repeat this effect an additional time.',
    },
    "16-yatsuha-A1-s-4": {
        megami: "yatsuha",
        anotherID: "A1",
    ...
    "18-mizuki-o-s-3": {
        ...
        textZhG1: "【常时】不动～若本回合内当前距离的值没有发生过变化，则此《攻击》获得+0/+1。\n【攻击后】将此牌置入追加牌区。\n（此牌视为菰珠的牌）",
    ...
    "21-kamuwi-o-s-1": {
        ...
        textZh: "(+3) 将自气的樱花结晶全部移至虚，并给予自命1点伤害。 \n从追加牌区以未使用的状态获得『晓』。",
        textZhG1: "(+3) 将自气中的所有樱花结晶移至虚，对自命造成1点伤害。将『晓』从追加牌区以未使用状态加入王牌。",
        textKo: '(+3) 당신의 플레어가 1 이하가 될 때 까지 벛꽃결정을 더스트로 보낸 후, 당신의 라이프에 1 대미지를 준다.\n추가패에서 "새벽"을 미사용 상태로 얻는다.',
        textEn: '(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside "Daybreak" to your Special cards, face-down.\n\n----------',
    },
    "21-kamuwi-o-s-2": {
        megami: "kamuwi",
        name: "阡",
        ...
        textZh: "(+2) 【展开时】进行一次“攻击距离3-4、伤害3/3、不可被对应（通常牌）”的攻击，并给予自命1点伤害。 \n---- \n【常时】此牌上有樱花结晶放置时，你无法胜利。",
        textZhG1: "(+2) 【展开时】进行一次“攻击距离3-4 伤害3/3 不可被对应（通常牌）”的攻击，对自命造成1点伤害。\n---- \n【常时】若此牌上置有樱花结晶，则妳不能因敌命中樱花结晶的数目降至0或叙述为“妳赢得本局游戏”的牌的效果而赢得本局游戏。",
        textKo: "(+2) 【전개시】공격 『적정거리3-4、3/3, 대응불가(통상패)』를 수행한 뒤, 당신의 라이프에 1 대미지를 받는다.\n----\n【상시】이 카드 위에 벚꽃결정이 올려져 있다면, 당신은 승리할 수 없다.",
        textEn: '(+2): Initialize: You attack with "Range: 3-4, Damage: 3/3, No Reactions (Normal)". Deal 1 damage to your Life.\n\n----------\n\nForced: As long as there are Sakura tokens on this card, you cannot win the game.',
    },
    "01-yurina-A2-n-3": {
        megami: "yurina",
        anotherID: "A2",
        ...
        textZh: "【攻击后】若对手选择由装承受此次伤害，则盖伏对手牌库顶的3张牌，你进行1次基本动作，对手如果可以的话则进行相同的基本动作。",
        textZhG1: "【攻击后】若对手选择由命承受此次伤害，则盖伏对手牌库顶的3张牌，执行1次基本动作，然后若对手能够执行该基本动作，则对手也如此做。",
        textKo: "【공격후】상대가 라이프로의 데미지를 선택했다면, 상대의 패산 위의 3장을 덮은 패로 만든 뒤, 당신은 기본동작을 1회 수행하고 상대도 동일한 기본동작을 가능하면 수행한다.",
        textEn: "After Attack: If your opponent chose to take damage to Life, put the top 3 cards of their deck into their discard pile, and you perform a basic action. Your opponent must also perform that basic action, if able.",
    },
    "01-yurina-A2-n-7": {
        megami: "yurina",
        anotherID: "A2",
        ...
        textZh: "【展开中】各个回合中，由于《攻击》的伤害或者基本动作，导致敌装第一次变化时，那个《攻击》或者基本动作结算后你可以选择以下一项执行：\n●进行基本动作《装附》。然后可以再进行基本动作《聚气》。\n●进行一次“攻击距离3-5、伤害2/1”的攻击。",
        textZhG1: "【展开中】每回合内，每当敌装中的樱花结晶数目首次因《攻击》伤害或基本动作的效果而变化时，该《攻击》或基本动作结算完毕后，妳可以选择一项。\n1.执行一次基本动作《装附》。妳可以执行一次基本动作《聚气》。\n2.进行一次“攻击距离3-5 伤害2/1”的攻击。",
        textKo: "【전개중】각 턴에 《공격》의 데미지 또는 기본동작으로 처음으로 상대 오라의 수치가 변화하였다면, 그 《공격》이나 기본동작의 해결 후 당신은 다음 중 하나를 골라 수행할 수 있다.\n・기본동작 《휘감기》를 수행한다. 그 후 기본동작 《품기》를 수행할 수 있다.\n・공격『적정거리3-5、2/1』을 수행한다.",
        textEn: 'Ongoing: The first time each turn your opponent\'s Aura changes due to a basic action or damage from an attack, after that basic action or attack resolves, you may choose one:\n・Perform a Recover basic action. Then, you may perform a Focus basic action.\n・You attack with "Range: 3-5, Damage: 2/1".',
    },
    "01-yurina-A2-s-1": {
        megami: "yurina",
        anotherID: "A2",
    ...
    "16-yatsuha-AA1-n-7-ex1": {
        ...
        textZh: "从散樱的旅路的任意起点出发。\n【已使用】各回合的准备阶段开始时结算所在地的效果，将樱花结晶顺时针移动到下个位置。在将要再次结算起点的效果的时候，改为结算归路的效果。",
        textZhG1: "从任意起点出发，开始散樱代的旅途。 （仅寄宿了自我八叶的玩家可以开始旅途，每局游戏中每名玩家仅能开始旅途一次）\n【已使用】每回合的准备阶段开始时，结算所在地的效果，然后将樱花结晶沿顺时针方向移至下一个地点。当将要第2次结算出发地的效果时，不结算出发地的效果，而改为结算归途的效果。",
        textZhAdditional: "（面朝上的状态下右键可以发动效果。之后，可以用画面上的「旅路」按钮来进行推进旅路的操作）",
        textZhG1Additional: "（在正面朝上的状态下，可以通过右键激活效果。之后，您可以从屏幕上的“旅程”按钮继续旅程。）",
        textKo: "벛꽃 내리는 시대의 여로의 임의의 지점에서 출발한다.\n【사용됨】각 턴의 개시 페이즈의 시작에 소재지의 효과를 해결 후, 벛꽃결정을 다음 위치에 시계방향으로 이동시킨다.\n출발점의 효과를 2번째 해결하려 한다면, 그 대신 귀로의 효과를 해결한다.",
        textKoAdditional: "(앞면 표시의 상태에서 우클릭으로 효과 발동 가능. 이후 화면에서 「여로」버튼으로 여로를 진행시킬 수 있다)",
        textEn: "Begin your Journey at the starting location of your choice.\n\nDevoted: At the beginning of each turn, resolve the effect of your current location, then move your Sakura token one location clockwise. If you would resolve your starting location's effect for the second time, instead resolve Homecoming.",
        textEnAdditional: '(To begin your Journey, right-click on this card. From then on, you can use the added "Journey" button to progress your Journey.)',
    },
...
exports.S8_UPDATED_CARD_DATA = {
    ...
    "23-akina-o-n-1": {
        ...
        textZh: "【攻击后】选择一项：\n●你获得1点集中力。\n●进行回收。\n●自气←1→自流",
        textZhG1: "",
        textKo: "【공격후】 아래에서 1가지를 선택한다.\n・당신은 집중력을 1 얻는다.\n・회수를 수행한다.\n・플레어(자신)↔플로우(자신):1",
        textEn: "After Attack: Choose one:\n・Gain 1 Vigor.\n・Divest.\n・Your Flare (1)↔ Your Flow",
    },
    "23-akina-o-n-2": {
        megami: "akina",
        name: "恫喝",
    ...
    "23-akina-o-s-1": {
        ...
        textZh: "进行一次“攻击距离0-10 伤害-/1\n【常时】此《攻击》被对应了的话，此攻击被打消。\n【常时】此《攻击》的伤害不会被改变”\n的攻击。那之后，你的资本比对手的资本更多的话，就再次使用此牌。\n（需要支付费用，且费用不受时价以外的变化影响）",
        textZhG1: "",
        textKo: "공격 『적정거리 0-10, -/1, 【상시】 이 《공격》이 대응되었다면, 이 《공격》은 무효화된다. 【상시】 이 《공격》의 데미지는 변하지 않는다』를 수행한다. 그 후, 당신의 자본이 상대의 자본보다 크다면 이 카드를 사용한다.\n(소모값은 지불하며, 시가 이외의 효과로 변화하지 않는다.)",
        textEn: 'You attack with "Range: 0-10, Damage: -/1, Forced: If a Reaction is made to this attack, cancel this attack., Forced: This attack\'s Damage cannot be modified." Then, if you have more funds than your opponent, play this card (again, paying its cost).',
    },
    "23-akina-o-s-2": {
        megami: "akina",
        name: "大衍算顆手打表",
    ...
    "24-shisui-o-n-2": {
        ...
        textZh: "【攻击后】进行一次“攻击距离2-3 伤害{1/2} 【常时】若敌装中有不少于敌装的裂伤指示物，则对手不能选择承受对装伤害”的攻击。",
        textZhG1: "",
        textKo: "【공격후】 공격 『적정거리 2-3, {1/2}, 【상시】 상대의 오라에 놓여있는 당신의 열상 토큰의 갯수가 상대의 오라 이상이라면, 상대는 오라 데미지를 선택할 수 없다.』을 수행한다.",
        textEn: "After Attack: You attack with \"Range: 2-3, Damage: {1/2}, Forced: If the number of your Laceration tokens on your opponent's Aura is greater than or equal to their Aura, your opponent cannot choose to take this attack's damage to Aura.\"",
    },
    "24-shisui-o-n-3": {
        megami: "shisui",
        name: "反乱撃",
    ...
    "24-shisui-o-n-6": {
        ...
        textZh: "进行两次基本动作《装附》。那之后，选择一项：\n●对自装和敌装各造成1点裂伤；\n●对自气和敌气各造成1点裂伤。",
        textZhG1: "",
        textKo: "기본동작 《휘감기》를 2번 수행한다. 그 후, 아래에서 1가지를 선택한다.\n・당신과 상대의 오라에 열상을 1 준다.\n・당신과 상대의 플레어에 열상을 1 준다.",
        textEn: "Perform 2 Recover basic actions, then choose one:\n・Lacerate each players' Aura once.\n・Lacerate each players' Flare once.",
    },
    "24-shisui-o-n-7": {
        megami: "shisui",
        name: "黒き鎧",
        ...
        textZh: "【展开时】从虚中将X个樱花结晶置于此牌上。X为本回合你受到过伤害的次数的两倍。X不小于4的话则额外再放置1个。\n【展开中】对手的《攻击》得+0/-1，且结算后将此付与牌上的2个樱花结晶移至虚。",
        textZhG1: "",
        textKo: "【전개시】 더스트에서 벚꽃결정을 X개 가져와 이 카드 위에 놓는다. X는 이번 턴에 당신이 데미지를 받은 횟수의 2배와 같다. X가 4 이상이라면 1개 더 놓는다.\n【전개중】 상대의 《공격》은 +0/-1 되고, 그 공격의 해결 후에 이 카드 위에 놓여진 벛꽃결정을 2개 더스트로 보낸다.",
        textEn: "Initialize: Move X Sakura tokens from Shadow to this card, where X is twice the number of times you've taken damage this turn. If X is 4 or more, move 1 additional token.\n\nOngoing: Your opponent's attacks get +0/-1. After one resolves, move 2 Sakura tokens from this card to Shadow.",
    },
    "24-shisui-o-s-1": {
        megami: "shisui",
        name: "ハドマギリ",
    ...
    "24-shisui-o-s-2": {
        ...
        textZh: "【攻击后】对手选择承受对命伤害的话，本回合中你的对装伤害不大于2的《攻击》造成的伤害裂伤化。\n----\n【再起】自装和自气合计不大于6。",
        textZhG1: "",
        textKo: "【공격후】 상대가 라이프 데미지를 선택했다면, 이 턴에 당신이 다음에 수행하는 오라 데미지가 2 이하인 《공격》을 열상화한다.\n----\n【재기】 당신의 오라와 플레어의 합계가 6 이하이다.",
        textEn: "After Attack: If your opponent chose to take damage to Life, the Damage from your next attack this turn that has 2 or less Damage to Aura becomes Lacerated.\n\nResurgence: Your total Aura and Flare is 6 or less.",
    },
    "24-shisui-o-s-3": {
        megami: "shisui",
        name: "アブダグイ",
        ...
        textZh: "打消被对应的《攻击》的伤害。若如此做，你受到{X/Y}的裂伤。X/Y的值和被打消的伤害相同。\n----\n【即再起】你承受本回合第三次伤害。",
        textZhG1: "",
        textKo: "대응한 《공격》의 데미지를 무효화한다.\n그렇게 했다면, 당신은 열상 {X/Y}을 받는다. X/Y는 무효화한 데미지와 같다.\n----\n【즉재기】 이번 턴에 당신이 3번째 데미지를 받았다.",
        textEn: "Cancel the damage of the attack you played this card as a Reaction to. If you did, Lacerate yourself for {X/Y}, where X and Y are the Damage values of that attack.\n\nImmediate Resurgence: You take damage for the third time in a turn.",
    },
    "24-shisui-o-s-4": {
        megami: "shisui",
        name: "桑畑志水の死に所",
        ...
        textZh: "【展开时】从敌气中将X个樱花结晶置于此牌上。若敌气比自气更多则X为那个差值，若否则X为0。\n【展开中】你不会输掉这局游戏。\n【展开中】自命为0时，对手无法支付集中力。",
        textZhG1: "",
        textKo: " 【전개시】 상대의 플레어에서 벚꽃결정을 X개 가져와 이 카드 위에 놓는다. 상대의 플레어가 당신의 플레어보다 많다면, X는 그 차이와 같다. 그렇지 않다면 X는 0이다.\n【전개중】 당신은 패배하지 않는다.\n【전개중】 당신의 라이프가 0이라면, 상대는 집중력을 지불할 수 없다.",
        textEn: "Initialize: Move X Sakura tokens from your opponent's Flare to this card. If your opponent has more Flare than you, X is equal to the difference. Otherwise, X is 0.\n\nOngoing: You cannot lose the game.\n\nOngoing: As long as your Life is 0, your opponent can't spend Vigor.",
    },
};
// シーズン8-2
exports.S8_2_UPDATED_CARD_DATA = {
    "06-yukihi-o-n-2": {
        megami: "yukihi",
        name: "しこみび / ねこだまし",
        nameEn: "Preparation / Fake Out",
    ...
    "10-kururu-A1-s-3": {
        ...
        textEn: "Mechanism (ATK) - If your opponent's discard pile has 0 cards in it, put 1 card from the top of your opponent's deck into their discard. Your opponent chooses a card in their discard pile, then you declare a card name. Put your opponent's chosen card into their played pile. If the name matched, move 1 Sakura token from Out-of-Game to this card. If there are 2 Sakura tokens on this card, you make the Discovery of the Century.\n\n----------\n\nDevoted: When you reshuffle your deck or play a Throughout card, at the end of this turn you may play this card ignoring any costs. (This effect can stack for multiple uses)",
    },
    "12-raira-o-n-2": {
        megami: "raira",
        name: "風雷撃",
    ...
    "22-renri-a1-n-2": {
        ...
        textZh: "【常时】此卡可以宣言当做，对手在眼前构筑选择的其他女神的非《付于》的通常牌，以正常的方式使用。若如此做，对手可以从其手牌、盖牌、弃牌中将那张牌公开。若公开的话，此牌使用失败并就这样弃掉。",
        textZhG1: "",
        textKo: "【상시】 이 카드를, 상대가 안전구축에서 고를 수 있는 다른 여신의 《부여》가 아닌 통상패로서 통상의 방법으로 사용을 선언해도 된다.\n그렇게 했다면, 상대는 상대의 손패, 덮은패, 버림패로부터 해당 카드를 공개해도 된다. 공개되었다면, 이 카드는 사용되지 않고 버림패가 된다.",
        textEn: "Forced: You may declare this card as if it were any non-Renri non-Enhancement Normal card that your opponent could have chosen during deck construction, being played within the regular timing rules of that card. When you do, your opponent may reveal the copied card from their hand, discard or played pile. If they reveal it, place this card in your played pile without being played.",
    },
    "22-renri-a1-n-5": {
        megami: "renri",
        anotherID: "A1",
        ...
        textAdditional: "（使用済み領域に出し、右クリックすることで効果を発動可能）",
        textZh: "将此「神授」置于牌库顶，那之后将其和遗物中的1张通常牌交换。\n【常时】在重铸牌库前弃牌中有这张「神授」的话，可以使用这张牌。",
        textZhG1: "",
        textZhAdditional: "（移动到已使用区域并右键就可以发动效果）",
        textKo: "이「신수」를 패산 위에 놓고, 그 후에 유물에 있는 통상패 한 장과 교환한다.\n【상시】패산을 재구성하기 직전에, 이 「신수」가 버림패에 있다면, 이 카드를 사용해도 된다.",
        textKoAdditional: "（사용됨 영역에서 꺼내서 우클릭으로 효과 발동 가능）",
        textEn: 'Put this "Divine Gift" on the top of your deck, then exchange it with a Noral card in your Relic.\n\nForced: You may use this "Divine Gift" from played pile just before you reshuffle your deck.',
        textEnAdditional: "(You can activate the effect by placing it in a used area and right-clicking.)",
    },
    "22-renri-a1-n-5-ex1": {
        megami: "renri",
        anotherID: "A1",
        ...
        textAdditional: "（表向きにした後に右クリックすることで回帰させることが可能）",
        ...
        textEn: "FalseTrap Falsehood Return\n\nAfter Attack: False Inferno - If the third card you play this turn is an attack card, that attack gains +0/+1.",
        textEnAdditional: "(You can return by right-clicking after turning it face up)",
        lie: true,
    },
    "22-renri-a1-n-5-ex2": {
        megami: "renri",
...
exports.S9_UPDATED_CARD_DATA = {
    ...
    "24-shisui-o-s-2": {
        ...
        cost: "{2}",
        text: "【攻撃後】相手がライフへのダメージを選んだならば、このターンにあなたが次に行うオーラへのダメージが2以下の《攻撃》のダメージは裂傷化する。\n----\n【再起】あなたのオーラとフレアの合計が6以下である。",
        textZh: "【攻击后】对手选择承受对命伤害的话，本回合中你的下一次对装伤害不大于2的《攻击》造成的伤害裂伤化。\n----\n【再起】自装和自气合计不大于6。",
        textZhG1: "",
        textKo: "【공격후】 상대가 라이프 데미지를 선택했다면, 이 턴에 당신이 다음에 수행하는 오라 데미지가 2 이하인 《공격》을 열상화한다.\n----\n【재기】 당신의 오라와 플레어의 합계가 6 이하이다.",
        textEn: "After Attack: If your opponent chose to take damage to Life, the Damage from your next attack this turn that has 2 or less Damage to Aura becomes Lacerated.\n\nResurgence: Your total Aura and Flare is 6 or less.",
    },
    ...
    "02-saine-A1-n-6": {
        ...
        textZh: "【展开中】八相～若自装中樱花结晶数仅1个或更少或你有已使用状态的其他女神的王牌，则每回合对手的第一次《攻击》失去不可被对应、得-1/+0。\n【展开时/破弃时】若你有已使用状态的细音的王牌，则在这个回合中你使用王牌的费用减小1。",
        textZhG1: "",
        textKo: "【전개중】팔상- 상대가 각 턴에 처음으로 《공격》을 수행할 때, 당신의 오라가 1 이하 또는 다른 여신의 비장패가 사용됨 상태라면, 그 《공격》은 대응불가를 잃고, -1/+0 된다.\n【전개시/파기시】사이네의 비장패가 사용됨 상태라면, 이 턴 중에 당신의 비장패의 소모값은 1 감소한다.\n(0 미만이 되지는 않는다)",
        textEn: "",
    },
    "04-tokoyo-A1-n-1": {
        megami: "tokoyo",
    ...
    "05-oboro-a2-s-1": {
        ...
        textZh: "【常时】此牌的消费会减少你的盖牌和组装的部件数的和。\n【攻击后】进行3次“攻击距离3-4 伤害2/1”的攻击。",
        textZhG1: "",
        textKo: "【상시】이 카드의 소비값은 당신의 덮은패 숫자와 조립한 파츠의 숫자의 합계만큼 감소한다.\n【공격후】 공격 『적정거리 3-4, 2/1』을 3번 수행한다.",
        textEn: "",
    },
    "05-oboro-a2-s-3": {
        megami: "oboro",
    ...
    "05-oboro-a2-mp-1": {
        ...
        damage: "2/2",
        text: "デジ設置",
        textAdditional: "（公開・使用する場合、このカードを「使用済み」領域へ移動）",
        textZh: "数码设置",
        textZhG1: "",
        textZhAdditional: "（需展示·使用的时候、将此牌移到「已使用」区域）",
        textKo: "디지설치",
        textKoAdditional: "（공개 및 사용하는 경우, 이 카드를 「사용됨」 영역으로 이동)",
        textEn: "",
    },
    "05-oboro-a2-mp-2": {
        megami: "oboro",
    ...
    "25-misora-o-n-1": {
        ...
        textZh: "【常时】对上瞄准的话，此《攻击》对装伤害变为「-」。\n【攻击后】当前的距等于瞄准的话，虚→1→自装",
        textZhG1: "",
        textZhAdditional: "（对上瞄准指当前距和瞄准都处于该《攻击》的攻击距离之内）",
        textKo: "【상시】조준이 맞았다면, 이 《공격》의 오라 데미지는 「-」이 된다\n【공격후】현재 간격과 조준이 동일하다면\n더스트→오라(자신):1",
        textEn: "",
    },
    "25-misora-o-n-2": {
        megami: "misora",
    ...
    "25-misora-o-n-3": {
        ...
        textZh: "【攻击后】比较当前的距和瞄准进行以下一项：\n・当前的距＞瞄准…距→1→虚\n・当前的距＝瞄准…虚→1→自装\n・当前的距＜瞄准…虚→1→距",
        textZhG1: "",
        textKo: "【공격후】현재 간격과 조준을 비교하여 다음 중 하나를 수행한다.\n현재 간격 > 조준: 간격→더스트:1\n현재 간격 = 조준: 더스트→오라(자신):1\n현재 간격 < 조준: 더스트→간격:1",
        textEn: "",
    },
    "25-misora-o-n-4": {
        megami: "misora",
    ...
    "25-misora-o-n-6": {
        ...
        textAdditional: "（このカードを右クリックすることで、眼前構築で選んでいないカードを取得可能。また、使用したカードを右クリックすることで取り除くことができる）",
        textZh: "从盖牌中或者眼前构筑时未选取的其他女神的牌中，选1张非《全力》的《攻击》通常牌，使用之且视其具有追踪。从游戏外使用了的那张牌在区域移动时会改为面朝下移出游戏。（回到眼前构筑时未选取的状态）",
        textZhG1: "",
        textZhAdditional: "（右键这张牌，以获取眼前构筑时未选取的牌。并且，使用的牌可以被右键移除）",
        textKo: "안전구축에서 선택하지 않은 다른 여신의 카드, 또는 덮은패로부터 《전력》이 아닌 《공격》을 하나 선택한 뒤, 그것을 추미를 부여하여 사용한다. 게임 외에서 사용한 카드가 다른 영역으로 이동할 때는 대신 그 카드를 뒷면으로 제거한다.\n(안전구축에서 선택되지 않은 상태로 되돌린다.)",
        textKoAdditional: "(이 카드를 우클릭해서 안전구축에서 고르지 않은 카드를 획득할 수 있음. 그리고 사용한 카드를 우클릭해서 제거할 수 있음)",
        textEn: "",
    },
    "25-misora-o-n-7": {
        megami: "misora",
    ...
    "25-misora-o-s-2": {
        ...
        textZh: "【展开中】有瞄准的话，当前的距等于瞄准。\n【展开中】你不能进行基本动作《前进》或《离脱》。",
        textZhG1: "",
        textKo: "【전개중】조준이 있다면 현재 간격은 조준과 동일한 것으로 취급한다.\n【전개중】당신은 기본동작 《전진》과 《이탈》을 수행할 수 없다.",
        textEn: "",
    },
    "25-misora-o-s-3": {
        megami: "misora",
        ...
        textZh: "【展开时】被对应的基于通常牌的《攻击》的攻击距离包含瞄准的话，打消被对应的《攻击》，并将其封印在此牌下。\n【破弃时】将封印在此牌下的牌返回对手的弃牌。",
        textZhG1: "",
        textKo: "【전개시】대응한 통상패에 의한 《공격》의 적정거리에 당신의 조준이 포함되어 있다면, 대응한 《공격》을 무효화한 뒤, 그 카드를 이 카드의 아래에 봉인한다.\n【파기시】 이 카드에 봉인된 카드를 상대의 버림패로 되돌린다.",
        textEn: "",
        sealable: true,
    },
    "25-misora-o-s-4": {
        ...
        textZh: "【展开中】当前的距的值增加5。\n【破弃时】敌命→1→距、敌装→1→距、敌气→1→距\n【已使用】此牌不能被使用。",
        textZhG1: "",
        textKo: "【전개중】현재의 간격이 5 증가한다.\n【파기시】라이프(상대)→간격:1\n오라(상대)→간격:1\n플레어(상대)→간격:1\n【사용됨】이 카드는 사용할 수 없다.",
        textEn: "",
    },
};
// シーズン9-2
exports.S9_2_UPDATED_CARD_DATA = {
    "01-yurina-o-n-5": {
        megami: "yurina",
        name: "体捌き",
        nameEn: "",
        ...
        textZh: "本回合你的下一次《攻击》获得距离扩大（远1）。\n自命小于敌命时，进行最多2次基本动作。",
        textZhG1: "",
        textKo: "이번 턴에 당신이 수행하는 다음번 《공격》은 거리확대(원1)을 얻는다.\n당신의 라이프가 상대의 라이프보다 적다면, 기본행동을 2회까지 수행한다.",
        textEn: "",
    },
    "06-yukihi-o-n-5": {
        megami: "yukihi",
    ...
    "11-thallya-o-s-3": {
        ...
        textZh: "【展开中】你燃烧造花结晶时，不是从引擎往已燃烧移动，而是从已燃烧往引擎移动。\n（已燃烧的造花结晶不足的话则无法燃烧）",
        textZhG1: "",
        textKo: "【전개중】당신이 조화결정을 연소시킬 때마다, 머신의 조화결정을 연소됨으로 이동시키는 대신 연소된 조화결정을 머신으로 이동시킨다.\n(연소됨 상태의 조화결정이 부족하다면 연소할 수 없다.)",
        textEn: "",
    },
    "12-raira-o-n-6": {
        megami: "raira",
    ...
    "22-renri-a1-n-5": {
        ...
        textAdditional: "（使用済み領域上で右クリックすることにより効果を発動可能）",
...
exports.S10_UPDATED_CARD_DATA = {
    ...
    "07-shinra-o-n-2": {
        ...
        textZh: "【攻击后】打消被对应的《攻击》非王牌且对装伤害不为「-」的攻击将造成的伤害（其攻击后效果依然结算）。\n【攻击后】对手抓1张牌。",
        textZhG1: "",
        textKo: "【공격후】 대응한 비장패가 아니며 오라 데미지가「-」 가 아닌 《공격》의 데미지를 무효화한다.\n【공격후】 상대는 카드를 1장 뽑는다.",
        textEn: "",
    },
    "08-hagane-o-s-4": {
        megami: "hagane",
    ...
    "24-shisui-o-n-4": {
        ...
        textZhG1: "",
        textKo: "【공격후】 상대를 위축시키고, 당신은 오라 또는 플레어 또는 라이프에 열상을 1 받는다.",
        textEn: "After Attack: Flinch your opponent. Lacerate your Aura, Flare, or Life once.",
    },
    "26-innealra-o-n-1": {
        megami: "innealra",
        name: "槍振るい",
    ...
    "26-innealra-o-s-4": {
        ...
        textZh: "【展开时】盖伏任意数量手牌，执行最多那个数量的基本动作。\n 【展开中】将命运导向交缠的命运。\n 【使用后】此卡不能被使用。",
        textZhG1: "",
        textKo: "【전개시】손패에서 원하는 만큼의 카드를 덮음패로 만든다. 그 장수와 같은 횟수까지 기본동작을 수행한다.\n【전개중】운명을 얽힌 운명으로 인도한다.\n【사용됨】이 카드는 사용할 수 없다.",
        textEn: "",
    },
    "26-innealra-o1-n-2": {
        megami: "innealra",
    ...
    "26-innealra-o1-n-3": {
        ...
        textZh: "【攻击后】选择以下一项。此《攻击》被对应的话，改为对手进行选择：\n ●进行共鸣。\n ●将过去的命运移去未知的命运。",
        textZhG1: "",
        textKo: "【공격후】다음 중 하나를 선택한다. 이 《공격》이 대응되었다면 대신 상대가 선택한다.\n・공명한다\n・과거의 운명을 보지 못한 운명으로 이동시킨다.",
        textEn: "",
    },
    "26-innealra-o1-n-4": {
        megami: "innealra",
    ...
    "26-innealra-o1-n-6": {
        ...
        textZhG1: "",
        textKo: "【전개시/파기시】상대는 상대의 덮음패 또는 손패에서 1장을 버림패로 만든다.",
        textEn: "",
    },
    "26-innealra-o1-s-1": {
        megami: "innealra",
        ...
        textZh: "【常时】此攻击得距离扩大(近X)和距离扩大(远Y)。X为对手已使用的王牌数，Y为对手的弃牌数。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
        textZhG1: "",
        textKo: "【상시】이 《공격》은 거리확대(근X)와 거리확대(원Y)을 얻는다.\nX는 상대가 사용한 비장패의 숫자와 동일하다.\nY는 상대의 버림패의 숫자와 동일하다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
        textEn: "",
    },
    "26-innealra-o1-s-2": {
        megami: "innealra",
        ...
        textZh: "【展开中】对手的《攻击》不能在基础值上进行增加。\n （代入、交换数值可以进行）",
        textZhG1: "",
        textKo: "【전개중】상대의 《공격》은 데미지가 본래 수치에서 가산되지 않는다\n(수치의 대입이나 교체 등은 가능하다.)",
        textEn: "",
    },
    "26-innealra-o1-s-3": {
        megami: "innealra",
        ...
        textZh: "【已使用】对手的弃牌不会因为重铸牌库而移动。\n 【已使用】对手重铸牌库之后，将此卡移出游戏。",
        textZhG1: "",
        textKo: "【사용됨】상대의 버림패에 있는 카드는 패산을 재구성할 때 이동하지 않는다\n【사용됨】상대가 패산을 재구성을 수행할 때, 이 카드를 게임에서 제외한다.",
        textEn: "",
        removable: true,
    },
    "26-innealra-o2-n-2": {
        ...
        textZh: "【常时】你在本回合中进行过共鸣的话，此《攻击》得+0/+1。\n 【常时】你在本回合中使用过其他女神的牌的话，此《攻击》得+0/+1。",
        textZhG1: "",
    ...
    "26-innealra-o2-n-6": {
        ...
        textZh: "【展开中】樱花结晶因基本动作《装附》以外的原因向敌装移动的话，改为移到此卡上。\n 【展开中】对手进行基本动作《装附》时，结算后从将此卡上的1个樱花结晶移去虚。",
        textZhG1: "",
        textKo: "【전개중】기본동작 《휘감기》 외의 방법으로 상대의 오라로 벚꽃결정이 이동하려 한다면, 대신 그 결정은 이 카드 위로 이동한다.\n【전개중】상대가 기본동작 《휘감기》를 수행할 때, 그 동작의 해결 후 이 카드 위에서 벚꽃결정 하나를 더스트로 보낸다.",
        textEn: "",
    },
    "26-innealra-o2-s-1": {
        megami: "innealra",
    ...
    "26-innealra-o2-s-3": {
        ...
        textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
        textZhG1: "",
        textKo: "【상시】이 《공격》의 데미지로 이동하는 벚꽃결정은 더스트나 플레어가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
        textEn: "",
    },
    "26-innealra-o3-n-2": {
        megami: "innealra",
    ...
    "26-innealra-o3-n-6": {
        ...
        textZh: "【展开时】可以将过去的命运移去未知的命运。\n 【展开中】达人距离的数值减少1。",
        textZhG1: "",
        textKo: "【전개시】과거의 운명을 보지 못한 운명으로 이동시켜도 된다.\n【전개중】달인의 간격이 1 감소한다.",
        textEn: "",
    },
    "26-innealra-o3-s-1": {
        megami: "innealra",
        ...
        textZh: "【常时】因支付此卡费用而将移动的樱花结晶改为移去迷失。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
        textZhG1: "",
        textKo: "【상시】이 카드의 비용으로 지불하여 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
        textEn: "",
    },
    "26-innealra-o3-s-2": {
        megami: "innealra",
        ...
        textZhG1: "",
        textKo: "【상시】이 카드의 비용으로 지불할 때 이동하는 벚꽃결정은 더스트가 아니라 로스트로 이동한다.\n【상시】이 카드를 사용할 때, 봉납을 간격에서 가져와도 된다.",
        textEn: "",
    },
    "26-innealra-o3-s-3": {
        megami: "innealra",
    ...
    "26-innealra-o1-f-1": {
        ...
        textKo: "이번 턴에, 당신은《공격》을 수행할 수 없다.\n현재 간격이 5 이하라면,\n오라(상대)→간격:1\n이 운명이 과거에 있다면, 다시 한번 수행한다.",
        textEn: "",
    },
    "26-innealra-o1-f-1a": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이번 턴에, 당신은 통상패를 사용할 수 없다.\n상대 라이프에 1 데미지를 준다.",
        textEn: "",
    },
    "26-innealra-o1-f-2": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이번 턴에, 당신은 기본동작 《전진》과《후진》을 수행할 수 없다.\n플레어(상대)→오라(상대):1",
        textEn: "",
    },
    "26-innealra-o1-f-2a": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이번 턴에, 당신은 기본동작을 수행할 수 없다.\n상대 라이프에 1 데미지를 준다.",
        textEn: "",
    },
    "26-innealra-o1-f-3": {
        megami: "innealra",
        ...
        textAdditional: "（クリックでまだ見ぬ運命へと移動）",
        textZh: "此命运是过去的命运的话，给予敌命1点伤害。若如此做，你从手牌中舍弃1张《对应》牌，若不能这么做则将手牌公开。",
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이 운명이 과거에 있다면, 상대의 라이프에 1 데미지를 준다. 그렇게 했다면, 당신은 손패에서 《대응》카드 1장을 버림패로 만든다. 그렇게 하지 못했을경우, 당신은 손패를 공개한다.",
        textEn: "",
    },
    "26-innealra-o1-f-3a": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이번 턴에 당신이 통상패를 사용하지 않았다면, 상대 라이프에 1 데미지를 준다.",
        textEn: "",
    },
    "26-innealra-o1-f-4": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "당신과 상대의 패산 위의 카드 1장을 덮음패로 만든다. 이 운명이 과거에 있다면, 한번 더 수행한다.",
        textEn: "",
    },
    "26-innealra-o1-f-4a": {
        megami: "innealra",
        ...
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "이번 턴에 당신이 기본동작을 수행하지 않았다면, 상대 라이프에 1 데미지를 준다.",
        textEn: "",
    },
    "26-innealra-o2-f-1": {
        megami: "innealra",
    ...
    "26-innealra-o3-f-1a": {
        ...
        textAdditional: "（クリックでまだ見ぬ運命へと移動）",
        textZh: "进行一次“攻击距离0-X 伤害3/5 不可被对应 【常时】X等于迷失的值”的攻击。\n 迷失→∞→虚",
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "공격『적정거리 0-X, 3/5, 대응불가,【상시】X는 로스트의 숫자와 동일하다.』을 수행한다.\n로스트→더스트:모두",
        textEn: "",
    },
    "26-innealra-o3-f-2": {
        megami: "innealra",
        ...
        textAdditional: "（クリックでまだ見ぬ運命へと移動）",
        textZh: "因角色规则进行共鸣的话结算以下行动：\n 你获得1点集中力，自装→1→迷失\n \n 若非如此则结算以下行动：\n 令对手畏缩、迷失→1→虚",
        textZhG1: "",
        textZhAdditional: "（点击即可将其移去未知的命运）",
        textKo: "규칙에 의한 공명이라면 다음을 수행한다:\n당신은 집중력을 1 얻은 뒤, 오라→로스트:1\n아니라면 다음을 수행한다:\n상대를 위축시킨 뒤, 로스트→더스트:1",
        textEn: "",
    },
    "26-innealra-o3-f-2a": {
        megami: "innealra",
...
// シーズン10-2
exports.S10_2_UPDATED_CARD_DATA = {
    "17-hatsumi-o-s-1": {
        megami: "hatsumi",
        name: "イサナ海域",
        nameEn: "Cetacean Ocean",
        ...
        textZh: "【常时】若顺风，此《攻击》得+1/+2。\n【攻击后】若逆风，则：虚→2→距。\n然后将此牌变为未使用的状态。",
        textZhG1: "",
        textZhG1Additional: "【상시】순풍이라면, 이 《공격》은 +1/+2된다.\n【공격시】역풍이라면,\n더스트→간격：2\n을 하고, 이 카드를 미사용으로 되돌린다.",
        textKo: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.",
        textKoAdditional: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.",
        textEn: "Forced: If there is a tailwind, this attack gains +1/+2.\n\nAfter Attack: If there is a headwind, Shadow (2)→ Distance, then turn this card face-down.",
    },
    "20-kanawe-o-n-2": {
        megami: "kanawe",
        name: "脚本化",
        ...
        textZh: "【攻击后】你可以从追加牌区的构想牌中准备1张构想。 \n【常时】在你的结束阶段你可以将此牌从弃牌放到牌库底。若如此做，对手获得1集中力。",
        textZhG1: "",
        textZhG1Additional: "【공격후】추가패에서 구상 카드를 1장 준비해도 좋다.\n【상시】당신의 종료 페이즈에 이 카드가 버림패에 있다면 패산의 아래에 두어도 좋다. 그렇게 했다면, 상대는 집중력 1을 얻는다.",
        textKo: "After Attack: You may prepare one of your set aside Plot cards.\n\nForced: At the end of your turn, you may move this card from your played pile to the bottom of your deck. If you do, your opponent gains 1 Vigor.",
        textKoAdditional: "After Attack: You may prepare one of your set aside Plot cards.\n\nForced: At the end of your turn, you may move this card from your played pile to the bottom of your deck. If you do, your opponent gains 1 Vigor.",
        textEn: "After Attack: You may prepare one of your set aside Plot cards.\n\nForced: At the end of your turn, you may move this card from your played pile to the bottom of your deck. If you do, your opponent gains 1 Vigor.",
    },
    "21-kamuwi-o-s-1": {
        megami: "kamuwi",
        ...
        textZh: "(+3) 将自气的樱花结晶全部移至虚，并给予自命1点伤害。 \n从追加牌区以未使用的状态获得『晓』。",
        textZhG1: "",
        textZhG1Additional: "(+4) 당신의 플레어에 있는 벚꽃결정을 전부 더스트로 보낸다. 추가패에서 「새벽」을 미사용 상태로 얻는다.",
        textKo: '(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside "Daybreak" to your Special cards, face-down.\n\n----------',
        textKoAdditional: '(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside "Daybreak" to your Special cards, face-down.\n\n----------',
        textEn: '(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside "Daybreak" to your Special cards, face-down.\n\n----------',
    },
    "23-akina-o-n-2": {
        megami: "akina",
    ...
    "26-innealra-o3-n-6": {
        ...
        textZh: "【展开时】可以将过去的命运移去未知的命运。\n 【展开中】达人距离的数值减少1。",
        textZhG1: "",
        textZhG1Additional: "【전개시/파기시】과거의 운명을 아직 보지 않은 운명으로 이동시켜도 된다.\n【상시】이 부여패 위의 벚꽃결정이 더스트로 보내진다면, 대신 로스트로 이동한다.",
        textKo: "",
        textEn: "",
    },
    "26-innealra-o3-s-3": {
    ...
    "26-innealra-o2-s-3": {
        ...
        textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
        textZhG1: "",
        textZhG1Additional: "【상시】이 《공격》의 오라 데미지로 이동하는 벚꽃결정은 더스트가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
        textKo: "",
        textEn: "",
    },
    "26-innealra-o3-f-1": {
...
exports.CARD_DATA["na-s9"] = Object.assign({}, exports.CARD_DATA["na-s8-2"]);
for (let key of (0, typedObjectKeys_js_1.typedObjectKeys)(exports.S9_UPDATED_CARD_DATA)) {
    let data = exports.S9_UPDATED_CARD_DATA[key];
    if (data === null || data === undefined) {
        delete exports.CARD_DATA["na-s9"][key];
    }
    else {
        exports.CARD_DATA["na-s9"][key] = data;
    }
}
exports.CARD_DATA["na-s9-2"] = Object.assign({}, exports.CARD_DATA["na-s9"]);
for (let key of (0, typedObjectKeys_js_1.typedObjectKeys)(exports.S9_2_UPDATED_CARD_DATA)) {
    let data = exports.S9_2_UPDATED_CARD_DATA[key];
    if (data === null || data === undefined) {
        delete exports.CARD_DATA["na-s9-2"][key];
    }
    else {
        exports.CARD_DATA["na-s9-2"][key] = data;
    }
}
exports.CARD_DATA["na-s10"] = Object.assign({}, exports.CARD_DATA["na-s9"]);
for (let key of (0, typedObjectKeys_js_1.typedObjectKeys)(exports.S10_UPDATED_CARD_DATA)) {
    let data = exports.S10_UPDATED_CARD_DATA[key];
    if (data === null || data === undefined) {
        delete exports.CARD_DATA["na-s10"][key];
    }
    else {
        exports.CARD_DATA["na-s10"][key] = data;
    }
}
exports.CARD_DATA["na-s10-2"] = Object.assign({}, exports.CARD_DATA["na-s10"]);
for (let key of (0, typedObjectKeys_js_1.typedObjectKeys)(exports.S10_2_UPDATED_CARD_DATA)) {
    let data = exports.S10_2_UPDATED_CARD_DATA[key];
    if (data === null || data === undefined) {
        delete exports.CARD_DATA["na-s10-2"][key];
    }
    else {
        exports.CARD_DATA["na-s10-2"][key] = data;
    }
}
