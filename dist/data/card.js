...
exports.S10_2_UPDATED_CARD_DATA = {
    ...
    "21-kamuwi-o-s-1": {
        ...
        textZh: "(+4) 将自气的樱花结晶全部移至虚。从追加牌区以未使用的状态获得『晓』。",
        textZhG1: "",
        textKo: "(+4) 당신의 플레어에 있는 벚꽃결정을 전부 더스트로 보낸다. 추가패에서 「새벽」을 미사용 상태로 얻는다.",
        textEn: '(+3): Move all Sakura tokens on your Flare to Shadow. Deal 1 damage to your Life.\n\nAdd your set aside "Daybreak" to your Special cards, face-down.\n\n----------',
    },
    "23-akina-o-n-2": {
        megami: "akina",
    ...
    "26-innealra-o3-n-6": {
        ...
        textZh: "【展开时/破弃时】可以将过去的命运移去未知的命运。\n 【常时】此付与牌上的樱花结晶将移至虚时，改为移去迷失。",
        textZhG1: "",
        textKo: "【전개시/파기시】과거의 운명을 아직 보지 않은 운명으로 이동시켜도 된다.\n【상시】이 부여패 위의 벚꽃결정이 더스트로 보내진다면, 대신 로스트로 이동한다.",
        textEn: "",
    },
    "26-innealra-o3-s-3": {
        megami: "innealra",
    ...
    "26-innealra-o2-s-3": {
        ...
        textZh: "【常时】因此《攻击》造成的伤害将移动的樱花结晶改为移去距。\n ----\n 【再起】你在本回合进行了至少2次共鸣。",
        textZhG1: "",
        textKo: "【상시】이 《공격》의 오라 데미지로 이동하는 벚꽃결정은 더스트가 아니라 간격으로 이동시킨다.\n【재기】당신이 이번 턴에 2회 이상 공명하였다.",
        textEn: "",
    },
    "26-innealra-o3-f-1": {
        megami: "innealra",
